<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SignIn.aspx.cs" Inherits="Design_Mobile_Login" %>
            ...
            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 loginbox">
                ...
                <div class="row ">                   
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4  col-xs-5 "> 
                        <asp:Button ID="btnLogin" CssClass="btn btn-default submit-btn" runat="server" Text="Login" OnClick="btnLogin_Click" /> 
                                   
                       <%-- <a href="dashboard.aspx" class=" btn btn-default submit-btn">Login</a>--%> 
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-md-4 col-sm-3 col-xs-0"></div>

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SRAToApprove.aspx.cs" Inherits="Design_DashBoardNew_SRAToApprove" %>
        ...
        <div style="width:98%;height:300px;overflow:scroll;">
            ...
            <asp:GridView ID="grd" Width="99%" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3">
                <Columns>
                    ...
                    <asp:BoundField DataField="LedgerTransactionNo" HeaderText="SIN No" ItemStyle-Width="170px" />
                    <asp:BoundField DataField="BarcodeNo" HeaderText="BarcodeNo" ItemStyle-Width="200px" />
                    <asp:BoundField DataField="SubCategorymasterName" HeaderText="Department" />

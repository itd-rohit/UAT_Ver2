<%@ Page ClientIDMode="Static" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="CampRequestApproval.aspx.cs" Inherits="Design_Camp_CampRequestApproval" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="row">
             <div class="col-md-1">&nbsp;</div>
                 ...
                 <div class="col-md-1" style="background-color:#FFC0CB;height: 20px;width:2%;border:1px solid black;cursor:pointer;" onclick="searchCampRequest('3')">
                    ...
                    <div class="col-md-2" style="text-align:left"> Approved
                 </div>
    ...
    <script type="text/javascript">
        ...
        function searchCampRequest(searchType) {
            ...
            serverCall('CampRequestApproval.aspx/SearchCampRequest', { fromDate: jQuery('#txtFromDate').val(), toDate: jQuery('#txtToDate').val(), searchType: searchType, status: jQuery('#ddlStatus').val(), TypeID: jQuery('#ddlType').val() }, function (response) {
    ...
    style="width:100%;border-collapse:collapse;">
		...
		<tr id="Header">
            ...
            <th class="GridViewHeaderStyle" scope="col" style="width:120px;">Camp End Date</th>          
            ...
            <th class="GridViewHeaderStyle" scope="col" style="width:60px;">Approved/Reject</th>          
 ...
 if(objRow.IsActive ==0)
                    ...
                    <td class="GridViewLabItemStyle" ><#=objRow.EndDate#></td>                                         
 ...
 <# 
                        if(objRow.IsActive=="1" && objRow.IsApproved=="0"){#>
                       <input type="button" id="btnApproved" class="ItDoseButton"  value="Approve/Reject"  onclick="CampApprove(this)"  />                                                              
<#}#>
                        </td>    
    ...
    <script type="text/javascript">
        function CampApprove(rowid) {
            ...
            serverCall('CampRequestApproval.aspx/ApproveCampRequest', { ID: jQuery(rowid).closest('tr').find("#tdID").text() }, function (response) {

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MobileAppB2BSetting.aspx.cs" Inherits="Design_B2BMobile_MobileAppB2BSetting" %>
    ...
    <form id="form1" runat="server">
        ...
        <div id="Pbody_box_inventory" >
            <div class="POuter_Box_Inventory" style="text-align: center">
                <b>Mobile App B2B Setting</b>
            </div>
            <div class="POuter_Box_Inventory">
                <div class="Purchaseheader">Mobile App B2B Setting</div>
                <div class="row">
                    <div class="col-md-3">
        ...
        <script type="text/javascript">
            ...
            function savedata() {
                ...
                ar.push(obj);
                serverCall('MobileAppB2BSetting.aspx/SaveData', { data: ar }, function (response) {
                    BindData();
            ...
            function BindData() {
                ...
                serverCall('MobileAppB2BSetting.aspx/BindData', {}, function (response) {
                    if (response != "") {

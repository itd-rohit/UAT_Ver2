<%@ Page Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" ClientIDMode="Static"
    CodeFile="DocShareMaster.aspx.cs" Inherits="Design_DocAccount_DocShareMaster" %>
        ...
        <div class="POuter_Box_Inventory" >
            <div class="row">
                <div class="col-md-12" style="font-weight:bold">
                     <asp:RadioButtonList ID="rblSearchType" runat="server" RepeatDirection="Horizontal"   onchange="bindDocType('0')">
                <asp:ListItem Selected="True" Text="Master" Value="1"></asp:ListItem>
                <asp:ListItem  Text="Doctor" Value="2"></asp:ListItem>
            </asp:RadioButtonList>
                </div>
                <div class="col-md-6">
                    <input type="button" value="Transfer Doctor Share" class="searchbutton" onclick="showPopUp()"/>
                </div>
                <div class="col-md-6">
                              <input type="button" value="Change Doctor Share Status" class="searchbutton" onclick="showPopUpStatus()"/>
                    </div>
            </div>            <div class="row">
                    ...
                    <ContentTemplate>
                        <table style="width: 100%; border-collapse: collapse;">
                            ...
                            <tr >
                                <td>
                                   <b> Panel :&nbsp;</b>
                                <asp:DropDownList ID="ddlPanelDept" runat="server" Width="200px" class="chosen-select" onchange="bindDepartment()"></asp:DropDownList> </td>
                            ...
                            <tr>
                                <td style="text-align:center" colspan="2">
                                     <input type="button" id="btnDepartment" value="Save" onclick="DepartmentSave();"
                        class="savebutton" />
                                </td>
                            </tr>
                        </table>
                               ...
                               <cc1:TabPanel runat="server" HeaderText="Item" ID="tabPanelItem" BackColor="#cccccc" Font-Size="Larger" Height="480px"  >
                    <ContentTemplate>
                        <table style="width: 100%; border-collapse: collapse;">
                            <tr>
                                <td  style="text-align:left"><b>Panel :</b></td>
                                <td><asp:DropDownList ID="ddlPanelItem" runat="server" Width="200px" class="chosen-select" onchange="bindItem()"></asp:DropDownList> </td>
                                <td style="text-align:left"><b> Department :</b></td>
                                <td> <asp:DropDownList ID="ddlDepartment" runat="server" class="ddlDepartment chosen-select" Width="200px" onchange="bindItem()"></asp:DropDownList></td>
                                 <td style="text-align:left"><b>Category:</b></td>
                                <td><asp:DropDownList ID="ddlcategory" runat="server"  Width="100px" class="chosen-select" onchange="bindItem()"></asp:DropDownList></td>
                            </tr>
                            ...
                            <tr>                                                             
                                <td colspan="2">                                    
                                    ...
                                    &nbsp;&nbsp;&nbsp;<b>Amount(Rs.) :&nbsp;</b><asp:TextBox ID="txtItemAmt" runat="server" Width="60px" onkeyup="fillItemAmt(this)"></asp:TextBox>
                                    &nbsp;&nbsp;&nbsp;<b>Percentage(%) :&nbsp;</b><asp:TextBox ID="txtItemPer" runat="server" Width="60px" onkeyup="fillItemPer(this)"></asp:TextBox>
                                </td>
                                <td style="text-align:left" class="trItemDoc"><b>Doctor :</b></td>
                                 <td  style="text-align:left" class="trItemDoc" colspan="3">
                                    <asp:DropDownList ID="ddlItemDoctor" runat="server" class="chosen-select" Width="200px" onchange="bindItem()"></asp:DropDownList>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6">
                                     <div id="ItemShareOutput" style="max-height: 340px; overflow-x: auto; text-align: center">
            </div>
                                </td>
                            </tr>
                        ...
                        <div style="text-align:center">
                             <div class="row">
                                 <div class="col-md-24">
                                     <input type="button" id="btnItem" value="Save" onclick="ItemSave();" style="display:none" class="savebutton" />
                                 </div>
                             </div>
...
<td id="<#=objRow.SubCategoryID#>"  class="GridViewLabItemStyle" style="text-align:left"><#=objRow.Name#></td>
<td class="GridViewLabItemStyle" id="tdSubCategoryID"  style="width:40px;display:none;text-align:left" ><#=objRow.SubCategoryID#>    
<td class="GridViewLabItemStyle"><input id="txtDeptSharePer"  class="ItDoseTextinputNum" type="text" onkeypress="return checkForSecondDecimal(this,event)" value="<#=objRow.DocSharePer#>" style="width:90px;" onkeyup="CheckDocSharePer(this,'Dept');" />%</td>
</tr>
            <#}#>
     </table>
    </script>
...
<td class="GridViewLabItemStyle"><input id="txtItemSharePer"  class="ItDoseTextinputNum clItemSharePer" type="text" onkeypress="return checkForSecondDecimal(this,event)" value="<#=objRow.DocSharePer#>" style="width:90px;" onkeyup="CheckDocSharePer(this,'Item');" />%</td>
    ...
    <script type="text/javascript">
        ...
        function bindDepartment() {
            ...
            if (jQuery("#rblSearchType input[type=radio]:checked").val() == "1")
                if (jQuery("#ddlPanelDept").val())
                    PageMethods.getDepartment(jQuery("#rblSearchType input[type=radio]:checked").val(), 0, jQuery("#ddlPanelDept").val(), onSucessDept, onFailureDept);
                else {
                ...
                if (jQuery("#ddlDeptDoctor").val() != "0" && jQuery("#ddlPanelDept").val())
                    PageMethods.getDepartment(jQuery("#rblSearchType input[type=radio]:checked").val(), jQuery("#ddlDeptDoctor").val(), jQuery("#ddlPanelDept").val(), onSucessDept, onFailureDept);
                else {
                    jQuery("#DeptShareOutput").html('');
                    jQuery("#DeptShareOutput").hide();
                }
    ...
    <script type="text/javascript">
        function bindItem() {            
            if (jQuery("#rblSearchType input[type=radio]:checked").val() == "1") {
                if (jQuery("#ddlDepartment").val() != "0" && jQuery("#ddlPanelItem").val() != "0") {
                    $modelBlockUI();
                    PageMethods.getItem(jQuery("#rblSearchType input[type=radio]:checked").val(), jQuery("#ddlDepartment").val(), 0, jQuery("#ddlcategory").val(), jQuery("#ddlPanelItem").val(), onSucessItem, onFailureDept);
                }
                else {
                ...
                if (jQuery("#ddlDepartment").val() != "0" && jQuery("#ddlItemDoctor").val() != 0 && jQuery("#ddlPanelItem").val() != "0") {
                    $modelBlockUI();
            ...
            jQuery("#tb_DeptShareSearch tr").each(function () {
                ...
                if (id != "trDeptHeader") {
                    if (jQuery(this).find('#txtDeptSharePer').val() > 0) {
                        ...
                        obj.PanelID = jQuery("#ddlPanelDept").val();
                        data.push(obj);
                    }
                }
            });
    ...
    <script type="text/javascript">
        ...
        function getDoc(activeTabIndex, type) {
            ...
            if (activeTabIndex == 1) {
                ...
                jQuery("#ddlPanelDept").prop('selectedIndex', 0);
                jQuery('#ddlPanelDept').trigger('chosen:updated');

...
public partial class Design_Lab_labreportnewhisto : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      */
        ...
        else
        {
            ...
            if (PrintDueReport != "1")// open For Adminsitartor Role If Due
            {
                try
                {
                    validation objVal = new validation();
...
WHERE `LedgertransactionNo`='" + drcurrent["LabNo"].ToString() + "' AND approved=0 AND isreporting=1");
            ...
            sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;padding:3px;text-transform: uppercase;font-family:Verdana;'>Test:</td>");
            sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;padding:3px;'>");
          ...
          //  sb.Append("<tr valign='top' style='height:5px;' ><td style='border:0px;'>&nbsp;</td>");
            //sb.Append("</tr>");

            sb.Append("<tr valign='top'  >");


            sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;padding:3px;text-transform: uppercase;font-family:Verdana;'>Specimen:</td>");
            sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;padding:3px;font-family:Verdana;'>");
           ...
           // sb.Append("</tr>");
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>Clinical History:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;padding:3px;'>" + dr["Clinicalhistory"].ToString() + "</td>");
                sb.Append("</tr>");
            ...
            {
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>Biopsy No:</td>");
            }
            else
            {
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>Cytology No:</td>");
            }
            sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;padding:3px;'>" + dr["SlideNumber"].ToString() + "</td>");
            sb.Append("</tr>");
          ...
          //  sb.Append("</tr>");
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>Gross:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;padding:3px;'>" + dr["gross"].ToString() + "</td>");
                sb.Append("</tr>");
               // sb.Append("<tr valign='top' style='height:12px;' ><td style='border:0px;'>&nbsp;</td>");
               // sb.Append("</tr>");
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>Microscopic:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;padding:3px; '>" + dr["microscopic"].ToString() + "</td>");
                sb.Append("</tr>");
               // sb.Append("<tr valign='top' style='height:12px;' ><td style='border:0px;'>&nbsp;</td>");
               // sb.Append("</tr>");
            }
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>Impression:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;padding:3px;'>" + dr["impression"].ToString() + "</td>");
                sb.Append("</tr>");
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>IHC:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;padding:3px;'>");
             ...
             //   sb.Append("<tr valign='top' style='height:12px;' ><td style='border:0px;'>&nbsp;</td>");
               // sb.Append("</tr>");
                ...
                {
                    sb.Append("<tr valign='top'  >");
                    sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>IHC Comment:</td>");
                    sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;adding:3px;text-align: justify;'>" + dtsbihc.Rows[0]["comments"].ToString() + "</td>");
                   // sb.Append("<tr valign='top' style='height:12px;' ><td style='border:0px;'>&nbsp;</td>");
                   // sb.Append("</tr>");
                }
                ...
                {
                    sb.Append("<tr valign='top'  >");
                    sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>Final Diagnosis:</td>");
                    sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;padding:3px;'>" + dtsbihc.Rows[0]["interpretation"].ToString() + "</td>");
                  //  sb.Append("<tr valign='top' style='height:12px;' ><td style='border:0px;'>&nbsp;</td>");
                  //  sb.Append("</tr>");
                }
            }
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:12px;font-family:Verdana;padding:3px;text-transform: uppercase;'>Advice:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:12px;font-family:Verdana;padding:3px;'>" + dr["advice"].ToString() + "</td>");
                sb.Append("</tr>");
            ...
            if (dr["detail"].ToString() != "")
            {
                ...
                sb.Append("<td valign='top' colSpan='" + dtLabReport.Rows.Count + "'  style='font-size:19px;padding:5px;'>" + img.Replace("<img", "<img width='300px' height='250px'") + "");         
                sb.Append("</td></tr>");
               // sb.Append("<tr valign='top' style='height:12px;' ><td style='border:0px;'>&nbsp;</td>");
               // sb.Append("</tr>");
            }
...
WHERE `LedgertransactionNo`='" + drcurrent["LabNo"].ToString() + "' AND approved=0 AND isreporting=1");
        ...
        foreach (DataRow drAtt in dtAttachment.Rows)
        {
            ...
            {
                _pdf = Resources.Resource.DocumentPath + "/Uploaded Report/" + drAtt["FileUrl"].ToString();
                if (File.Exists(_pdf))
                {
                    try
                    {
    ...
    private void mergeDocument()
    {
        ...
        try
        {
            FooterHeight = Util.GetInt(drcurrent["ReportFooterHeight"].ToString())+10;
        ...
        foreach (PdfPage p in tempDocument.Pages)
        {
          ...
          new System.Drawing.Font(new System.Drawing.FontFamily("Times New Roman"), 8, System.Drawing.GraphicsUnit.Point);
            ...
            PdfText reportline1 = new PdfText(PageWidth - 470, FooterHeight + 10, Util.GetString(drcurrent["ReportLine1"]), pageNumberingFont);
            p.Footer.Layout(reportline1);

            PdfText reportline2 = new PdfText(PageWidth - 470, FooterHeight + 20, Util.GetString(drcurrent["ReportLine2"]), pageNumberingFont);
            p.Footer.Layout(reportline2);

            PdfText reportline3 = new PdfText(PageWidth - 470, FooterHeight + 30, Util.GetString(drcurrent["TCentreAdd"]), pageNumberingFont);
    ...
    public string MakeHeader(string Header, DataRow dr_Detail)
    {
        ...
        if (dtReportHeader.Select("PanelId='" + dr_Detail["Panel_id"].ToString() + "'").Length > 0)
            ...
            Header = dtReportHeader.Select("PanelId='103'")[0]["ReportHeader"].ToString();
    ...
    void htmlToPdfConverter_PageCreatingEvent(PdfPageCreatingParams eventParams)
    {
        ...
        page1.Layout(getPDFImageforbarcode(25, 780, drcurrent["LabNo"].ToString(), "Yes"));
    ...
    private void SetHeader(PdfPage page)
    {
        ...
        {
            HeaderHeight = Util.GetInt(drcurrent["ReportHeaderHeight"].ToString()) - 10;
        }
        ...
        if (drcurrent["isnabl"].ToString().Trim() == "1" || drcurrent["isnabl"].ToString().Trim() == "5")
        {
            ...
            if (Util.GetString(drcurrent["NablLogoPath"]).Trim() != "")
                page.Header.Layout(getPDFImagewithresize1(270, 5, 55, "App_Images" + drcurrent["NablLogoPath"].ToString().Trim()));
        }
        else if (drcurrent["isnabl"].ToString().Trim() == "2" || drcurrent["isnabl"].ToString().Trim() == "5")
        {
            // To Set Cap Logo And Its Position
            if (Util.GetString(drcurrent["CapLogoPath"]).Trim() != "")
                page.Header.Layout(getPDFImagewithresize(350, 5, "App_Images" + drcurrent["CapLogoPath"].ToString().Trim()));
        }
        page.Header.Layout(headerHtml);
    }
    private void SetFooter(PdfPage page)
    {
        if (page.Footer != null)
        {
            ...
            //page.Footer.Layout(getPDFImageforbarcode(22, FooterHeight + 11, drcurrent["LabNo"].ToString(), "Yes"));
           ...
           // page.Footer.Layout(pdf11);
            ...
            {
                page.Footer.Layout(new PdfText(45, FooterHeight + 40, string.Concat("* NOTE – This sample has been processed at our reference lab. For any query, write us to ", Resources.Resource.ClientEmail), new Font("Times New Roman", 7)));
            }
    ...
    private PdfImage getPDFImageforbarcode(float X, float Y, string labno,string ShowQR)
    {
        ...
        if (ShowQR == "Yes")
        {
            string URL = Util.GetString("http://122.160.45.179/mdrcnew/Design/lab/labreportnew_ShortSMS.aspx?LabNo=" + Common.Encrypt(drcurrent["LabNo"].ToString()));
    ...
    public System.Drawing.Image Base64StringToImage(string base64String)
    {
        ...
        if (AllGlobalFunction.showqrcodeinprintlabreport == "Y")
        {
            ...
            using (Graphics graphics = Graphics.FromImage(newImage))
                graphics.DrawImage(image, 0, 0, 120, 90);
            return newImage;
        }
        else
        {
    ...
    private void bindReport()
    {
        ...
        sb.Append("           IF(IM.PrintSampleName=0,IF(IFNULL(itm.Inv_ShortName,'')!='',IM.Name,IM.Name),im.name)) AS TestName,im.method,im.FileLimitationName, scm.deptinterpretaion,scm.ReportLine1,scm.ReportLine2,(select Address from centre_master where CentreId=t.TestCentreID)TCentreAdd,  ");
        sb.Append("    ");
        ...
        sb.Append("           CentreEmail,ifnull((select NablLogoPath from centre_master where centreID=t.TestCentreID),'')NablLogoPath,ifnull((select CapLogoPath from centre_master where centreID=t.TestCentreID),'')CapLogoPath,'' printOrder ,cma.type1,  ");
        ...
        sb.Append("           ,otm.ObservationType_ID,pnl.`Panel_Code`,IFNULL(left(pnl.Add1,35),'')ClientAddress,   ");
        ...
        sb.Append("           Left(lt.PName,30)PName,lt.Age,pli.BarcodeNo,LEFT(lt.Gender,1)Gender,mic.Specimen_Title Specimen_Title, lt.OtherReferLab,lt.Interface_companyName,lt.CorporateIDCard,lt.LedgerTransactionNo_Interface,  ");
        ...
        sb.Append("            1 isborder,0 MachineID  , lt.centreid,lt.Panel_ID,Concat('Dr.',lt.`DoctorName`) ReferDoctor, IF(lt.OtherReferLab='',left(lt.panelname,30),left(lt.OtherReferLab,30)) Company_Name ,'' Company_code,'' Company_add,lt.`HLMPatientType`,lt.`HLMOPDIPDNo`,pli.SampleTypeName  ");
        sb.Append("            FROM patient_labobservation_histo mic     ");
        sb.Append("             INNER JOIN patient_labinvestigation_opd pli ON pli.Test_ID = mic.Test_ID     ");

<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="InqueryGroup_Master.aspx.cs" Inherits="Design_CallCenter_InqueryCategory_Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table cellspacing="0" rules="all" style="width: 100%" border="0" id="tblcategory">
                <thead>
                    <tr>
                        ...
                        <th class="GridViewHeaderStyle"  >Group Name</th>
    ...
    <script type="text/javascript">
        ...
        function GetCategory() {
            jQuery.ajax({
                url: "InqueryGroup_Master.aspx/BindGroup",
                data: {},
        ...
        function savdata() {
            ...
            var request = { GroupName: jQuery('#txtCategoryName').val(), Id: jQuery('#id').val(), status: status };
            jQuery.ajax({
                url: "InqueryGroup_Master.aspx/SaveGroup",
                ...
                success: function (result) {
                    ...
                    if (result.d == "2") {                       
                        showerrormsg("Group already exists");
                        return;
                    }
                    if (result.d == "0") {

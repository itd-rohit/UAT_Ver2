    ...
    <div id="Pbody_box_inventory">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                     <asp:TextBox ID="txtEmail" runat="server" TabIndex="13"
                            ToolTip="Enter E-Mail Address" MaxLength="70" ClientIDMode="Static"></asp:TextBox>
                </div>
            </div>
            <div class="row">
                 <div class="col-md-3">
             ...
             <div class="row">
                ...
                <div class="col-md-5">
                    <asp:TextBox ID="txtESI" runat="server" TabIndex="20" ToolTip="Enter ESI No. "
                            MaxLength="31" ClientIDMode="Static"></asp:TextBox>
             ...
             <div class="row">
                ...
                <div class="col-md-5">
                    <asp:TextBox ID="txtEPF" runat="server" TabIndex="21" ToolTip="Enter EPF No."
                            MaxLength="22" ClientIDMode="Static"></asp:TextBox>
                </div>
                 <div class="col-md-3">
                     Pan No. :&nbsp;
                </div>
                ...
                <div class="col-md-5">
                    <asp:TextBox ID="txtPassport" runat="server" TabIndex="23"
                            ToolTip="Enter Passport No." MaxLength="12" ClientIDMode="Static"></asp:TextBox>
                </div>
            </div>
             <div class="row">
        ...
        <div class="POuter_Box_Inventory">
            ...
            <div class="row">
             ...
             <div class="row">
                <div class="col-md-3">
                    <asp:CheckBox ID="chkLogin" runat="server" Text="UserName :" Checked="true"/>&nbsp;
                </div>
                <div class="col-md-5">
                    <asp:TextBox ID="txtuid" runat="server" MaxLength="20" Font-Bold="true" TabIndex="27"  ClientIDMode="Static" ></asp:TextBox>
                </div>
                 <div class="col-md-3">
                     Password :&nbsp;
                </div>
                <div class="col-md-5">
                    <asp:TextBox ID="txtpwd" runat="server" MaxLength="20" Font-Bold="true"  ClientIDMode="Static" 
                ...
                <div class="col-md-5">
                    <asp:TextBox ID="txtcpwd" runat="server" MaxLength="20" Font-Bold="true" ClientIDMode="Static"
                            TextMode="Password" Style="position: static" TabIndex="27" ></asp:TextBox>
                </div>
            </div>
            <div class="row">
    ...
    <script type="text/javascript">
        function UpdateData() {                     
          ...
          //  }
           ...
           serverCall('EmployeeRegistration.aspx/UpdateData', { Title: $("#<%=cmdTitle.ClientID%>").val(), Name: $("#<%=txName.ClientID%>").val(), HouseNo: $("#<%=txtHouseNo.ClientID%>").val(), Street: $("#<%=txtStreet.ClientID%>").val(), Locality: $("#<%=txtLocality.ClientID%>").val(), City: $("#<%=txtCity.ClientID%>").val(), Pincode: $("#<%=txtPinCode.ClientID%>").val(), OHouse: $("#<%=txtOhouseNo.ClientID%>").val(), OStreet: $("#<%=txtOStreet.ClientID%>").val(), OLocality: $("#<%=txtOlocality.ClientID%>").val(), OCity: $("#<%=txtOCity.ClientID%>").val(), OPincode: $("#<%=txtOPinCode.ClientID%>").val(), Father: $("#<%=txtFather.ClientID%>").val(), Mother: $("#<%=txtMother.ClientID%>").val(), ESI: $("#<%=txtESI.ClientID%>").val(), EPF: $("#<%=txtEPF.ClientID%>").val(), PAN: $("#<%=txtPAN.ClientID%>").val(), Passport: $("#<%=txtPassport.ClientID%>").val(), DOB: $("#<%=txtDOB.ClientID%>").val(), Qualification: $("#<%=txtqualification.ClientID%>").val(), Email: $("#<%=txtEmail.ClientID%>").val(), AllowSharing: AllowSharing, STD: $("#<%=txtSTD.ClientID%>").val(), Phone: $("#<%=txtPhone.ClientID%>").val(), Mobile: $("#<%=txtMobile.ClientID%>").val(), BloodGroup: $("#<%=cmgBloodGroup.ClientID%>").val(), StartDate: $("#<%=txtStartTime.ClientID%>").val(), Username: $("#<%=txtuid.ClientID%>").val(), Pwd: $("#<%=txtpwd.ClientID%>").val(), ConfirmPwd: $("#<%=txtcpwd.ClientID%>").val(), Dept: chkDepartmentID, Centre: chkCentres, Role: chkRoles, Login: isLogin, defaultCentreID: defaultcentre, Designation: $('#<%=ddlDesignation.ClientID %> option:selected').text(), defaultRoleID: $('#<%=ddlRoles.ClientID %>').val(), ApproveSpecialRate: ApproveSpecialRate, AmrValueAccess: AmrValueAccess, DesignationID: $('#<%=ddlDesignation.ClientID %>').val(), Employee_ID: $('#<%=lblEmployee_ID.ClientID %>').text(), ValidateLogin: 0, IsMobileAccess: IsMobileAccess, PROID: $('#<%=ddlPRO.ClientID %>').val(), IsHideRate: IsHideRate, IsEditMacReading: IsEditMacReading, IsSampleLogisticReject: IsSampleLogisticReject, GlobalReportAccess: IsGlobalReportAccess, PROHeadID: $('#<%=ddlPROHead.ClientID%>').val() }, function (result) {

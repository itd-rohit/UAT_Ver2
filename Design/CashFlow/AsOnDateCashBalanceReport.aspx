<%@ Page  ClientIDMode="Static" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="AsOnDateCashBalanceReport.aspx.cs" Inherits="Design_CashFlow_AsOnDateCashBalanceReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
     ...
     <div id="Pbody_box_inventory" >
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <strong>As On Date Cash Balance Report<br />
            </strong>
        ...
        <div class="POuter_Box_Inventory" >
            ...
            <table style="width: 100%; border-collapse: collapse">
                 <tr>
                    <td style="text-align: right; width: 20%">Report Type :&nbsp;</td>
                    <td style="text-align: left; width: 30%">
                       <asp:RadioButtonList ID="rdoReportType" runat="server" RepeatDirection="Horizontal"  onchange="showHide();">
                           <asp:ListItem Text="Centre Wise" Value="1" Selected="True"></asp:ListItem>
                ...
                <tr>
                    ...
                    <td style="width: 20%; text-align: right;display:none" class="clEmployee"><b>Employee :&nbsp;</b>
                    </td>
                    <td style="width: 40%; text-align: left;display:none" class="clEmployee" >
    ...
    <script type="text/javascript">
        jQuery(function () {
            ...
            jQuery('[id*=lstEmployee]').siblings().hide();
        });
        function bindState() {
            jQuery("#lblMsg").text('');
        ...
        function showHide() {
            ...
            if ($("#rdoReportType input[type=radio]:checked").val() == "2") {
                jQuery('[id*=lstEmployee]').siblings().show();
                jQuery('.clEmployee').show();
                jQuery("#lstEmployee").multipleSelect('refresh');
            }
            else {
                jQuery('[id*=lstEmployee]').siblings().hide();
                jQuery('.clEmployee').hide();
                jQuery("#lstEmployee").multipleSelect('refresh');
            }
        }
    </script>
    <script type="text/javascript">
        function bindCentre(con) {
            ...
            if ( jQuery("#ddlBusinessZone").val() != 0 && jQuery("#ddlState").val() != 0)
                PageMethods.bindCentre( jQuery("#ddlBusinessZone").val(), jQuery("#ddlState").val(), onSucessCentre, onFailureCentre);
        }
    ...
    <script type="text/javascript">
     ...
     <script type="text/javascript">
         function SearchReport() {
             ...
             var CentreID = jQuery("#lstCenterList").val();
             if ($("#rdoReportType input[type=radio]:checked").val() == "1" && CentreID == "") {
                 jQuery("#lblMsg").text("Please Select Centre");
                 return;
             }
             else if($("#rdoReportType input[type=radio]:checked").val() == "2" && EmployeeID == "")
             {
                 jQuery("#lblMsg").text("Please Select Employee");
                 return;
             }
                 jQuery.blockUI({ message: 'Please Wait.....\n<img src="../../App_Images/Progress.gif" />' });
                 PageMethods.bindSearchReport(EmployeeID, CentreID, jQuery('#txtDate').val(), jQuery('#txtTime').val(),$("#rdoReportType input[type=radio]:checked").val(), onSucessReport, onFailureSearch);

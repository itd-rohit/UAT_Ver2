...
public partial class Design_Store_IndentReceiptpdf : System.Web.UI.Page
{
    ...
    protected void BindData()
    {
        try
        {
            DataSet DsIndentDetail = ((DataSet)Session["IndentDetail"]);
            DataTable dtIndentDetail = DsIndentDetail.Tables[0];
           ...
           // DataTable dtAccountSumm = DsInvoice.Tables[2];
            ...
            sb.Append("<b>&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp;&nbsp;&nbsp&nbsp; " + Util.GetString(dtIndentDetail.Rows[0]["IndentType"]) + "</b></td>");
           ...
           // sb.Append(" <td><img style='width:100px;height:80px;' src='../../App_Images/yoda_logo1.png' /></td>");
            ...
            sb.Append("<span> <b>Indent Number :</b> " + Util.GetString(dtIndentDetail.Rows[0]["IndentNo"]) + " ");  
	        sb.Append("</span>");
                    
            sb.Append("</td>");
            sb.Append("<td>");
            sb.Append("<span><b> Indent Date : </b>" + Util.GetString(dtIndentDetail.Rows[0]["dtEntry"]) + " "); 
			sb.Append("</span>");
            ...
            sb.Append("<span> <b>GSTIN Sender: </b>");

		    sb.Append("</span>");
                    
            sb.Append("</td>");
            sb.Append("<td>");
            sb.Append("<span>" + Util.GetString(dtIndentDetail.Rows[0]["FromGSTNNo"]) + " ");  
		    sb.Append("</span>");
            ...
            sb.Append("</tr>");
             ...
             sb.Append("<span><b>Name & Address of Sender :  </b>");  
		     sb.Append("</span>");
                    
             sb.Append("</td>");
             sb.Append("<td>");
             sb.Append("<span> " + Util.GetString(dtIndentDetail.Rows[0]["FromLocation"]) + " " + Util.GetString(dtIndentDetail.Rows[0]["FromLocationAddress"]) + " "); 
		     sb.Append("</span>");
             ...
             sb.Append("</td>");
                       ...
                       sb.Append("</td>");
                       sb.Append("<td>");
                       sb.Append("<span> " + Util.GetString(dtIndentDetail.Rows[0]["ToLocation"]) + " " + Util.GetString(dtIndentDetail.Rows[0]["ToLocationAddress"]) + " ");
                       sb.Append("</span>");
                       ...
                       sb.Append("<tr>");
                       sb.Append("<td style=' width:20%; border-right: 1px solid; '>");
                       sb.Append("<span> <b>GSTIN Recipient: </b>");

                       sb.Append("</span>");

                       sb.Append("</td>");
                       sb.Append("<td>");
                       sb.Append("<span>" + Util.GetString(dtIndentDetail.Rows[0]["ToGSTNNo"]) + " ");
                       sb.Append("</span>");
                       ...
                       float totalAmount = 0;
                     //  float alltotal = 0;
                       for (int k = 0; k < dtIndentDetail.Rows.Count; k++)
                       {
                           int J = k + 1;
                           sb.Append("<tr style='height: 40px; border-bottom: 1px solid;'>");
                           sb.Append("<td style='width: 3%;  border-right: 1px solid;'> "+J+"  ");
                           sb.Append("</td>");
                           sb.Append("<td style='width: 10%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[k]["ItemName"]) + "");
                           sb.Append("</td>");
                           sb.Append("<td style='width: 5%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[k]["HsnCode"]) + " ");
                           sb.Append("</td>");
                           sb.Append("<td style='width: 10%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[k]["CatalogNo"]) + " ");
                           sb.Append("</td>");
                           sb.Append("<td style='width: 6%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[k]["OrderQty"]) + " ");
                           sb.Append("</td>");
                           sb.Append("<td style='width: 5%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[k]["Rate"]) + "");
                           sb.Append("</td>");
                           sb.Append("<td style='width: 3%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[k]["NetAmount"]) + "");//pack size
                           sb.Append("</td>");
                           //sb.Append("<td style='width: 3%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[0]["Qty"]) + "");
                           //sb.Append("</td>");
                           //sb.Append("<td style='width: 3%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[0]["UnitPrice"]) + " ");
                           //sb.Append("</td>");
                           //sb.Append("<td style='width: 3%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[0]["Disc"]) + " ");
                           //sb.Append("</td>");
                           //sb.Append("<td style='width: 3%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[0]["Tax"]) + "");
                           //sb.Append("</td>");
                           //sb.Append("<td style='width: 3%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[0]["IGST"]) + "");
                           //sb.Append("</td>");
                           //sb.Append("<td style='width: 3%;  border-right: 1px solid;'>" + Util.GetString(dtIndentDetail.Rows[0]["Amount"]) + " ");
                           //sb.Append("</td>");
                           sb.Append("</tr>");
                           //totalCGST = Util.GetFloat(dtIndentDetail.Rows[0]["CGST"]);
                           //totalQty = Util.GetFloat(dtIndentDetail.Rows[0]["Qty"]);
                           //totalUnitPrice = Util.GetFloat(dtIndentDetail.Rows[0]["UnitPrice"]);
                           //totalDisc = Util.GetFloat(dtIndentDetail.Rows[0]["Disc"]);
                           //totalTax = Util.GetFloat(dtIndentDetail.Rows[0]["Tax"]);
                           //totalIGST = Util.GetFloat(dtIndentDetail.Rows[0]["IGST"]);
                           totalAmount = totalAmount + Util.GetFloat(dtIndentDetail.Rows[k]["NetAmount"]);
        ...
        {
            Session["dtIndentDetail"] = "";
            Session.Remove("dtIndentDetail");
        }
    ...
    private void mergeDocument()
    {
        ...
        foreach (PdfPage p in tempDocument.Pages)
        {
			...
			PdfHtml satushtml = new PdfHtml(XFooter, -2, "<table style='border: 1px solid;width: 1150px; font-family:Times New Roman;font-size:20px;'><tr><td style='border-right: 1px solid;'><span><b>Created By :" + Util.GetString(dtIndentDetail.Rows[0]["username"]) + "</b></span></td><td style=' border-right: 1px solid; '><span><b>Checked By :" + Util.GetString(dtIndentDetail.Rows[0]["CheckedUserName"]) + " </b></span></td><td><span><b>Approved By :" + Util.GetString(dtIndentDetail.Rows[0]["ApprovedUserName"]) + "</b></span></td></tr></table>", null);

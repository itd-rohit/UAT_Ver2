<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="DirectStockTransfer.aspx.cs" Inherits="Design_Store_DirectStockTransfer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <div class="Purchaseheader">
                    Search Option
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 ">
                                <asp:DropDownList ID="ddllocation" class="ddllocation chosen-select chosen-container requiredField" runat="server" onchange="bindindentfromlocation();"></asp:DropDownList>
                            </div>
                            <div class="col-md-2 ">
                            ...
                            <div class="col-md-3 ">
                                <asp:ListBox ID="lstZone" CssClass="multiselect " SelectionMode="Multiple" runat="server" ClientIDMode="Static" onchange="bindState($(this).val());bindCentre();"></asp:ListBox>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 ">
                                <label class="pull-left ">Transfer To Location   </label>
                                <b class="pull-right">:</b>
                            </div>
                            <div class="col-md-9 ">
                                <asp:DropDownList ID="ddlissuelocation" class="ddlissuelocation chosen-select chosen-container" runat="server" onchange=""></asp:DropDownList>
                            </div>
                            ...
                            <div class="col-md-24 ">
                                <table id="tblitemlist1" style="width: 99%; border-collapse: collapse; text-align: left;">
                                    <tr id="triteheader1">
                                        ...
                                        <td class="GridViewHeaderStyle">Transfer Qty.</td>
    ...
    <script type="text/javascript">
        ...
        function bindindentfromlocation() {
            if ($('#<%=ddllocation.ClientID%>').val() == "0") {
                ...
                $("#<%=ddlissuelocation.ClientID%>").append($("<option></option>").val("0").html("Select Transfer To Location"));
                return;
            }
            ...
            serverCall('DirectStockTransfer.aspx/bindindentfromlocation', { tolocation: $('#<%=ddllocation.ClientID%>').val(), TypeId: TypeId, ZoneId: ZoneId, StateID: StateID, panelid: panelid }, function (response) {
                  dropdown.bindDropDown({ defaultValue: 'Select', data: JSON.parse(response), valueField: 'locationid', textField: 'location' });
                  $("#<%=ddlissuelocation.ClientID%>").trigger('chosen:updated');
            });
          }
    ...
    <script type="text/javascript">
        ...
        function AddItem(itemid, barcodeno) {
            ...
            serverCall('DirectStockTransfer.aspx/SearchItemDetail', { itemid: itemid, location: $('#<%=ddllocation.ClientID%>').val(), barcodeno: barcodeno }, function (response) {
        ...
        function showme(ctrl) {
            ...
            if (parseFloat($(ctrl).val()) > parseFloat(avilableqty)) {
                ...
                toast("Error", "Transfer Qty Can't Greater Then Avilable Qty..!", "");
                return;
            }
    ...
    <script type="text/javascript">
        ...
        function saveissue() {
            ...
            serverCall('DirectStockTransfer.aspx/savedirectstocktransfer', { datatosave: datatosave, narration: narration }, function (response) {
            ...
            $("#txtitem")
                      ...
                      .autocomplete({
                          ...
                          source: function (request, response) {
                              var _temp = [];
                              _temp.push(serverCall('DirectStockTransfer.aspx/SearchItem', { itemname: extractLast(request.term), locationidfrom: $('#<%=ddllocation.ClientID%>').val(), locationidto: $('#<%=ddlissuelocation.ClientID%>').val(), itemcate: $('#<%=ddlcategorytype.ClientID%>').val() }, function (responsenew) {
...
function bindManufacturer(ItemIDGroup) {
    $("#<%=ddlManufacturer.ClientID %> option").remove();
            ...
            serverCall('DirectStockTransfer.aspx/bindManufacturer', { locationidfrom: locationidfrom, locationidto: locationidto, ItemIDGroup: ItemIDGroup }, function (response) {
        ...
        function bindMachine(ItemIDGroup, ManufactureID) {
            ...
            locationidfrom = $('#<%=ddllocation.ClientID%>').val().split('#')[0];
            locationidto = $('#<%=ddlissuelocation.ClientID%>').val().split('#')[0];
            serverCall('DirectStockTransfer.aspx/bindMachine', { locationidfrom: locationidfrom, locationidto: locationidto, ItemIDGroup: ItemIDGroup, ManufactureID: ManufactureID }, function (response) {
                var tempData = $.parseJSON(response);
                if (tempData.length > 1) {
        ...
        function bindPackSize(ItemIDGroup, ManufactureID, MachineID) {
            ...
            serverCall('DirectStockTransfer.aspx/bindPackSize', { locationidfrom: locationidfrom, locationidto: locationidto, ItemIDGroup: ItemIDGroup, ManufactureID: ManufactureID, MachineID: MachineID }, function (response) {
                var tempData = $.parseJSON(response);
                if (tempData.length > 1) {

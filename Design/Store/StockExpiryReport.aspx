<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="StockExpiryReport.aspx.cs" Inherits="Design_Store_StockExpiryReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="alert fade" style="position:absolute;left:30%;border-radius:15px;z-index:11111"><%--durga msg changes--%>
                        ...
                        <div class="row">
                         ...
                         <div class="col-md-3 ">
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-9 ">
                                 <asp:TextBox ID="txtfromdate" runat="server" CssClass="requiredField" ></asp:TextBox>
                         ...
                         <div class="col-md-3 ">
                                <label class="pull-left ">Expired In (Days):   </label>
                                <b class="pull-right">:</b>
                            </div>
                            <div class="col-md-9 ">
                                <asp:TextBox ID="txtexpwithin" CssClass="requiredField" runat="server" AutoCompleteType="Disabled" MaxLength="3" Text="60"></asp:TextBox>
                            <cc1:FilteredTextBoxExtender ID="ftbMobileNo" runat="server" FilterType="Numbers" TargetControlID="txtexpwithin">
       ...
       <div class="POuter_Box_Inventory" style="text-align: center">
            <div id="div6">
                <div class="row">
                    <div class="col-md-24 ">
                       <input type="button" value="Get Report PDF" class="searchbutton" onclick="GetReport('PDF')" />
                   <input type="button" value="Get Report Excel" class="searchbutton" onclick="GetReport('Excel')" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <script type="text/javascript">
        ...
        function GetReportPDF() {
            ...
            if ($('#<%=txtexpwithin.ClientID%>').val() == "" || $('#<%=txtexpwithin.ClientID%>').val() == "0") {
                toast("Error", "Please Enter Expired in Days..!", "");
                $('#<%=txtexpwithin.ClientID%>').focus();
                $modelUnBlockUI();
                return;
            }
            serverCall('StockExpiryReport.aspx/GetReportPDF', { fromdate: $('#<%=txtfromdate.ClientID%>').val(), todate: $('#<%=txtexpwithin.ClientID%>').val(), categorytypeid: CategoryTypeId, subcategorytypeid: SubCategoryTypeId, subcategoryid: CategoryId, itemid: itemid, locationid: locationid, machineid: machineid }, function (response) {
        ...
        function GetReport(reportType) {
            ...
            serverCall('StockExpiryReport.aspx/GetReport', { fromdate: $('#<%=txtfromdate.ClientID%>').val().toString(), todate: $('#<%=txtexpwithin.ClientID%>').val().toString(), categorytypeid: CategoryTypeId, subcategorytypeid: SubCategoryTypeId, subcategoryid: CategoryId, itemid: itemid, locationid: locationid, machineid: machineid, reportType: reportType }, function (response) {
                $responseData = JSON.parse(response);
                if ($responseData.status) {

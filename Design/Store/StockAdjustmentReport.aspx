<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="StockAdjustmentReport.aspx.cs" Inherits="Design_Store_StockAdjustmentReport" %>
          ...
          <div class="POuter_Box_Inventory" style="width:1300px;">
            <div class="content">
                ...
                <table width="99%">
                    <tr>
                        <td align="center">
                          <b>Stock Adustment Report(Stock Physical Verification)</b>  
                        </td>
                    </tr>
                    </table>
                </div>
        ...
        <script type="text/javascript">
         ...
         <script type="text/javascript">
             ...
             function getexcelreport() {
                 ...
                 $.blockUI();
                 $.ajax({
                     url: "StockAdjustmentReport.aspx/getstockstatusreportexcel",
                     data: JSON.stringify({ location: JSON.stringify(locations), Items: JSON.stringify(Items), manu: manu, machine: machine, fromdate: fromdate, todate: todate,type:type }),
                     type: "POST", // data has to be Posted    	        
                     contentType: "application/json; charset=utf-8",
                     timeout: 120000,
                     dataType: "json",

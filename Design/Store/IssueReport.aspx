<%@ Page Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="IssueReport.aspx.cs" Inherits="Design_Store_IssueReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory">
            <div class="Purchaseheader">Issue From Location</div>
            <div class="row">
                <div class="col-md-3">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <asp:DropDownList ID="ddldateoption" runat="server">
                            <asp:ListItem Value="1">Receive Date</asp:ListItem>
             ...
             <div class="row">
                ...
                <div class="col-md-9">
                    <asp:DropDownList ID="ddlissuetype" runat="server">
                            ...
                            <asp:ListItem Value="Direct Issue">Direct Issue</asp:ListItem>
                            <asp:ListItem Value="Direct Stock Transfer">Direct Stock Transfer</asp:ListItem>
                        </asp:DropDownList>
</div>
                  <div class="col-md-3">
                    <label class="pull-left">Indent No.
                    </label>
                    <b class="pull-right">:</b>
                </div>
                <div class="col-md-9">
              ...
              <div class="row" style="display:none">
                <div class="col-md-3">
                    <asp:RadioButtonList ID="radsummary" runat="server" RepeatDirection="Horizontal" Style="display: none;">
    ...
    <script type="text/javascript">
        ...
        function getReport(reportType) {
            ...
            var dateoption = $('#<%=ddldateoption.ClientID%>').val().toString();

            serverCall('IssueReport.aspx/GetReport', { type: $('#<%=radsummary.ClientID%> input:checked').val(), fromdate: $('#<%=txtfromdate.ClientID%>').val(), todate: $('#<%=txttodate.ClientID%>').val(), categorytypeid: CategoryTypeId, subcategorytypeid: SubCategoryTypeId, subcategoryid: CategoryId, itemid: itemid, locationid: locationid, machineid: machineid, dateoption: dateoption, issuetype: $('#<%=ddlissuetype.ClientID%>').val(), indentno: $('#<%=txtindentno.ClientID%>').val(), reportType: reportType }, function (response) {
                ...
                if ($responseData.status) {
                    ...
                    $objData.DateOption = JSON.parse(response).DateOption;
                    $objData.IssueType = JSON.parse(response).IssueType;

...
public partial class Design_Store_UnConsumeReportPDF : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        try
        {
            dtObs = Store_ReportQuery.StockUnConsumeReport(Request.Form["ItemID"], Request.Form["MachineID"], Request.Form["LocationID"], Request.Form["Type"], Request.Form["CategoryTypeID"], Request.Form["SubCategoryTypeID"], Request.Form["SubCategoryID"], Request.Form["FromDate"], Request.Form["ToDate"], Request.Form["IsAutoIncrement"]);
        }
        catch (Exception ex)
        {

<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="StockMovementReport.aspx.cs" Inherits="Design_Store_StockMovementReport" %>
    ...
    <script type="text/javascript">
        ...
        function binditem() {
            ...
            if (CategoryTypeId != "") {
                ...
                if (CategoryTypeId != "") {
                    $.ajax({
                        url: "StockMovementReport.aspx/binditem",
        ...
        <script type="text/javascript">
         ...
         <script type="text/javascript">
             ...
             function getexcelreport() {
                 ...
                 $.blockUI();
                 $.ajax({
                     url: "StockMovementReport.aspx/getstockmovementreportexcel",
                     data: JSON.stringify({ location: JSON.stringify(locations), Items: JSON.stringify(Items), manu: manu, machine: machine }),
                     type: "POST", // data has to be Posted    	        
                     contentType: "application/json; charset=utf-8",
                     timeout: 120000,

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LocationLocationMappingDirectReceive.aspx.cs" Inherits="Design_Store_LocationLocationMappingDirectReceive" %>
...
<body>
            ...
            <div class="POuter_Box_Inventory">
                ...
                <div class="row">
                    <div class="col-md-24 " style="text-align: center">
                        <b>Map Location With Location For Direct Issue</b>
                    </div>
                    <div class="row">
                        <div class="col-md-3 ">
                            ...
                            <table id="tblitemlist" style="width: 100%; border-collapse: collapse; text-align: left;">
                                <tr id="triteheader">
                                    ...
                                    <td class="GridViewHeaderStyle">
                                        <input type="checkbox" onclick="call()" id="hd" />&nbsp;&nbsp;<input onclick="    DeleteRows()" type="button" value="Delete" style="cursor: pointer; background-color: pink; font-weight: 700;" /></td>
                                </tr>
                            </table>
                        </div>
                    </div>
    ...
    <script type="text/javascript">
        function SaveData() {
            ...
            var type = "DirectIssue";
            var fromcenterID = $('#<%=ddllocation.ClientID%>').val().toString();
    ...
    <script type="text/javascript">
        ...
        function ExportToExcel() {
            var fromCentre = $('#<%=ddllocation.ClientID%>').val();

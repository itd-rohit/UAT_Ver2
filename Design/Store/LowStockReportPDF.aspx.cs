...
public partial class Design_Store_StockStatusReportPDF : System.Web.UI.Page
{
    ...
    private void BindData()
    {
        ...
        try
        {
            dtObs = Store_ReportQuery.LowStockReport(Request.Form["CategorytypeId"], Request.Form["SubCategoryTypeId"], Request.Form["SubCategoryId"], Request.Form["ItemID"], Request.Form["LocationID"], Request.Form["MachineID"], Request.Form["Apptype"]);
        }
        catch (Exception ex)
        {

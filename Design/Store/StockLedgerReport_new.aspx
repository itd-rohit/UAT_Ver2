...
<Ajax:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true">
    ...
    <div id="Pbody_box_inventory" style="width:1304px;">
         ...
         <div class="POuter_Box_Inventory" style="width:1300px; display:None;">
            <div class="content">
        ...
        <script type="text/javascript">
         ...
         <script type="text/javascript">
             ...
             function getexcelreport() {
                 ...
                 var manu = $("#<%=ddlmanu.ClientID%>").val();
                 var machine = $("#<%=ddlmachine.ClientID%>").val();
				 var category = $("#<%=ddlcattype.ClientID%>").val();

                 var fromdate = $("#<%=txtfromdate.ClientID%>").val();
                 var todate = $("#<%=txttodate.ClientID%>").val();
				 
				 var subcat = $("#<%=ddlsubcattype.ClientID%>").val();


                // $.blockUI();
                 $.ajax({
                     url: "StockLedgerReport_new.aspx/getstockstatusreportexcel",
                     data: JSON.stringify({ location: JSON.stringify(locations), Items: JSON.stringify(Items), manu: manu, machine: machine, fromdate: fromdate, todate: todate, subcat:JSON.stringify(subcat) }),
                     type: "POST", // data has to be Posted    	        
                     contentType: "application/json; charset=utf-8",
                     timeout: 120000,
                     dataType: "json",

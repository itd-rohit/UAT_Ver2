...
public partial class Design_Store_StockStatusReportPDF : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            foreach (DataRow dw in dtObs.Rows)
            {
                ...
                sb.Append("<td style='width:100px;'>" + Util.GetString(dw["MachineName"]) + "</td>");                
    ...
    private string MakeHeader()
    {
        ...
        Header.Append("<tr>");
        Header.Append("<td valign='top' style='font-weight:bold;width:200px;'>Item Name</td>");
        Header.Append("<td valign='top' style='font-weight:bold;width:200px;'>CategoryType Name</td>");
        Header.Append("<td valign='top' style='font-weight:bold;width:200px;'>SubCategoryType Name</td>");
        Header.Append("<td valign='top' style='font-weight:bold;width:100px;'>Machine Name</td>");
        Header.Append("<td valign='top' style='width:70px;font-weight:bold;'>Barcode No</td>");
        Header.Append("<td valign='top' style='width:70px;font-weight:bold;'>Consume Unit</td>");
        Header.Append("<td valign='top' style='width:70px;font-weight:bold;'>Expiry Date</td>");
        Header.Append("</tr>");
        Header.Append("</table></div>");
    ...
    private void BindData()
    {
        try
        {
            dtObs = Store_ReportQuery.StockExpiryReport(Request.Form["FromDate"], Request.Form["ToDate"], Request.Form["CategorytypeId"], Request.Form["SubCategoryTypeId"], Request.Form["SubCategoryId"], Request.Form["ItemID"], Request.Form["LocationID"], Request.Form["MachineID"]);
        }
        catch (Exception ex)
        {

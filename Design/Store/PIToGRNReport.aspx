<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="PIToGRNReport.aspx.cs" Inherits="Design_Store_PIToGRNReport" %>
                ...
                <div class="Purchaseheader">
                  ...
                  <table width="99%">
                      ...
                      <tr>
                          ...
                          <td colspan="3"> <asp:ListBox ID="ddlvendor" CssClass="multiselect " SelectionMode="Multiple" Width="600px" runat="server" ClientIDMode="Static"></asp:ListBox></td>
    ...
    <script type="text/javascript">
        ...
        function binditem() {
            ...
            if (CategoryTypeId != "") {
                ...
                if (CategoryTypeId != "") {
                    $.ajax({
                        url: "PIToGRNReport.aspx/binditem",
         ...
         <script type="text/javascript">
             ...
             function getexcelreport() {
                 ...
                 $.blockUI();
                 $.ajax({
                     url: "PIToGRNReport.aspx/getreportexcel",
                     data: JSON.stringify({ location: JSON.stringify(locations), Items: JSON.stringify(Items), manu: manu, machine: machine, fromdate: fromdate, todate: todate, vendor: JSON.stringify(vendor) }),
                     type: "POST", // data has to be Posted    	        
                     contentType: "application/json; charset=utf-8",
                     timeout: 120000,
                     dataType: "json",

<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="StockClosingReport.aspx.cs" Inherits="Design_Store_StockClosingReport" %>
...
<Ajax:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true">
    ...
    <div id="Pbody_box_inventory" style="width:1304px;">
          ...
          <div class="POuter_Box_Inventory" style="width:1300px;">
            <div class="content">
                ...
                <table width="99%">
                    <tr>
                        <td align="center">
                          <b>Stock Cloing Report(As On Date)</b>  
                        </td>
                    </tr>
                    </table>
                </div>
         ...
         <div class="POuter_Box_Inventory" style="width:1300px;">
            <div class="content">
                <div class="Purchaseheader" >As On Date</div>

                <table width="100%">
          <tr>
                                            <td class="required">As On Date :&nbsp;&nbsp;&nbsp;
         ...
         <div class="POuter_Box_Inventory" style="width:1300px;">
            <div class="content">
                ...
                <table width="100%">
                    <tr>
                        <td style="text-align: left; font-weight: 700; width: 149px;">Current Location :&nbsp; </td>
    ...
    <script type="text/javascript">
        ...
        function binditem() {
            ...
            if (CategoryTypeId != "") {
                ...
                if (CategoryTypeId != "") {
                    $.ajax({
                        url: "StockStatusReport.aspx/binditem",
        ...
        <script type="text/javascript">
            ...
            function getpdfreport() {
                ...
                $.blockUI();
                $.ajax({
                    url: "StockClosingReports.aspx/getstockstatusreportpdf",
         ...
         <script type="text/javascript">
             ...
             function getexcelreport() {
                 ...
                 var fromtime = $("#<%=txtfromtime.ClientID%>").val(); 
                 

                 $.blockUI();
                 $.ajax({
                     url: "StockClosingReport.aspx/getstockstatusreportexcel",
                     data: JSON.stringify({ location: JSON.stringify(locations), Items: JSON.stringify(Items), manu: manu, machine: machine, fromdate: fromdate, fromtime: fromtime }),
                     type: "POST", // data has to be Posted    	        
                     contentType: "application/json; charset=utf-8",
                     timeout: 120000,
                     dataType: "json",

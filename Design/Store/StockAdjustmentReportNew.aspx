<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="StockAdjustmentReportNew.aspx.cs" Inherits="Design_Store_StockAdjustmentReportNew" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <link href="../../App_Style/multiple-select.css" rel="stylesheet" /> 
     ...
     <div id="Pbody_box_inventory">
        <div class="POuter_Box_Inventory" style="text-align: center">
            <b>Stock Physical Verification Report</b>
          ...
          <div class="POuter_Box_Inventory">
            <div  id="div1">
                ...
                <div class="row">
                 ...
                 <div class="POuter_Box_Inventory" style="text-align:center;">
               <div class="content">
                   <input type="button" value="Get Report Excel" class="searchbutton" onclick="GetReport();" id="Button1" /></div>
                     </div>
         </div>
    ...
    <script type="text/javascript">
        ...
        function bindCatagoryType() {
            ...
            serverCall('MappingStoreItemWithCentre.aspx/bindcattype', {}, function (response) {
                 var $ddlCat = $('#<%=ddlcattype.ClientID%>');
                $ddlCat.bindMultipleSelect({ defaultValue: 'Select', data: JSON.parse(response), valueField: 'CategoryTypeID', textField: 'CategoryTypeName', controlID: $("#ddlcattype"), isClearControl: '' });
            });
        }
        ...
        function bindSubcattype(CategoryTypeID) {
            ...
            if (CategoryTypeID != "") {
                serverCall('MappingStoreItemWithCentre.aspx/bindSubcattype', { CategoryTypeID: CategoryTypeID.toString() }, function (response) {
                    var $ddlsCat = $('#<%=ddlsubcattype.ClientID%>');
                    $ddlsCat.bindMultipleSelect({ defaultValue: 'Select', data: JSON.parse(response), valueField: 'SubCategoryTypeID', textField: 'SubCategoryTypeName', controlID: $("#ddlsubcattype"), isClearControl: '' });
                });
                binditem();
            }
    ...
    <script type="text/javascript">
        ...
        function bindCentrecity(BusinessZoneID) {
            ...
            serverCall('StoreLocationMaster.aspx/bindCentrecity', { stateid: StateID }, function (response) {
                var $ddlCentrecity = $('#<%=lstCentrecity.ClientID%>');
                $ddlCentrecity.bindMultipleSelect({ defaultValue: 'Select', data: JSON.parse(response), valueField: 'id', textField: 'city', controlID: $("#lstCentrecity"), isClearControl: '' });
            });
            bindCentre();
        }
        ...
        function bindmachine() {
            ...
            serverCall('Services/StoreCommonServices.asmx/bindmachine', {}, function (response) {
                 var $ddlMac = $('#<%=ddlmachine.ClientID%>');
                 $ddlMac.bindMultipleSelect({ defaultValue: 'Select', data: JSON.parse(response), valueField: 'ID', textField: 'NAME', controlID: $("#ddlmachine"), isClearControl: '' });
            });
    ...
    <script type="text/javascript">
        ...
        function GetReport() {
            ...
            serverCall('StockAdjustmentReportNew.aspx/GetReport', { fromdate:$('#<%=txtfromdate.ClientID%>').val(), todate:$('#<%=txttodate.ClientID%>').val(), categorytypeid:CategoryTypeId, subcategorytypeid: SubCategoryTypeId, subcategoryid:CategoryId, itemid:itemid, locationid:locationid , machineid: machineid}, function (response) {
                ItemData = response;
                if (ItemData == "false") {

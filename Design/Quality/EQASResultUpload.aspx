<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EQASResultUpload.aspx.cs" Inherits="Design_Quality_EQASResultUpload" %>
            ...
            <div class="content">
                <table>
                    <tr>
                        ...
                        <td>
                          <asp:DropDownList ID="ddleqasprovider" runat="server" Width="300px"></asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        <td style="font-weight: 700">EQAS Program :</td>
                        <td><asp:DropDownList ID="ddleqasprogram" runat="server" Width="300px"></asp:DropDownList></td>
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="View Result">
                            ...
                            <ItemTemplate>
                                ...
                                <a target="_blank" href='EQASResult/<%# Eval("filename")%>'>View EQAS Result</a>
                            </ItemTemplate>
                        </asp:TemplateField>

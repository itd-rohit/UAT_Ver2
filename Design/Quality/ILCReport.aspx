<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="ILCReport.aspx.cs" Inherits="Design_Quality_ILCReport" %>
...
<td> From Date :</td>
<td><asp:TextBox ID="dtFromDate" Width="100px" runat="server"></asp:TextBox>
                        <cc1:CalendarExtender runat="server" ID="ce_dtTo" TargetControlID="dtFromDate" Format="dd-MMM-yyyy" PopupButtonID="dtFromDate" /></td>

<td> To Date :</td>
<td><asp:TextBox ID="dtToDate" Width="100px" runat="server"></asp:TextBox>
                        <cc1:CalendarExtender runat="server" ID="ce_dtTo1" TargetControlID="dtToDate" Format="dd-MMM-yyyy" PopupButtonID="dtToDate" /></td>
                        <td style="font-weight: 700;display:none;">
                            Month/Year :
                        </td>
    ...
    <script type="text/javascript">
        ...
        function summaryreport() {
            ...
            //$.blockUI();
            $.ajax({
                url: "ILCReport.aspx/Getsummaryreport",
                data: '{processingcentre:"' + processingcentre + '",cmonth:"' + $('#<%=ddlcurrentmonth.ClientID%>').val() + '",cyear:"' + $('#<%=ddlyear.ClientID%>').val() + '",dtFromDate:"' + $('#<%=dtFromDate.ClientID%>').val() + '",dtToDate:"' + $('#<%=dtToDate.ClientID%>').val() + '"}',
                type: "POST",
                timeout: 120000,

<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="EQASResultReject.aspx.cs" Inherits="Design_Quality_EQASResultReject" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div id="Pbody_box_inventory" style="width:1304px;">
            ...
            <div class="content">
                  <table width="99%">
                    <tr>
                        <td align="center">
                          <b>EQAS Registration Rejection </b>  
          ...
          <div class="POuter_Box_Inventory" style="width:1300px;">
           ...
           <table id="tbl" style="width:99%;border-collapse:collapse;text-align:left;">
                        ...
                        <tr id="trheader">
                            ...
                            <td class="GridViewHeaderStyle">Program No</td>
                            <td class="GridViewHeaderStyle">Cycle No</td>
    ...
    <script type="text/javascript">
        function SearchNow() {
            ...
            jQuery.ajax({
                url: "EQASResultReject.aspx/getEQASresult",
                ...
                success: function (result) {
                    ...
                    for (var i = 0; i <= PanelData.length - 1; i++) {
                        ...
                        if (PanelData[i].isReject == "0" && (PanelData[i].custatus == "New" || PanelData[i].custatus == "ResultDone")) {
                            mydata += '<td align="left" style="background-color:aqua"><input type="checkbox" id="chk" onchange="checkPaitent(this)" class="mmc ' + PanelData[i].programid + '" data="' + PanelData[i].programid + '"  /></td>';
                        }
                        else if (PanelData[i].isReject == "0") {
                        ...
                        mydata += '<td align="left"  >' + PanelData[i].EQASProvideName + '</td>';
                        mydata += '<td align="left" style="font-weight:bold;" >' + PanelData[i].custatus + '</td>';
        ...
        function rejectme() {
            ...
            $.blockUI();
            $.ajax({
                url: "EQASResultReject.aspx/rejectnow",

...
public partial class Design_Quality_EQAS_Sumarry_Report_ForAllLabs_MachineWise : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            ddleqasprogram.Items.Insert(0, new ListItem("Select All", "0"));
    ...
    static DataTable ChangeDatatable(DataTable dt)
    {
        ...
        DataView dv = dt.DefaultView.ToTable(true, "Centre", "programname").DefaultView;
        dv.Sort = "Centre asc";
        ...
        foreach (DataRow dwrr in dtCentre.Rows)
        {
            ...
            dwr["Instrument^Name"] = dt.Rows[0]["MachineName"].ToString();
            dwr["Program^Name"] = dwrr["programname"].ToString();

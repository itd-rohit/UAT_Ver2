<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="SummaryReportOfEQAS.aspx.cs" Inherits="Design_Quality_SummaryReportOfEQAS" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function bindcentre() {
            ...
            $.ajax({
                url: "SummaryReportOfEQAS.aspx/bindCentre",
                data: '{TypeId: "' + TypeId + '"}',
    ...
    <script type="text/javascript">
        ...
        function summaryreport() {
            ...
            //$.blockUI();
            $.ajax({
                url: "SummaryReportOfEQAS.aspx/Getsummaryreport",

<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ILCUpload.aspx.cs" Inherits="Design_Quality_ILCUpload" %>
...
<body>
    <form id="form1" runat="server">
      <div id="Pbody_box_inventory" style="width:980px; min-height:300px;">
        <div class="POuter_Box_Inventory" style="width: 975px">
            <div class="Purchaseheader">Upload Attachment</div>
             <div class="content">
                 <asp:Label ID="lblMsg" runat="server" CssClass="ItDoseLblError"></asp:Label> <br />
               <div id="mmd" runat="server">
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Action">
                            <ItemTemplate>
                               ...
                               <%--   <asp:ImageButton ID="ImageButton1" ValidationGroup="a" CausesValidation="false" CommandName="View" CommandArgument='<%#Eval("AttachedFile") %>' ImageUrl="~/App_Images/view.GIF" runat="server" />--%>

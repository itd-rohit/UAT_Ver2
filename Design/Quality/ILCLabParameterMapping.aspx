<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="ILCLabParameterMapping.aspx.cs" Inherits="Design_Quality_ILCLabParameterMapping" %>
 ...
 <Ajax:ScriptManager ID="ScriptManager1" runat="server" EnablePageMethods="true">
                ...
                <table width="99%">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:ListBox ID="ddlprocessinglab" onchange="getmydata()" CssClass="multiselect" SelectionMode="Multiple" Width="365px" runat="server"></asp:ListBox>
                        ...
                        <td  >
                          <asp:DropDownList ID="ddllabtype" runat="server" class="ddllabtype chosen-select chosen-container" Width="160" onchange="bindilclab()">
                           ...
                           <asp:CheckBox ID="chkAllCentre" runat="server" Text="All Centre" ToolTip="Check For All Outhouse" onclick="bindilclab()" style="font-weight: 700"   />
                            ...
                            <asp:DropDownList class="ddlilclab chosen-select chosen-container" ID="ddlilclab" runat="server" style="width:345px;"></asp:DropDownList>
          ...
          <div class="POuter_Box_Inventory" style="width:1300px;">
           ...
           <table id="tbl" style="width:99%;border-collapse:collapse;text-align:left;">
                        ...
                        <tr id="trheader">
                             ...
                             <td class="GridViewHeaderStyle" title="Start Month" style="width:85px">
                                 Start From<br />
                                           <select id="monthall" onchange="setbottom(this)" name="t3">
                                        ...
                                        <td class="GridViewHeaderStyle" title="Fequency in Month" style="width:85px">
                                            Feq(inMonth)
                                            <input type="text" id="txtFequencyhead" placeholder="1-12" style="width:80px" onkeyup="showme2(this)" name="t2" />
                                        </td>
                            </tr>
                       </table>
                       </div>
     ...
     <script type="text/javascript">
         ...
         function bindcentre() {
             ...
             $.ajax({
                 url: "ILCLabParameterMapping.aspx/bindCentre",
                 data: '{TypeId: "' + TypeId + '"}',
         ...
         function binddataall() {
             ...
             if (department != "0") {
                 jQuery.ajax({
                     url: "ILCLabParameterMapping.aspx/bindtest",
         ...
         function bindilclab() {
             ...
             if (processingcentre != "0") {
                 ...
                 if (department != "0") {
                     jQuery.ajax({
                         url: "ILCLabParameterMapping.aspx/bindilc",
             ...
             $('#<%=ddlprocessinglab.ClientID%> > option:selected').each(function () {
                 ...
                 $('#<%=lstparameter.ClientID%> > option:selected').each(function () {
                     ...
                     if ($('table#tbl').find('#' + id).length == 0) {
                         ...
                         if ($('#<%=ddllabtype.ClientID%>').val() == "1") {
                             mydata += '<td align="left" id="rate"><input type="text" style="width:80px;display:none;" id="txtrate" name="t1" onkeyup="showme1(this)" /></td>';
                         }
                         else {
                         ...
                         mydata += '<td align="left" id="tdmonth"><select id="month"  name="t3">';
                         mydata += '<option value="1">January</option><option value="2">February</option>';
                         mydata += '<option value="3">March</option><option value="4">April</option>';
                         mydata += '<option value="5">May</option><option value="6">June</option>';
                         mydata += '<option value="7">July</option><option value="8">August</option>';
                         mydata += '<option value="9">September</option><option value="10">October</option>';
                         mydata += '<option value="11">November</option><option value="12">December</option>';
                         mydata += '</select></td>';


                         mydata += '<td align="left" id="Fequency" title="Fequency in Month"><input type="text" style="width:80px" id="txtFequency"  name="t2" onkeyup="showme1(this)" placeholder="1-12" /></td>';
                         ...
                         showerrormsg(paramnmae+ "  Already Added ");
                     }
                 });

             });
             $('#btnsave').show();
             $("#<%=ddlprocessinglab.ClientID%>").multipleSelect("disable");
             $("#<%=ddlcentretype.ClientID%>").attr("disabled", true).trigger('chosen:updated');
         ...
         function deleterownew(itemid) {
             if (confirm("Do You Want To Delete This Data?")) {
                 ...
                 jQuery.ajax({
                     url: "ILCLabParameterMapping.aspx/deletedata",
                     data: '{ id: "' + id + '"}',
                     type: "POST",
                     timeout: 120000,
                     async: false,
    ...
    <script type="text/javascript">
        function bindallparameter() {
            ...
            if (test != "") {
                jQuery.ajax({
                    url: "ILCLabParameterMapping.aspx/bindparameter",
                    data: '{ test: "' + test + '"}',
                    type: "POST",
                    timeout: 120000,
                    async: false,
    ...
    <script type="text/javascript">
        ...
        function validation() {
            ...
            $('#tbl tr').each(function () {
                ...
                if (id != "trheader") {
                    ...
                    if (rate == 0 && $(this).find('#ddllabtypeid').html()=="2") {
                        sn = 1;
            ...
            $('#tbl tr').each(function () {
                var id = $(this).closest("tr").attr("id");
                if (id != "trheader") {
                    var qty = $(this).find('#txtFequency').val() == "" ? 0 : parseFloat($(this).find('#txtFequency').val());
                    if (qty == 0) {
                        sn1 = 1;
                        $(this).find('#txtFequency').focus();
            ...
            if (sn1 == 1) {
                showerrormsg("Please Enter Fequency ");
                return false;
            }
        ...
        function getilcdata() {
                ...
                $('#tbl tr').each(function () {
                    ...
                    if (id != "trheader") {
                        ...
                        ILCData.Rate = $(this).find('#txtrate').val() == "" ? 0 : parseFloat($(this).find('#txtrate').val());
                        ILCData.AcceptablePer = $(this).closest("tr").find("#txtaceept").val();
                        ILCData.Fequency = $(this).closest("tr").find("#txtFequency").val();

                        ILCData.StartMonth = $(this).closest("tr").find("#month").val();
                        ILCData.StartMonthName = $(this).closest("tr").find("#month option:selected").text();
        ...
        function saveme() {
            ...
            //$.blockUI();
            $.ajax({
                url: "ILCLabParameterMapping.aspx/SaveData",
        ...
        function clearForm() {
            ...
            jQuery('#<%=ddlprocessinglab.ClientID%> option').remove();
            jQuery('#<%=ddlprocessinglab.ClientID%>').multipleSelect("refresh");
            jQuery('#<%=ddlprocessinglab.ClientID%>').multipleSelect("enable");
    ...
    <script type="text/javascript">
        function getmydata() {
            ...
            if (processingcentre != "0") {
                ...
                jQuery.ajax({
                    url: "ILCLabParameterMapping.aspx/getalldata",
                    ...
                    success: function (result) {
                        ...
                        for (var i = 0; i <= PanelData.length - 1; i++) {
                            ...
                            var id = PanelData[i].ProcessingLabID+"_"+PanelData[i].TestID + "_" + PanelData[i].TestType;
                            ...
                            var mydata = '<tr style="background-color:lightgreen;" class="GridViewItemStyle" id=' + id + ' name="' + PanelData[i].id + '">';
                                ...
                                if (PanelData[i].ILCLabTypeID == "1") {
                                    mydata += '<td align="left" id="rate"><input type="text" style="width:80px;display:none;" id="txtrate" name="t1" onkeyup="showme1(this)" value="' + PanelData[i].Rate + '"/></td>';
                                }
                                else {
                                ...
                                mydata += '<td align="left" id="tdmonth"><select id="month"  name="t3">';
                                if (PanelData[i].StartMonth == "1") {
                                    mydata += '<option value="1" selected="true">January</option>';
                                }
                                else {
                                    mydata += '<option value="1">January</option>';
                                }

                                if (PanelData[i].StartMonth == "2") {
                                    mydata += '<option value="2" selected="true">February</option>';
                                }
                                else {
                                    mydata += '<option value="2">February</option>';
                                }

                                if (PanelData[i].StartMonth == "3") {
                                    mydata += '<option value="3" selected="true">March</option>';
                                }
                                else {
                                    mydata += '<option value="3">March</option>';
                                }

                                if (PanelData[i].StartMonth == "4") {
                                    mydata += '<option value="4" selected="true">April</option>';
                                }
                                else {
                                    mydata += '<option value="4">April</option>';
                                }

                                if (PanelData[i].StartMonth == "5") {
                                    mydata += '<option value="5" selected="true">May</option>';
                                }
                                else {
                                    mydata += '<option value="5">May</option>';
                                }
                                if (PanelData[i].StartMonth == "6") {
                                    mydata += '<option value="6" selected="true">June</option>';
                                }
                                else {
                                    mydata += '<option value="6">June</option>';
                                }

                                if (PanelData[i].StartMonth == "7") {
                                    mydata += '<option value="7" selected="true">July</option>';
                                }
                                else {
                                    mydata += '<option value="7">July</option>';
                                }

                                if (PanelData[i].StartMonth == "8") {
                                    mydata += '<option value="8" selected="true">August</option>';
                                }
                                else {
                                    mydata += '<option value="8">August</option>';
                                }
                                if (PanelData[i].StartMonth == "9") {
                                    mydata += '<option value="9" selected="true">September</option>';
                                }
                                else {
                                    mydata += '<option value="9">September</option>';
                                }

                                if (PanelData[i].StartMonth == "10") {
                                    mydata += '<option value="10" selected="true">October</option>';
                                }
                                else {
                                    mydata += '<option value="10">October</option>';
                                }
                              
                               
                                if (PanelData[i].StartMonth == "11") {
                                    mydata += '<option value="11" selected="true">November</option>';
                                }
                                else {
                                    mydata += '<option value="11">November</option>';
                                }

                                if (PanelData[i].StartMonth == "12") {
                                    mydata += '<option value="12" selected="true">December</option>';
                                }
                                else {
                                    mydata += '<option value="12">December</option>';
                                }
                                ...
                                mydata += '<td align="left" id="Fequency" title="Fequency in Month"><input type="text" style="width:80px" id="txtFequency"  name="t2" onkeyup="showme1(this)" value="' + PanelData[i].Fequency + '" placeholder="1-12" /></td>';
        ...
        function exporttoexcel() {
            ...
            jQuery.ajax({
                url: "ILCLabParameterMapping.aspx/exporttoexcel",
                data: '{}',
                type: "POST",
                timeout: 120000,
                async: false,

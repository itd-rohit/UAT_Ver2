<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" ClientIDMode="Static" AutoEventWireup="true" CodeFile="EnrolmentVerification.aspx.cs" Inherits="Design_Sales_EnrolmentVerification" %>
   ...
   <script type="text/javascript" src="../../Scripts/jquery.tablednd.js"></script>
    ...
    <div id="Pbody_box_inventory" style="width: 1304px; text-align: left;">
        ...
        <div class="POuter_Box_Inventory" style="width: 1300px; text-align: center">
            <b> <asp:Label ID="lblVerificationType"  runat="server"></asp:Label>  Admin Verification </b>
            <br />
                        ...
                        <table style="width: 100%; border-collapse: collapse">
                            <tr>
                                ...
                                <td style="width: 24%">
                                    ...
                                    <asp:DropDownList ID="ddlType" runat="server" Width="146px" onchange="selectPatientType()">
                                    </asp:DropDownList>
                                </td>
                                <td style="text-align: right; width: 14%"><b>Patient&nbsp;Type&nbsp;:&nbsp;</b></td>
                                <td style="width: 20%">
                                    <asp:DropDownList ID="ddlPanelGroup" runat="server" Width="146px">
                                    </asp:DropDownList>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtPUPName" runat="server" Width="240px" MaxLength="50" AutoCompleteType="Disabled" style="text-transform:uppercase"></asp:TextBox>
                                </td>
...
<th class="GridViewHeaderStyle EnrollVerified" scope="col" style="width: 90px; text-align: center;display:none">Created Date</th>
                            ...
                            <tr>
                             ...
                             <tr>                               
                                ...
                                <td style="text-align: right"><b>Invoice To :&nbsp;</b></td>
                                <td>
                                    <asp:DropDownList ID="ddlInvoiceTo" runat="server" ToolTip="Select Invoice To" Width="166px">
                                    </asp:DropDownList></td>
                            </tr>  
                            <tr>
                                <td style="text-align: right"><b>Cheque No. :&nbsp;</b> </td>
                                <td>
                                    <asp:TextBox ID="txtChequeNo" runat="server" Width="160px" MaxLength="50" AutoCompleteType="Disabled"> </asp:TextBox></td>
                                <td style="text-align: right"><b>Cheque Date :&nbsp;</b></td>
                                <td>
                                    <asp:TextBox ID="txtChequeDate" runat="server" Width="160px" MaxLength="50" AutoCompleteType="Disabled"> </asp:TextBox>
                                    <cc1:CalendarExtender ID="calChequeDate" runat="server" TargetControlID="txtChequeDate"  Format="dd-MMM-yyyy"></cc1:CalendarExtender>
                                </td>
                                <td style="text-align: right"><b>Cheque Amt. :&nbsp;</b></td>
                                <td>
                                    <asp:TextBox ID="txtChequeAmt" runat="server" Width="160px" MaxLength="50" AutoCompleteType="Disabled" onkeypress="return checkForSecondDecimal(this,event)"> </asp:TextBox>
                                    <cc1:FilteredTextBoxExtender ID="ftbChequeAmt" runat="server" TargetControlID="txtChequeAmt" ValidChars=".0123456789"></cc1:FilteredTextBoxExtender>
                                </td>
                            </tr>
                            <tr>
                                <td style="text-align: right"><b>Pan No. :&nbsp;</b></td>
                                <td>
                                   <asp:TextBox ID="txtPanNo" runat="server" Width="160px" MaxLength="50" AutoCompleteType="Disabled"> </asp:TextBox></td>
                                <td style="text-align: right"><b>Owner Name :&nbsp;</b> </td>
                                <td>
                                    <asp:TextBox ID="txtOwnerName" runat="server" Width="160px" MaxLength="50" AutoCompleteType="Disabled"> </asp:TextBox></td>
                                <td style="text-align: right">&nbsp;</td>
                                <td>
                                    &nbsp;</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td >
                                     <asp:DropDownList ID="ddlTagProcessingLab" runat="server" Width="166px">
                                    </asp:DropDownList>
                                    
                                </td>
                                 <td style="text-align: right;display:none">
                                   <b>Online&nbsp;UserName&nbsp;:&nbsp;</b></td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="txtCreditLimit" runat="server" Width="160px" MaxLength="10" AutoCompleteType="Disabled" onkeypress="return checkForSecondDecimal(this,event)"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMinCash" runat="server" Text="0" Width="50px" onkeyup="chkMinCash()" AutoCompleteType="Disabled" onkeypress="return checkForSecondDecimal(this,event)" />
                                ...
                                <td style="text-align: left" colspan="2">
                                    ...
                                    <span style="font-weight:bold;"><a href="javascript:void(0)" onclick="showuploadbox()" style="color:blue;">Attach Agreement/MOU/Blank Cheque</a></span> </td>
                            </tr>                            
                                  <tr>
                                ...
                                <td colspan="3">
                                   <asp:TextBox ID="txtInvoiceDisplayAddress" runat="server" MaxLength="100"  Width="280px"></asp:TextBox></td>
                            ...
                            <tr id="tr_HLM">
                                ...
                                <td>                              
                                    <asp:TextBox ID="txtMinBusinessComm" Width="160px" AutoCompleteType="Disabled" runat="server" onkeyup="chkVerification()"  MaxLength="10" onkeypress="return checkForSecondDecimal(this,event)"></asp:TextBox>
                              ...
                              <asp:TextBox ID="txtActualMinBusinessComm" Width="140px" runat="server"  MaxLength="10"  style="display:none"></asp:TextBox>
                                ...
                                <td>
                                    <asp:TextBox ID="txtMRPPercentage"  style="display:none" AutoCompleteType="Disabled" runat="server"  Width="50px" onkeyup="chkMRPPercentage()" onkeypress="return checkForSecondDecimal(this,event)" />
                                            <cc1:FilteredTextBoxExtender ID="ftbMRPPercentage" runat="server" ValidChars="0123456789"  TargetControlID="txtMRPPercentage" />
                               
                               <asp:TextBox ID="txtActualMRPPercentage"  style="display:none" runat="server"  Width="50px" />
                        ...
                        <tr id="tr_HLMMRP">
                            ...
                            <tr>
                                <td style="text-align: left"  >&nbsp;
                                 ...
                                 <td style="text-align: left"  ><div class="alertMsg" style="position:absolute;left:30%;border-radius:15px;z-index:11111;text-align:center">
                            ...
                            <tr class="trSpecialTest">
                                ...
                                <td colspan="5">
                                    <div id="divSpecialtest1" style="max-height: 100px; overflow-y: auto; overflow-x: hidden;">                                       
                                        </div>
                                    <div id="divSpecialtest" style="margin-top: 5px; max-height: 500px;  overflow-y: auto; overflow-x: hidden; width: 100%;">
                            <table id="tb_grdSpecialTest" style="width: 98%; border-collapse: collapse;display:none">
                                <tr id="InvHeader" class="nodrop">                                                                                                       
                                    ...
                                    <td class="GridViewHeaderStyle" style="width: 480px; text-align: center">Test Name</td>
                          ...
                          <td colspan="5">
                            ...
                            <table id="tblHLMPackageTest" style="width: 98%; border-collapse: collapse;display:none">
                                <tr id="trHLMPackageHeader" >                                                                                                       
                                    ...
                                    <td class="GridViewHeaderStyle" style="width: 110px; text-align: center">&nbsp;</td>
                                    <td class="GridViewHeaderStyle" style="width: 70px; text-align: center">&nbsp;</td>  
                            ...
                            <tr>
                                <td colspan="6" style="text-align: center">                                 
                                    <input type="button" value="Approve" class="searchbutton" id="btnApprove" onclick="ApproveVerifyEnrolment(2)" style="font-weight: bold;" />
                                    <input type="button" value="UnApprove" class="searchbutton" id="btnUnApprove" onclick="UnApprove()" style="font-weight: bold;display:none" />
                                    ...
                                    <span class="clReason" style="display:none"> Reason :&nbsp;<input type="text" id="txtReason" style="display:none" maxlength="100" /></span>
                                   &nbsp;&nbsp; <span id="spnUnApproveReason" style="display:none"><b>UnApprove Reason :&nbsp;</b><input type="text" id="txtUnApproveReason" style="display:none" maxlength="100" /></span>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <script type="text/javascript">
        ...
        jQuery(function () {
            ...
            getPaymentCon();
            if (jQuery("#lblVerificationType").text() == "Financial") {
                jQuery("#btnUnApprove,#spnUnApproveReason,#txtUnApproveReason").show();
            }
            else {
                jQuery("#btnUnApprove,#spnUnApproveReason,#txtUnApproveReason").hide();
            }
        });
    ...
    <script type="text/javascript">
        ...
        function selectPatientType() {
            ...
            if (jQuery("#ddlType option:selected").text() == "PUP") {
                ...
                jQuery("#txtMRPPercentage,.trSpecialTest,#tr_HLM").show()
                ...
                jQuery(".addressDetail,#tr_HLMMRP,.trSpecialTest,.trHLMPackage").show();
                jQuery("#div_PCCGrouping,#tr_HLM,.trMarketingCampaignTest").hide();
                ...
                jQuery('.clAddress,.clMobileNo').removeAttr('style');
                jQuery("#ddlPanelGroup").val('1');
                jQuery("#ddlPanelGroup").attr('disabled', 'disabled');
                jQuery(".addressDetail,.trSpecialTest,#txtMRPPercentag,#tr_HLM").show();
                ...
                jQuery("#ddlTagProcessingLab option[value='0']").remove();
                jQuery("#ddlReferringRate").removeAttr('disabled');
                jQuery("#tr_HLMMRP,.trHLMPackage,.trMarketingCampaignTest").hide();
            }
            else {
                jQuery('.clBusinessZone,.clState,.clHeadQuarter,.clCity,.clCityZone,.clLocality,.clTagRegistrationLab').css('color', 'red');
                jQuery('.clAddress,.clMobileNo,.clMinBusinessCommit,.clMRPPercentage').removeAttr('style');
                ...
                jQuery(".trSpecialTest,#div_PCCGrouping,#tr_HLMMRP,#tr_HLM,.trMarketingCampaignTest,.trHLMPackage").hide();
                jQuery("#ddlReferringRate").removeAttr('disabled');
                jQuery("#tblMarketingTest tr:not(#trMarketingTest)").remove();
            }
        }     
        function ValidateEnrolment() {
            ...
            if (jQuery("#ddlType option:selected").text() == "PCC" || jQuery("#ddlType option:selected").text() == "PUP") {
                jQuery("#tb_grdSpecialTest > tbody > tr").each(function () {
                    ...
                    if (id != "InvHeader") {
                        ...
                        if ((!jQuery(this).closest('tr').find("#chkSelect").is(':visible') || jQuery(this).closest('tr').find("#chkSelect").is(':checked')) && jQuery(this).closest('tr').find("#txtMinimumSales").is(':visible') && jQuery.trim(jQuery(this).closest('tr').find("#txtMinimumSales").val()) == "") {
                            showSaveErrorMsg('Enter Min. Sales Comm.');
                            jQuery(this).closest('tr').find("#txtMinimumSales").focus();
                            MinimumSales = 1;
                            checkedCount += 1;
                            con = 1;
                            return con;
                        }
                        if ((!jQuery(this).closest('tr').find("#chkSelect").is(':visible') || jQuery(this).closest('tr').find("#chkSelect").is(':checked')) && jQuery(this).closest('tr').find("#txtSalesDuration").is(':visible') && jQuery.trim(jQuery(this).closest('tr').find("#txtSalesDuration").val()) == "") {
                        ...
                        if ((!jQuery(this).closest('tr').find("#chkSelect").is(':visible') || jQuery(this).closest('tr').find("#chkSelect").is(':checked')) && jQuery(this).closest('tr').find("#txtIntimationDays").is(':visible') && jQuery.trim(jQuery(this).closest('tr').find("#txtIntimationDays").val()) == "") {
                        ...
                        if (jQuery("#ddlType option:selected").text() == "PCC" && (parseFloat(jQuery.trim(jQuery(this).closest('tr').find("#txtIntimationDays").val()))) > parseFloat(jQuery.trim(jQuery(this).closest('tr').find("#txtSalesDuration").val()))) {
            ...
            var PCCMarketingFromDate = 0; var PCCMarketingToDate = 0; var PCCMarketingOfferMRP = 0; var PCCMarketingPCCShare = 0;
            if (jQuery("#ddlType option:selected").text() == "PCC") {
                    ...
                    if (id != "trMarketingTest") {
                        if ($rowid.find(".img_MarketDelete").is(':visible')) {
                            ...
                            if ($rowid.find("#txtFromDate_" + MarketItemID).val() == "") {
                                ...
                                jQuery(this).closest('tr').find("#txtFromDate_" + MarketItemID).focus();
                                PCCMarketingFromDate = 1;
                                return PCCMarketingFromDate;
                            }
                            if ($rowid.find("#txtToDate_" + MarketItemID).val() == "") {
                                showSaveErrorMsg('Enter Marketing Campaign To Date ');
                                jQuery(this).closest('tr').find("#txtFromDate_" + MarketItemID).focus();
                                PCCMarketingToDate = 1;
                                return PCCMarketingToDate;
                            }
                            if ($rowid.find("#txtOfferMRP").val() == "") {
                                showSaveErrorMsg('Enter Marketing Campaign Offer MRP ');
                                jQuery(this).closest('tr').find("#txtOfferMRP").focus();
                                PCCMarketingOfferMRP = 1;
                                return PCCMarketingOfferMRP;
                            }
                            if ($rowid.find("#txtMarketPCCShare").val() == "") {
                                showSaveErrorMsg('Enter Marketing Campaign PCCShare ');
                                jQuery(this).closest('tr').find("#txtMarketPCCShare").focus();
                                PCCMarketingPCCShare = 1;
                                return PCCMarketingPCCShare;
                            }
                        }
                ...
                if (PCCMarketingFromDate == "1") {
                    showSaveErrorMsg('Enter Marketing Campaign From Date ');
                    con = 1;
                    return con;
                }
                if (PCCMarketingToDate == "1") {
                    showSaveErrorMsg('Enter Marketing Campaign To Date ');
                    con = 1;
                    return con;
                }
                if (PCCMarketingOfferMRP == "1") {
                    showSaveErrorMsg('Enter Marketing Campaign Offer MRP ');
                    con = 1;
                    return con;
                }
                if (PCCMarketingPCCShare == "1") {
                    showSaveErrorMsg('Enter Marketing Campaign PCCShare ');
                    con = 1;
                    return con;
                }
    ...
    <script type="text/javascript">
        ...
        function panelMaster() {
            ...
            objPanel.AttachedFileName = jQuery('#lblFileName').text();
            ...
            objPanel.VerificationType = jQuery.trim(jQuery("#lblVerificationType").text());
            ...
            objPanel.ChequeNo = jQuery('#txtChequeNo').val();
            objPanel.ChequeDate = jQuery('#txtChequeDate').val();
            objPanel.ChequeAmt = jQuery('#txtChequeAmt').val();
            objPanel.PanNo = jQuery('#txtPanNo').val();
            objPanel.OwnerName = jQuery('#txtOwnerName').val();
                ...
                if (id != "InvHeader") {
                    ...
                    if (($rowid.find("#chkSelect").is(':checked') || $rowid.find(".img_Delete").is(':visible'))) {
                        ...
                        if (jQuery("#lblEnrollID").text() == "" && jQuery("#ddlType option:selected").text() == "PUP" && jQuery.trim($rowid.find("#tdIsNewTest").text() == 0)) {
                            ...
                            if (parseFloat(jQuery.trim($rowid.find("#txtSpecialRate").val())) < (parseFloat(TestRate))) {
    ...
    <script type="text/javascript">
        ...
        jQuery('#txtPUPName').change(function () {
            jQuery.ajax({
                url: "EnrolmentVerification.aspx/checkesixts",
                data: '{"companyName":"' + jQuery(this).val() + '","EnrollID":"' + jQuery("#lblEnrollID").text() + '"}',
                type: "POST",
                async: false,
                dataType: "json",
                ...
                success: function (data) {
                    if (data.d == 1) {
                        jQuery('#lblMsg').html('Name already exists in system !.');
                    }
                    else {
                        jQuery('#lblMsg').html('');
                    }
    ...
    <script type="text/javascript">
        function bindSalesHierarchy() {
            jQuery("#tbSelected tr:not(#salesHead)").remove();         
                PageMethods.bindSalesHierarchy( jQuery("#lblEnrollID").text(), onSucessSalesHierarchy, onFailureSalesHierarchy)                        
        }
    ...
    <script type="text/javascript">
        ...
        function checkRateLimit(rowID) {
            ...
            if ((parseInt(jQuery(rowID).closest('tr').find('#tdIsNewTest').text()) == 1)) {
                jQuery("#tb_grdSpecialTest > tbody > tr").each(function () {
                    var id = jQuery(this).attr("id");
                    var $rowid = jQuery(this).closest("tr");
                    if (id != "InvHeader") {
    ...
    <script type="text/javascript">
        ...
        function clearform() {
            ...
            jQuery("#txtPUPName,#txtAddress,#txtLandline,#txtMobile,#txtEmailInvoice,#txtEmailReport,#txtIFSCCode,#txtGSTTIN,#txtAccountNo,#txtIFSCCode,#txtOnlinePassword,#txtOnlineUserName,#txtCreditLimit,#txtMinCash,#txtMinBusinessComm,#txtMRPPercentage,#txtInvoiceDisplayName,#txtInvoiceDisplayAddress,#txtChequeNo,#txtChequeDate,#txtChequeAmt,#txtPanNo,#txtOwnerName").val('');
            jQuery("#txtCreditLimit").val('0').attr('disabled', 'disabled');
            ...
            jQuery("#btnVerify,#spnMRPPercentage,#txtMRPPercentage").hide();
            jQuery("#txtStateCity").val('');
        ...
        function showuploadbox() {
            ...
            if (jQuery('#lblFileName').text() == "") {
                ...
                FileName = jQuery('#lblFileName').text();
            }
    ...
    <script type="text/javascript">
        function bindEnrollSpecialTest(type) {
            if ((type == "PCC" || type == "PUP" || type == "HLM")) {
                PageMethods.bindEnrollSpecialTest(type, jQuery("#lblEnrollID").text(), onSucessEnrolSpecialTest, onFailureSpecialTest);
            }
            else {
        ...
        function onSucessEnrolSpecialTest(result) {
            ...
            if (specialTest != null) {
                ...
                for (var i = 0; i < specialTest.length; i++) 
                {
                    ...
                    appendText.push('<td id="tdSpecialRate" style="text-align: center"><input type="text" onkeyup="chkVerification();calculateTotalValue(this)" style="width:70px;" autocomplete="off"  id="txtSpecialRate" value="' + specialTest[i].TestRate + '" onkeypress="return checkNumeric(event,this);" maxlength="6"/> <input type="text" style="width:70px;display:none"  id="txtActSpecialRate" value="' + specialTest[i].TestRate + '" /> </td>');
                    ...
                    if (jQuery("#ddlType option:selected").text() == "PUP" && specialTest[i].IsNewTest == 0) {
                        ...
                        appendText.push('<td id="tdMinimumSales" style="text-align: center"><input type="text" style="width:70px;" autocomplete="off" onkeyup="chkVerification();calculateTotalValue(this)" id="txtMinimumSales" value="' + specialTest[i].MinimumSales + '" onkeypress="return checkNumeric(event,this);" maxlength="6"/> <input type="text" style="width:70px;display:none"  id="txtActMinimumSales" value="' + specialTest[i].MinimumSales + '" /> </td>');
                        appendText.push('<td id="tdSalesDuration" style="text-align: center"><input type="text" style="width:70px;" autocomplete="off" onkeyup="chkVerification()" id="txtSalesDuration" value="' + specialTest[i].SalesDuration + '" onkeypress="return checkNumeric(event,this);" maxlength="6"/> <input type="text" style="width:70px;display:none"  id="txtActSalesDuration" value="' + specialTest[i].SalesDuration + '" /> </td>');
                        appendText.push('<td id="tdIntimationDays" style="text-align: center"><input type="text" style="width:70px;" autocomplete="off" onkeyup="chkVerification()" id="txtIntimationDays" value="' + specialTest[i].IntimationDays + '" onkeypress="return checkNumeric(event,this);" maxlength="6"/> <input type="text" style="width:70px;display:none"  id="txtActIntimationDays" value="' + specialTest[i].IntimationDays + '" /></td>');
                        appendText.push('<td id="tdTotalValue" style="text-align: center"><input type="text" style="width:70px;" autocomplete="off" onkeyup="chkVerification()" id="txtTotalValue" value="' + specialTest[i].TotalValue + '" onkeypress="return checkNumeric(event,this);" maxlength="6"/></td>');
                ...
                if (jQuery("#lblVerificationType").text() == "Financial") {
                    ...
                    jQuery("#tb_grdPCCGrouping :input").attr("disabled", "disabled");
                }
            }
            else {
                jQuery('#divSpecialtest').hide();
    ...
    <script type="text/javascript">
        function ApproveVerifyEnrolment(Approve) {
            ...
            if (jQuery('#lblIsApprove').text() == "1" && jQuery.trim( jQuery("#txtReason").val())=="") {
                showerrormsg('Enter Reason');
                ...
                jQuery.ajax({
                    url: "EnrolmentVerification.aspx/approveEnrolment",
                    data: JSON.stringify({ Panel: resultPanel, Employee: resultEmployee, TestEnrolment: resultTestEnrolment, PCCGrouping: resultPCCGrouping, MarketingCampaignTest: resultCampaignTest, HLMPackage: resultHLMPackage, Reason: Reason }),
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    timeout: 120000,
                    dataType: "json",
                    success: function (result) {
                        if (result.d != "1" && result.d != "2" ) {
                            ...
                            if(jQuery("#lblVerificationType").text()=="Sales")
                                location.href = 'SalesVerification.aspx';
                            else
                                location.href = 'FinancialVerification.aspx';
                        }
                        else {
                            alert('Error...');
                        }
    ...
    <script type="text/javascript">
        function bindHeadQuarter() {
            ...
            if (jQuery("#ddlState").val() != "0") {
                jQuery.ajax({
                    url: "EnrolmentVerification.aspx/bindHeadQuarter",
                    ...
                    success: function (result) {
                        ...
                        if (HeadQuarterData.length == 0) {
                            ...
                            jQuery("#ddlHeadQuarter").attr('disabled', 'disabled');
                        }
                    },
                    error: function (xhr, status) {
        ...
        function bindCity() {
            ...
            if (jQuery("#ddlHeadQuarter").val() != "0") {
                jQuery.ajax({
                    url: "EnrolmentVerification.aspx/bindCityByHeadQuarter",
        ...
        function bindZone() {
            ...
            if (jQuery("#ddlCity").val() != "0") {
                jQuery.ajax({
                    url: "EnrolmentVerification.aspx/bindZone",
        ...
        function bindLocality() {
            ...
            if (jQuery("#ddlZone").val() != "0") {
                jQuery.ajax({
                    url: "EnrolmentVerification.aspx/bindLocalityByZone",
        ...
        function bindState() {
            ...
            if (jQuery("#ddlBusinessZone").val() != 0) {
                jQuery.ajax({
                    url: "EnrolmentVerification.aspx/bindState",
    ...
    <script type="text/javascript">
        ...
        function hideShowHeader() {
            ...
            if (jQuery("#ddlType option:selected").text() == "PUP") {
                ...
                jQuery(".testRateLimit,.minSalesComm,.salesDuration,.IntimationDays").hide();
                jQuery(".specialRateReq").show();
            ...
            jQuery.ajax({
                ...
                success: function (result) {
                    ...
                    if (TestData.length == 0) {
                        ...
                        mydata.push('<a href="javascript:void(0);" onclick="deleteItemNode(jQuery(this));"><img class="img_Delete" src="../../App_Images/Delete.gif"  title="Click to Remove Item"/></a>');
                        ...
                        if (jQuery("#ddlType option:selected").text() == "PUP") {
                            mydata.push('<td id="tdTestRate" style="text-align: right;font-weight:bold;">');
                            mydata.push(' </td>');

                        }
                        if (jQuery("#ddlType option:selected").text() != "HLM") {
                            mydata.push('<td id="tdSpecialRate" style="text-align: center"><input type="text" style="width:70px;" autocomplete="off"  id="txtSpecialRate" value="" onkeyup="calculateTotalValue(this)" onkeypress="return checkNumeric(event,this);" maxlength="6"/></td>');
                            mydata.push('<td id="tdMinimumSales" style="text-align: center"><input type="text" style="width:70px;"  autocomplete="off" id="txtMinimumSales" value="" onkeyup="calculateTotalValue(this)" onkeypress="return checkNumeric(event,this);" maxlength="6"/></td>');
                            ...
                            mydata.push('<td id="tdSpecialRate" style="text-align: center"><input type="text" style="width:70px;" autocomplete="off"  id="txtSpecialRate" value="" onkeyup="calculateTotalValue(this)" onkeypress="return checkNumeric(event,this);" maxlength="6"/></td>');
                            mydata.push('<td id="tdSpecialRate" style="text-align: center">');
                            mydata.push('<input type="radio" title="Net Price" name="HLMPrice_' + TestData[0].ItemID + '" id="rbHLMNetPrice" checked="checked" value="Net" />Net Price');
                        ...
                        mydata = mydata.join(" ");
                        jQuery('#tb_grdSpecialTest').append(mydata);
                        jQuery('#tb_grdSpecialTest').css('display', 'block');
     ...
     <script type="text/javascript">
         ...
         function onSuccessGrouping(result) {
             ...
             ChkAcPCCGrouping = 0;
             ChkAcPCCGrouping = parseInt(jQuery(".clPCCGrouping:checked").length);
             if (jQuery("#lblVerificationType").text() == "Financial") {
                 jQuery("#tb_grdPCCGrouping :input").attr("disabled", "disabled");
             }
         }
     ...
     <script id="tb_PCCGrouping" type="text/html">      
       ...
       <#      
        ...
        objRow = PCCGroupingData[j];
                 #>            
            <tr>                                 
            <td class="GridViewLabItemStyle" style="text-align:center;" ><#=j+1#><input type="checkbox" class="clPCCGrouping Financial" id="chkPCCGrouping"  onclick="chkVerification()"
                <#
                if(objRow.IsCheck=="1")
                {#>
                checked="checked"
            ...
            <td  class="GridViewLabItemStyle" style="text-align:center;text-align:left"><#=objRow.GroupName#></td>
                <td  class="GridViewLabItemStyle" style="text-align:center;text-align:left">
                    <input type="text"  style="width:80px" id="txtPCCGroupShare" autocomplete="off" value="<#=objRow.PCCGroupSharePer#>"  onkeyup="chkPCCGroupShare(this)" onkeypress="return checkNumeric(event,this);" maxlength="3"/>
                     <input type="text"  style="width:80px;display:none" id="txtActualPCCGroupShare" value="<#=objRow.PCCGroupSharePer#>"   maxlength="3"/>
                </td>
     ...
     <script id="tb_PCCGroupingTest" type="text/html">      
        <table class="GridViewStyle" cellspacing="0" rules="all" border="1" id="tb_grdPCCGroupingTest" style="border-collapse:collapse;width:580px;"> 
            <thead>
		<tr>
            ...
            <th class="GridViewHeaderStyle" scope="col" style="width:420px;">Item Name</th>						                 
        </tr>
                </thead>
       <#      
    ...
    <script type="text/javascript">
     ...
     <asp:Button ID="btnGroupTest" runat="server" Style="display:none" />
    <cc1:ModalPopupExtender ID="mpGroupTest" runat="server"
                            DropShadow="true" TargetControlID="btnGroupTest" CancelControlID="closeGroupTest" BackgroundCssClass="filterPupupBackground"
                            PopupControlID="pnlGroupTest"  OnCancelScript="closeGroupTest()"  BehaviorID="mpGroupTest">
                        </cc1:ModalPopupExtender>  
    <asp:Panel ID="pnlGroupTest" runat="server" Style="display: none;width:620px; height:400px; " CssClass="pnlVendorItemsFilter"> 
             <div  class="Purchaseheader">
        <table style="width:100%; border-collapse:collapse" border="0">                                                  
                <tr>                                      
                    <td  style="text-align:right">      
                        <img id="closeGroupTest" alt="1" src="../../App_Images/Delete.gif"  style="cursor:pointer;" title="Click to Close" />  
                    </td>                    
                </tr>
            </table>   
      </div>
              <table style="width: 100%;border-collapse:collapse">               
                  <tr>
                      <td>
            <div id="div_GroupTest" style="text-align:center;width: 99%; max-height:370px;overflow-y:scroll;">                
            </div>                 
                      </td>
                  </tr>                     
                </table>    
    ...
    <script type="text/javascript">        
        function chkVerification() {
            ...
            if (isNaN(MinBusinessComm) || MinBusinessComm == "")
                MinBusinessComm = 0;
            if (parseFloat(MinBusinessComm) != jQuery("#txtActualMinBusinessComm").val()) {
                chkCon = 1;
                showHideButton(chkCon);
                return;
            }
            var MRPPercentage = jQuery("#txtMRPPercentage").val();
            if (isNaN(MRPPercentage) || MRPPercentage == "")
                MRPPercentage = 0;
            if (parseFloat(MRPPercentage) != jQuery("#txtActualMRPPercentage").val()) {
                chkCon = 1;
                showHideButton(chkCon);
                return;
            }
            if (jQuery("#ddlType option:selected").text() == "PCC") {               
                if (parseInt(ChkAcPCCGrouping) != parseInt(parseInt(jQuery(".clPCCGrouping:checked").length))) {
                    chkCon = 1;
                    showHideButton(chkCon);
                    return;
                }              
                jQuery("#tb_grdPCCGrouping > tbody > tr").each(function () {
                    var id = jQuery(this).attr("id");
                    var $rowid = jQuery(this).closest("tr");

                    if (id != "PCCGroupingHeader") {
                        if ($rowid.find("#chkPCCGrouping").is(':checked')) {
                            if (parseFloat(jQuery(this).closest('tr').find('#txtPCCGroupShare').val()) != parseFloat(jQuery(this).closest('tr').find('#txtActualPCCGroupShare').val())) {
                                chkCon = 1;                                
                            }
                        }
                    }
            ...
            if (jQuery(".clIsNewTest").length > 0) {
                chkCon = 1;
                showHideButton(chkCon);
                return;
            }           
            if (parseInt(chkActSpecialtest) != parseInt(parseInt(jQuery(".chk_Select:checked").length) + parseInt(jQuery(".img_Delete").length))) {
                chkCon = 1;
                showHideButton(chkCon);
                return;
            }            
            jQuery("#tb_grdSpecialTest > tbody > tr").each(function () {
                ...
                if (id != "InvHeader") {
                    if (jQuery(this).closest('tr').find("#chkSelect").is(':checked')) {
                        if (parseFloat(jQuery(this).closest('tr').find("#txtSpecialRate").val()) != parseFloat(jQuery(this).closest('tr').find("#txtActSpecialRate").val())) {
                            chkCon = 1;                           
                        }
                        if (parseFloat(jQuery(this).closest('tr').find("#txtMinimumSales").val()) != parseFloat(jQuery(this).closest('tr').find("#txtActMinimumSales").val())) {
                            chkCon = 1;                            
                        }
                        if (parseFloat(jQuery(this).closest('tr').find("#txtSalesDuration").val()) != parseFloat(jQuery(this).closest('tr').find("#txtActSalesDuration").val())) {
                            chkCon = 1;                            
                        }
                        if (parseFloat(jQuery(this).closest('tr').find("#txtIntimationDays").val()) != parseFloat(jQuery(this).closest('tr').find("#txtActIntimationDays").val())) {
                            chkCon = 1;                           
                        }
                    }
                }
        ...
        function showHideButton(chkCon) {
            //if (chkCon == 0) {
            //    jQuery("#btnApprove").show();
            //    jQuery("#btnVerify,.clReason,#txtReason").hide();
            //    jQuery("#txtReason").val('');
            //}
            //else {
            //    jQuery("#btnApprove").hide();
            //    jQuery("#btnVerify").show();
            //    jQuery(".clReason,#txtReason").show();
            //    jQuery("#txtReason").val('');
            //}
            jQuery("#btnApprove").show();
            jQuery("#btnVerify,.clReason,#txtReason").hide();
        ...
        jQuery(function () {
            ...
            if (jQuery("#lblVerificationType").text() == "Financial") {
                ...
                jQuery("#ddlTagProcessingLab,#ddlReferringRate,#ddlInvoiceTo,#txtMinBusinessComm,#txtMRPPercentage,#txtNewInvestigation,#txtMinCash,#txtCreditLimit").attr('disabled', 'disabled');
    ...
    <script type="text/javascript">
        function UnApprove() {
            if (jQuery.trim(jQuery("#txtUnApproveReason").val()) == "") {
                showerrormsg('Enter UnApproval Reason');
                jQuery("#txtUnApproveReason").focus();

            }
            else {
                jQuery.blockUI({ message: 'Please Wait.....\n<img src="../../App_Images/Progress.gif" />' });
                PageMethods.UnApproveFinance(jQuery("#lblEnrollID").text(), jQuery("#txtUnApproveReason").val(), onSucessUnApprove, onFailureUnApprove);

            }
        }
        function onSucessUnApprove(result) {
           
            if (result == "1") {
                showerrormsg("Already Financial Approved");
            }
            else if (result == "2") {
                showerrormsg("Already Enrolled");
            }
            else if (result == "3") {
                showerrormsg("Financial UnApproved Successfully");
                if (jQuery("#lblVerificationType").text() == "Sales")
                    location.href = 'SalesVerification.aspx';
                else
                    location.href = 'FinancialVerification.aspx';
        ...
        function onFailureUnApprove(result) {
            jQuery.unblockUI();
        }
    </script>
    <script type="text/javascript">
        ...
        <script type="text/javascript">
            ...
            function deleteHLMItem(row) {
                ...
                var len = RmvInv.length;
                HLMPackageData.splice(jQuery.inArray(RmvInv[0], HLMPackageData), len);
                row.closest('tr').remove();
            ...
            function addHLMPackage() {
                ...
                mydata.push('<td id="tdHLMTestWiseRate" style="font-weight:bold;text-align: center">');
            ...
            function onSucessHLMPackage(result) {
                ...
                if (getHLMPackageData != null) {
                    for (var a = 0; a <= getHLMPackageData.length - 1; a++) {
                        marketInvList.push(getHLMPackageData[a].ItemID);
                        if (jQuery('#tblHLMPackageTest tr:not(#trHLMPackageHeader)').length == 0)
                ...
                if (jQuery("#lblVerificationType").text() == "Financial") {
                    jQuery("#txtHLMItemName,#txtHLMPackageName").attr("disabled", "disabled");
      ...
      <script id="tb_PackageView" type="text/html">      
       ...
       <#      
        ...
        objRow = PackageViewData[j];
            ...
            <td class="GridViewLabItemStyle" style="text-align:center;" ><#=j+1#></td>                
            <td  class="GridViewLabItemStyle" style="text-align:center;"><#=objRow.TestCode#></td>
            <td  class="GridViewLabItemStyle"  style="text-align:left;"><#=objRow.ItemName#></td>               

...
public partial class BrowseDirectory : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            //TreeNode onjParent = new TreeNode(Server.MapPath("~/Design"), Server.MapPath("~/Design"));
            //onjParent.PopulateOnDemand = true;
            //TreeView1.Nodes.Add(onjParent);

            //TreeView1.CollapseAll();
            _browseTextBox.Text = Server.MapPath("~/Design");
    ...
    private void TreeView1_TreeNodeCollapsed(object sender, TreeNodeEventArgs e)
    {
        //throw new Exception("The method or operation is not implemented.");
    }

    private void TreeView1_TreeNodeExpanded(object sender, TreeNodeEventArgs e)
    {

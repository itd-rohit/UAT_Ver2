<%@ Page Language="C#"  ClientIDMode="Static" AutoEventWireup="true" CodeFile="ImportExportRateList.aspx.cs" Inherits="Design_Master_ImportExportRateList" %>
...
<Scripts>
     ...
     <asp:ScriptReference Path="~/Scripts/Common.js" />
        ...
        <div class="POuter_Box_Inventory" style="text-align:center">
            <div class="row">
                <div class="col-md-24"> <b>Import Export Rate List </b>
                            <br />
                    ...
                    <div class="POuter_Box_Inventory">
                        <div class="row">
                            <div class="col-md-4">Panel : </div> 
                             <div class="col-md-5"> <asp:DropDownList ID="ddlPanel" runat="server" CssClass="ItDoseDropdownbox"
                                TabIndex="1" Width="150px">
                            </asp:DropDownList> </div>
                            <div class="col-md-4">Billing Category : </div> 
                             <div class="col-md-5"> <asp:DropDownList ID="ddlBillCategory" runat="server" CssClass="ItDoseDropdownbox"
                                TabIndex="1" Width="150px">
                            </asp:DropDownList> </div> 
                             <div class="col-md-6">  <asp:LinkButton ID="LinkButton1" runat="server" Text="Download RateList File" OnClientClick="DownloadRateList()" Style="float: left;"></asp:LinkButton></div>
            ...
            <div class="row">
                <div class="col-md-4">Select File:</div>
                  <div class="col-md-12"> <asp:FileUpload ID="file1" runat="server" /></div>
                <div class="col-md-8"> <asp:Button ID="btnupload" runat="server" Text="Upload" OnClick="btnupload_Click" Style="cursor: pointer; padding: 5px; color: white; background-color: blue; font-weight: bold;" />
                   <asp:Button ID="btnsave" runat="server" Text="Save To DataBase" OnClick="btnsave_Click" Style="cursor: pointer; padding: 5px; color: white; background-color: blue; font-weight: bold;cursor:not-allowed" Enabled="false" /></div>                             
                                ...
                                <asp:GridView Width="90%" ID="grd" runat="server" BackColor="#CCCCCC" BorderColor="#999999" BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" ForeColor="Black" AutoGenerateColumns="False" OnRowDataBound="grd_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ItemName" HeaderText="NAME" />
                                         <asp:BoundField DataField="BillCategory" HeaderText="BillingCategory" />
    ...
    <%--Loading Panel--%>
        ...
        <script>          
            ...
            function DownloadRateList() {
                ...
                var BillCategoryID = $('[id$=ddlBillCategory]').val();
                ...
                try {
                    serverCall('ImportExportRateList.aspx/DownloadRateList', { PanelId: PanelId, PanelName: PanelName, BillCategoryID: BillCategoryID }, function (response) {

<%@ Page Language="C#" MasterPageFile="~/Design/DefaultHome.master" ClientIDMode="Static" AutoEventWireup="true" CodeFile="AmmendmentReport.aspx.cs" Inherits="Design_Lab_AmmendmentReport" %>
        ...
        <div class="POuter_Box_Inventory" style="width: 1300px;">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                         <asp:ListBox ID="ddlSubcategory" CssClass="multiselect" SelectionMode="Multiple" runat="server" Width="300px"></asp:ListBox>
                    </td>
                    <td>
                    </td>
                    <td>
    ...
    <script type="text/javascript">
        ...
        function bindCentre() {
         ...
         //   jQuery.blockUI({ message: 'Please Wait.....\n<img src="../../App_Images/Progress.gif" />' });
            $.ajax({
                url: "AmmendmentReport.aspx/bindCentre",
                data: '{}',
                type: "POST",
        ...
        function bindSubcategory() {
            $('#<%=ddlSubcategory.ClientID%> option').remove();
             jQuery('#<%=ddlSubcategory.ClientID%>').multipleSelect("refresh");
           //  jQuery.blockUI({ message: 'Please Wait.....\n<img src="../../App_Images/Progress.gif" />' });
             $.ajax({
                 url: "AmmendmentReport.aspx/bindSubCategory",
                 data: '{}',
                 type: "POST",
                 contentType: "application/json; charset=utf-8",
                 timeout: 120000,
                 ...
                 success: function (result) {
                     ...
                     for (var a = 0; a <= data.length - 1; a++) {
                         jQuery('#<%=ddlSubcategory.ClientID%>').append($("<option></option>").val(data[a].SubCategoryID).html(data[a].NAME));
                    }
                    jQuery('#<%=ddlSubcategory.ClientID%>').multipleSelect({
                        includeSelectAllOption: true,
                        filter: true, keepOpen: false
                    });
                  //  $modelUnBlockUI();
    ...
    <script type="text/javascript">
        ...
        function getreport() {
            ...
            if (IsValid) {
                ...
                var SubcategoryId = $('[id$=ddlSubcategory]').val().toString();

              
               
                $.ajax({
                    url: "AmmendmentReport.aspx/GetReport",
                    async: true,
                    data: JSON.stringify({ FromDate: FromDate, ToDate: ToDate, CentreId: CentreId, SubcategoryId: SubcategoryId }),
                    contentType: "application/json; charset=utf-8",

<%@ Page Title="Result Entry" Language="C#" MasterPageFile="~/Design/DefaultHome.master" ClientIDMode="Static" AutoEventWireup="true" CodeFile="MachineResultEntry_Radiology.aspx.cs" Inherits="PatientResultEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Pbody_box_inventory">
                            ...
                            <div class="col-md-11">
                                <div class="row">
                                    <div class="col-md-24">
                                        ...
                                        <input id="Button1" type="button" value="Delta Check" class="ItDoseButton" style="width: auto; height: 25px;display:none;" onclick="opendeltapoup()" />
        ...
        <script type="text/javascript">
            ...
            function BindCentre() {
                if (($('#<%=chkcentre.ClientID%>').prop('checked') == true)) {
                    ...
                    serverCall('MachineResultentry_Radiology.aspx/bindAccessCentre', {}, function (response) {
            ...
            function BindPanel() {
                if (($('#<%=chkPanel.ClientID%>').prop('checked') == true)) {
                    ...
                    serverCall('MachineResultentry_Radiology.aspx/GetPanelMaster', { centreid: $("#<%=ddlCentreAccess.ClientID %> option:selected").val() }, function (response) {
        ...
        function BindTest() {
            if (($('#<%=chkPanel0.ClientID%>').prop('checked') == true)) {
                ...
                serverCall('MachineResultentry_Radiology.aspx/GetTestMaster', {}, function (response) {
        ...
        <script type="text/javascript">
            ...
            function SaveRemarksStatus(row, _remarks) {
                ...
                var _temp = [];
                _temp.push(serverCall('MachineResultentry_Radiology.aspx/SaveRemarksStatus', { TestID: TestID, Remarks: _remarks, LedgerTransactionNo: LedgerTransactionNo }, function (response) {
                    $.when.apply(null, _temp).done(function () {
            ...
            function OpenTestLog(Test_Id) {
                var _temp = [];
                _temp.push(serverCall('MachineResultentry_Radiology.aspx/OpenTestLog', { TestId: Test_Id }, function (response) {
                    $.when.apply(null, _temp).done(function () {
                        var $ResponseData = JSON.parse(response);
                        if ($ResponseData.status) {
            ...
            function ddlCommentsLabObservation1_Load(CommentID) {
                ...
                var type = 'Value';
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/GetComments_labobservation",
 ...
 IsRadiology = false;
                ...
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/LabObservationSearch",
  ...
  row = 2;
            ...
            function loaddata(Test_id) {
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/Getpatient_labobservation_opd_text",
                    async: false,
            ...
            function LoadInvName(LabNo) {
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/GetPatientInvsetigationsNameOnly",
                    data: '{ LabNo:"' + LabNo + '"}',
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    timeout: 120000,
    ...
    var _temp = [];
    _temp.push(serverCall('MachineResultentry_Radiology.aspx/savetemplate', { temp: commentValue, tempname: tempname, invid: invid }, function (response) {
        $.when.apply(null, _temp).done(function () {
            var $ResponseData = JSON.parse(response);
            if ($ResponseData.status) {
                toast("Success", $ResponseData.response, "");
...
function loadObservationComment(row, col, prop, value) {
    ...
    $.ajax({
        ...
        url: "MachineResultentry_Radiology.aspx/Comments_LabObservation",
    ...
    function AddComment(rowValue, prop) {
        var commentValue = CKEDITOR.instances['<%=CKEditorControl1.ClientID%>'].getData();
            ...
            function Forward() {
                ...
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/BindTestToForward",
                ...
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/BindCentreToForward",
                    data: '{}', // parameter map 
                    type: "POST", // data has to be Posted    	        
                    contentType: "application/json; charset=utf-8",
                    timeout: 120000,
            ...
            function binddoctoforward() {
                ...
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/BindDoctorToForward",
            ...
            function Forwardme() {
                ...
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/ForwardMe",
                ...
                function Approved() {
                    ...
                    if (checkreflextest() == true) {
                        ...
                        // Show Reflex POP UP
                        $.ajax({
                            url: "MachineResultentry_Radiology.aspx/getreflextestlist",
                ...
                function SaveLabObs() {
                    ...
                    $.ajax({
                        url: "MachineResultentry_Radiology.aspx/SaveLabObservationOpdData",
                ...
                function UpdateBarcodes(row, _barcode) {
                    ...
                    var LedgerTransactionNo = PatientData[row].LedgerTransactionNo;
                    var _temp = [];
                    _temp.push(serverCall('MachineResultentry_Radiology.aspx/UpdateLabInvestigationOpdData', { TestID: TestID, Barcode: _barcode, LedgerTransactionNo: LedgerTransactionNo }, function (response) {
                        $.when.apply(null, _temp).done(function () {
                            var $responseData = JSON.parse(response);
                            if ($responseData.status) {
        ...
        <script type="text/javascript">
            ...
            function Addme() {
                ...
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/saveNewtest",
            ...
            function loadSmsdetail(MobileNo, labno) {
                ...
                $('#hdnlabno').val(labno);
                serverCall('MachineResultentry_Radiology.aspx/loadSmsdetail', { MobileNo: MobileNo }, function (response) {
                    var $responseData = JSON.parse(response);
            ...
            function sendTATsms() {
                    ...
                    serverCall('MachineResultentry_Radiology.aspx/sendTATsms', { MobileNo: $('#txtmobilereportsms').val(), LabNo: $('#hdnlabno').val(), TATDate: tatdate }, function (response) {
                    var $responseData = JSON.parse(response);
                    if ($responseData.status) {
                        toast("Success", $responseData.response, "");
                    }
			 ...
			 function ClearRadiologyComment()
          {
		     ...
		     function LoadAutoCorrect() {
                $.ajax({
                    url: "MachineResultentry_Radiology.aspx/GetAutoCorrect",
                    data: '',
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    timeout: 120000,
	...
	<div class="modal-dialog">
        ...
        <script type="text/javascript">
            function openAddReport(LedgerTransactionNo, _test_id) {
                serverCall('MachineResultentry_Radiology.aspx/encryptData', { LedgerTransactionNo: LedgerTransactionNo, Test_ID: _test_id }, function (response) {

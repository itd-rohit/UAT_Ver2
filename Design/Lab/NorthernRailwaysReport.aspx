<%@ Page Language="C#" MasterPageFile="~/Design/DefaultHome.master" ClientIDMode="Static" AutoEventWireup="true" CodeFile="NorthernRailwaysReport.aspx.cs" Inherits="Design_Lab_NorthernRailwayReport" %>
        ...
        <div class="POuter_Box_Inventory" style="width: 1300px;">
            <div class="content">
                ...
                <table width="99%">
                    <tr>
                        <td align="center">
                            <b>Northern Railways Patient Report </b>
                            <br />
    ...
    <script type="text/javascript">
        ...
        function getreport() {
            ...
            if (IsValid) {
                ...
                $.ajax({
                    url: "NorthernRailwaysReport.aspx/GetReport",
                    async: true,
        ...
        function Search() {
            ...
            if (IsValid) {
                ...
                $.ajax({
                    url: "NorthernRailwaysReport.aspx/Search",
                    async: true,

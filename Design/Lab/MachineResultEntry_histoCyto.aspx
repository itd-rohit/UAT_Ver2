<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="MachineResultEntry_histoCyto.aspx.cs" Inherits="Design_Lab_MachineResultEntry_histoCyto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="POuter_Box_Inventory">
            ...
            <div class="row" style="vertical-align: top; margin-left: -18px; margin-right: -20px">
                <div class="col-md-24">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <asp:TextBox ID="txtToDate" CssClass="ItDoseTextinputText" runat="server" ReadOnly="true"></asp:TextBox>
         ...
         <div class="POuter_Box_Inventory">
            <div class="row">
                <table align="center">
                    <tr>
                        <td class="Collected" style="width: 20px; border: 1px solid black;cursor: pointer;" onclick="SearchSampleCollection(16)"></td>
        ...
        function BindCentre() {
            ...
            if (($('#<%=chkcentre.ClientID%>').prop('checked') == true)) {
                ...
                $.ajax({
                    ...
                    url: "MachineResultEntry_histoCyto.aspx/bindAccessCentre",
                    data: '{}', // parameter map
    ...
    <script type="text/javascript">
                ...
                success: function (result) {
                    ...
                    if (PatientData == "-2") {
                        ...
                        hot1 = new Handsontable(container1, {
                            data: PatientData,
                            colHeaders: [
                      "S.No.", "TAT", "Time Diff", "Reg. Date", "PCC/Client Name/Client Code", "Sec No", "Visit No.", "SIN No.", "UHID No.", "Patient Name", "Age/Sex", "Tests", "Status","Remaks", "Detail", "View Doc.", "Print"
                            ],
                            readOnly: true,
        ...
        function callRemarksPage(Test_ID, TestName, LabNo) {
            serverCall('MachineResultEntry_histoCyto.aspx/PostRemarksData1', { TestID: Test_ID, TestName: TestName, VisitNo: LabNo }, function (response) {
        ...
        function SaveRemarksStatus(row, _remarks) {
            ...
            $.ajax({
                ...
                success: function (result) {
                    if (result == '1') {
                        alert('Remarks Status Saved.');
                    }
                    if (result == '-1') {
                        alert('Remarks Status Not Saved.');
                    }
                },
                error: function (xhr, status) {
                }
        ...
        function ShowAttachment(instance, td, row, col, prop, value, cellProperties) {
            ...
            if (PatientData[row].DocumentStatus != "") {
                MyStr1 = MyStr1 + '<a target="_blank" id="mm"  href="../Lab/AddFileRegistration.aspx?labno=' + PatientData[row].LedgerTransactionNo + '"  > <img  src="../../App_Images/attachment.png" style="border-style: none" alt=""></a>';
            }
            td.innerHTML = MyStr1;
            return td;
        }
        ...
        function PrintreportRenderer(instance, td, row, col, prop, value, cellProperties) {
            ...
            if (PatientData[row].Approved == "1") {
                if ('<%=Session["RoleID"]%>' == '11')
                    td.innerHTML = '<img  src="../../App_Images/print.gif" style="border-style: none" onclick="PrintReport()" alt="">';
                else
                    td.innerHTML = '<a href="labreportnewhisto.aspx?IsPrev=1&TestID=' + PatientData[row].Test_ID + ',&PHead='+ PHeader +'target="_blank" > <img  src="../../App_Images/print.gif" style="border-style: none" alt="">     </a>';
            }
            else {
...
function ddlCommentsLabObservation_Load(CommentID) {
    ...
    function SaveApproved() {
        ...
        function PrintReport() {
            var PHeader = $("#chkheader").is(':checked') ? 1 : 0;
            window.open('labreportnewhisto.aspx?IsPrev=1&TestID=' + PatientData[currentRow].Test_ID + ',&PHead='+ PHeader +'&reportnumber=' + $('#<%=ddlreportnumber.ClientID%>').val());
        }
        ...
        function SaveSampleCollection(Type) {
            ...
            if (ItemData == "") {
                alert("Please Select Sample First..!");
                return;
            }
            //  alert(BarcodeID);
            $modelBlockUI();

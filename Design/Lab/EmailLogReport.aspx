<%@ Page Language="C#" MasterPageFile="~/Design/DefaultHome.master" ClientIDMode="Static" AutoEventWireup="true" CodeFile="EmailLogReport.aspx.cs" Inherits="Design_Lab_EmailLogReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        function bindCentre() {
            ...
            $.ajax({
                url: "EmailLogReport.aspx/bindCentre",
                data: '{}',
                type: "POST",
    ...
    <script type="text/javascript">
        ...
        function getreport() {
            ...
            if (IsValid) {
                ...
                $.ajax({
                    url: "EmailLogReport.aspx/GetReport",
                    async: true,

<%@ Page Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="DuplicatePatientEntryReport.aspx.cs" Inherits="Design_Lab_DuplicatePatientEntryReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory" style="text-align: center">
            ...
            <b>Duplicate Patient Entry Report</b><br />
    ...
    <script type="text/javascript">
        function getReport() {
            ...
            PageMethods.getReport(dtFrom, dtTo, CentreID, onSuccessReport, OnfailureReport);
        }

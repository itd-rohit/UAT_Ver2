<%@ Page  Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="RemoveLogisticTransactionReport.aspx.cs" Inherits="Design_Lab_RemoveLogisticTransactionReport" Title=" Abnormal Value Static" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory" style="text-align: center">
            ...
            <b>Remove Logistic Transaction Report</b><br />
        ...
        <div class="POuter_Box_Inventory" style="text-align: center">
            <asp:Button ID="btnPDFReport" runat="server" Text="PDF Report" CssClass="ItDoseButton" OnClick="btnPDFReport_Click"/>

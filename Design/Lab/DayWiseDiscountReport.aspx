<%@ Page Language="C#" MasterPageFile="~/Design/DefaultHome.master" ClientIDMode="Static" AutoEventWireup="true" CodeFile="DayWiseDiscountReport.aspx.cs" Inherits="DayWiseDiscountReport" %>
    ...
    <script type="text/javascript">
        ...
        function bindCentre() {
          ...
          //  jQuery.blockUI({ message: 'Please Wait.....\n<img src="../../App_Images/Progress.gif" />' });
            $.ajax({
                url: "DayWiseDiscountReport.aspx/bindCentre",
                data: '{}',
                type: "POST",
    ...
    <script type="text/javascript">
        ...
        function getreport() {
            ...
            if (IsValid) {
                ...
                $.ajax({
                    url: "DayWiseDiscountReport.aspx/GetReport",
                    async: true,

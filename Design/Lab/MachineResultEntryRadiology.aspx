<%@ Page Title="Result Entry" Language="C#" MasterPageFile="~/Design/DefaultHome.master" ClientIDMode="Static" AutoEventWireup="true" CodeFile="MachineResultEntryRadiology.aspx.cs" Inherits="PatientResultEntry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Pbody_box_inventory">
            ...
            <div class="row" style="vertical-align: top; margin-left: -18px; margin-right: -20px">
                ...
                <div class="col-md-9" style="margin-left: -20px">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <asp:DropDownList ID="ddlMachine" runat="server" Style="display: none;">
                            </asp:DropDownList>
                            ...
                            <asp:DropDownList ID="ddlMacMaster" runat="server">
                            </asp:DropDownList>
                        </div>
                        <div class="col-md-6">
                    ...
                    <div id="divInvestigation" style="display: none;">
                     ...
                     <%--<input type="file" name="file_upload_Radio" id="file_upload_Radio" />--%>
						 ...
						 <div id="imgCanvas" class="image-previewer" data-cropzee="cropzee-input" ></div>
                             ...
                             <br />
                    <CKEditor:CKEditorControl ID="CKEditorControl2" BasePath="~/ckeditor" runat="server" Height="400px"  Width="1450px"></CKEditor:CKEditorControl>
                    <br />
        ...
        <script type="text/javascript">
            ...
            function BindCentre() {
                if (($('#<%=chkcentre.ClientID%>').prop('checked') == true)) {
                    ...
                    serverCall('MachineResultEntryRadiology.aspx/bindAccessCentre', {}, function (response) {
            ...
            function BindPanel() {
                if (($('#<%=chkPanel.ClientID%>').prop('checked') == true)) {
                    ...
                    serverCall('MachineResultEntryRadiology.aspx/GetPanelMaster', { centreid: $("#<%=ddlCentreAccess.ClientID %> option:selected").val() }, function (response) {
        ...
        function BindTest() {
            if (($('#<%=chkPanel0.ClientID%>').prop('checked') == true)) {
                ...
                serverCall('MachineResultEntryRadiology.aspx/GetTestMaster', {}, function (response) {
        ...
        <script type="text/javascript">
                    ...
                    $.when.apply(null, _temp).done(function () {
                        ...
                        if (PatientData.response.length == 0) {
                            ...
                            if (PatientData.length > 0) {
                                $('#<%=lblTotalPatient.ClientID%>').text('Total Patient: ' + PatientData.length +'     Total Test:' + PatientData[0].TotalTestPatient);
                            }
                            ...
                            hot1 = new Handsontable(container1, {
                                data: PatientData,
                                colHeaders: [
                          "S.No.", "TAT", "Histoy", "Time Diff", "Reg Date", "Dept Rec. Date", "UHID No.", "SRF ID", "Patient Name", "Age/Sex", "Visit No.", "SIN No.", "Tests", "Doc.", "PCC/Client Name/Client Code", "Panel Type", "Status", "Detail", "Print", "Sample Status", "TAT SMS"
                                ],
                                readOnly: true,
                               ...
                               // { data: 'LedgerTransactionNo', renderer: safeHtmlRenderer },
                                { data: 'LedgerTransactionNo', renderer: PatientReportDetail },
            ...
            function SaveRemarksStatus(row, _remarks) {
                ...
                var _temp = [];
                _temp.push(serverCall('MachineResultEntryRadiology.aspx/SaveRemarksStatus', { TestID: TestID, Remarks: _remarks, LedgerTransactionNo: LedgerTransactionNo }, function (response) {
                    $.when.apply(null, _temp).done(function () {
            ...
            function callPatientReportDetail(PTest_ID, PLeddNo, PSubCategoryID) {
                serverCall('MachineResultEntryRadiology.aspx/checkreport', { Test_ID: PTest_ID }, function (response) {
                    var $ResponseData = JSON.parse(response);
                    if ($ResponseData[0].isReportOpen == '1' && $ResponseData[0].SameUser == '0') {
                        alert('Report Already Open By ' + $ResponseData[0].ReportOpenBy + ' at ' + $ResponseData[0].ReportOpenDateTime1);
                    }
                    else if ($ResponseData[0].isReportOpen == '1' && $ResponseData[0].SameUser == '1') {
                        var r = confirm('Report Open By ' + $ResponseData[0].ReportOpenBy + ' at ' + $ResponseData[0].ReportOpenDateTime1 + ' want to close ?');
                        if (r == true) {
                            updateIsOpen(PTest_ID);
                        } 
                    }
                    else {
                        window.open("../Lab/PatientReportinfoPopup.aspx?TestID=" + PTest_ID + "&LabNo=" + PLeddNo + "&SubCategoryID=" + PSubCategoryID);
                    }
                });
            }
            function updateIsOpen(PTest_ID) {
                serverCall('MachineResultEntryRadiology.aspx/updateIsopen', { Test_ID: PTest_ID }, function (response) {
                    if (response == "1") {
            ...
            function PatientReportDetail(instance, td, row, col, prop, value, cellProperties) {
                td.innerHTML = '<input type="button" value="' + PatientData[row].LedgerTransactionNo + ' "  onclick="callPatientReportDetail(' + "'" + '' + PatientData[row].Test_ID + "'" + ',' + "'" + '' + PatientData[row].LedgerTransactionNo + "'" + ',' + "'" + '' + PatientData[row].SubCategoryID + "'" + ');"></input>';
                td.className = PatientData[row].Status;
                return td;
            }
            ...
            function SampleStatusRenderer(instance, td, row, col, prop, value, cellProperties) {
                if (PatientData[row].BarcodeNo != "") {
                    td.innerHTML = '<img  src="../../App_Images/view.gif" style="border-style: none;cursor:pointer;" alt="" onclick="callSampleStatusRenderer(' + "'" + '' + PatientData[row].BarcodeNo + "'" + ');">';
                }
                else {
                    td.innerHTML = '<span>&nbsp;</span>';
                }
            ...
            function OpenTestLog(Test_Id) {
                var _temp = [];
                _temp.push(serverCall('MachineResultEntryRadiology.aspx/OpenTestLog', { TestId: Test_Id }, function (response) {
                    $.when.apply(null, _temp).done(function () {
                        var $ResponseData = JSON.parse(response);
                        if ($ResponseData.status) {
            ...
            function callSampleStatusRenderer(barcodeno) {
                serverCall('../Common/Services/CommonServices.asmx/encryptData', { ID: barcodeno }, function (response) {
                    var href = "../Lab/SampleTracking.aspx?barcodeno=" + response;
                    $.fancybox({
                        maxWidth: 840,
                        maxHeight: 800,
                        fitToView: false,
            ...
            function ddlCommentsLabObservation1_Load(CommentID) {
                ...
                var type = 'Value';
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/GetComments_labobservation",
 ...
 IsRadiology = false;
                ...
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/LabObservationSearch",
  ...
  row = 2;
            ...
            function loaddata(Test_id) {
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/Getpatient_labobservation_opd_text",
                    async: false,
            ...
            function LoadInvName(LabNo) {
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/GetPatientInvsetigationsNameOnly",
                    data: '{ LabNo:"' + LabNo + '"}',
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    timeout: 120000,
            ...
            function LabObservationRender(instance, td, row, col, prop, value, cellProperties) {
                if (LabObservationData[row].Inv == "1") {
                    if (LabObservationData[row].IsAttached != "") {
                        ...
                        if (elt.options[elt.selectedIndex].text == "Pending" || elt.options[elt.selectedIndex].text == "ReRun" || elt.options[elt.selectedIndex].text == "Tested" || elt.options[elt.selectedIndex].text == "Machine Data") {
                            if (LabObservationData[row].IsEdited == "1") {
                                td.innerHTML = value + ' <img src="../../App_Images/edit.png" title="' + LabObservationData[row].EditDetail + '"/> ' + '<br/><input type="button" onclick="openrerunoption(\'' + LabObservationData[row].PLIID + '\')" style="cursor:pointer;"  type="button" value="ReRun"/>';
                            }
                            else {
                                td.innerHTML = value + '<br/><input type="button" onclick="openrerunoption(\'' + LabObservationData[row].PLIID + '\')" style="cursor:pointer;"  type="button" value="ReRun"/>';
                            }
                        }
                        else {
                            if (LabObservationData[row].IsEdited == "1") {
    ...
    var _temp = [];
    _temp.push(serverCall('MachineResultEntryRadiology.aspx/savetemplate', { temp: commentValue, tempname: tempname, invid: invid }, function (response) {
        $.when.apply(null, _temp).done(function () {
            var $ResponseData = JSON.parse(response);
            if ($ResponseData.status) {
                toast("Success", $ResponseData.response, "");
...
function loadObservationComment(row, col, prop, value) {
    ...
    $.ajax({
        ...
        url: "MachineResultEntryRadiology.aspx/Comments_LabObservation",
    ...
    function AddComment(rowValue, prop) {
        var commentValue = CKEDITOR.instances['<%=CKEditorControl1.ClientID%>'].getData();
            ...
            function Forward() {
                ...
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/BindTestToForward",
                ...
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/BindCentreToForward",
                    data: '{}', // parameter map 
                    type: "POST", // data has to be Posted    	        
                    contentType: "application/json; charset=utf-8",
                    timeout: 120000,
            ...
            function binddoctoforward() {
                ...
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/BindDoctorToForward",
            ...
            function Forwardme() {
                ...
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/ForwardMe",
                ...
                function Approved() {
                    ...
                    if (checkreflextest() == true) {
                        ...
                        // Show Reflex POP UP
                        $.ajax({
                            url: "MachineResultEntryRadiology.aspx/getreflextestlist",
                ...
                function SaveLabObs() {
                    ...
                    $.ajax({
                        url: "MachineResultEntryRadiology.aspx/SaveLabObservationOpdData",
                ...
                function UpdateBarcodes(row, _barcode) {
                    ...
                    var LedgerTransactionNo = PatientData[row].LedgerTransactionNo;
                    var _temp = [];
                    _temp.push(serverCall('MachineResultEntryRadiology.aspx/UpdateLabInvestigationOpdData', { TestID: TestID, Barcode: _barcode, LedgerTransactionNo: LedgerTransactionNo }, function (response) {
                        $.when.apply(null, _temp).done(function () {
                            var $responseData = JSON.parse(response);
                            if ($responseData.status) {
        ...
        <script type="text/javascript">
            ...
            function Addme() {
                ...
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/saveNewtest",
            ...
            function loadSmsdetail(MobileNo, labno) {
                ...
                $('#hdnlabno').val(labno);
                serverCall('MachineResultEntryRadiology.aspx/loadSmsdetail', { MobileNo: MobileNo }, function (response) {
                    var $responseData = JSON.parse(response);
            ...
            function sendTATsms() {
                    ...
                    serverCall('MachineResultEntryRadiology.aspx/sendTATsms', { MobileNo: $('#txtmobilereportsms').val(), LabNo: $('#hdnlabno').val(), TATDate: tatdate }, function (response) {
                    var $responseData = JSON.parse(response);
                    if ($responseData.status) {
                        toast("Success", $responseData.response, "");
                    }
			 ...
			 function ClearRadiologyComment()
          {
		     ...
		     function LoadAutoCorrect() {
                $.ajax({
                    url: "MachineResultEntryRadiology.aspx/GetAutoCorrect",
                    data: '',
                    type: "POST",
                    contentType: "application/json; charset=utf-8",
                    timeout: 120000,
	...
	<div class="modal-dialog">
        ...
        <script type="text/javascript">
            function openAddReport(LedgerTransactionNo, _test_id) {
                serverCall('MachineResultEntryRadiology.aspx/encryptData', { LedgerTransactionNo: LedgerTransactionNo, Test_ID: _test_id }, function (response) {

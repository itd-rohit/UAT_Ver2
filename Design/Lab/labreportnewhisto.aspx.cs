...
WHERE `LedgertransactionNo`='" + drcurrent["LabNo"].ToString() + "' AND approved=0 AND isreporting=1 and IsSampleCollected<>'R'");
                        ...
                        if (list.Length > 0)
                        {
                            ...
                            //        string imgname = az.fileShowFromAzure(Util.GetString(st["ForwardBy"]), Util.GetString(st["ForwardBy"]) + ".jpg", "doctorsignature");
            ...
            //sb.Append("</tr>");
               if (dr["investigation_id"].ToString() == "2767" || dr["investigation_id"].ToString() == "2768" || dr["investigation_id"].ToString() == "2769" || dr["investigation_id"].ToString() == "2770" || dr["investigation_id"].ToString() == "646")
            {
}
else
{
           ...
           if (dr["Dept"].ToString().ToUpper() == "HISTOPATHOLOGY")
            {
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>Biopsy No:</td>");
            }
            else
            {
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>Cytology No:</td>");
            }

            sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:16px;padding:3px;'>" + dr["SlideNumber"].ToString() + "</td>");
            sb.Append("</tr>");
  }
             sb.Append("</tr>");
            ...
            sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>Specimen:</td>");
            sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:16px;padding:3px;'>");
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>Clinical History:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:16px;padding:3px;'>" + dr["Clinicalhistory"].ToString() + "</td>");
                sb.Append("</tr>");
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>Gross:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:16px;padding:3px;'>" + dr["gross"].ToString() + "</td>");
                sb.Append("</tr>");
                sb.Append("<tr valign='top' style='height:12px;' ><td style='border:0px;'>&nbsp;</td>");
                sb.Append("</tr>");
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>Microscopy:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:16px;padding:3px; '>" + dr["microscopic"].ToString() + "</td>");
                sb.Append("</tr>");
                sb.Append("<tr valign='top' style='height:12px;' ><td style='border:0px;'>&nbsp;</td>");
                sb.Append("</tr>");
            }
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>Impression/ Diagnosis:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:16px;padding:3px;'>" + dr["impression"].ToString() + "</td>");
                sb.Append("</tr>");
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>IHC:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:16px;padding:3px;'>");
                ...
                {
                    sb.Append("<tr valign='top'  >");
                    sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>IHC Comment:</td>");
                ...
                {
                    sb.Append("<tr valign='top'  >");
                    sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>Final Diagnosis:</td>");
                    sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:16px;padding:3px;'>" + dtsbihc.Rows[0]["interpretation"].ToString() + "</td>");
                    sb.Append("<tr valign='top' style='height:12px;' ><td style='border:0px;'>&nbsp;</td>");
                    sb.Append("</tr>");
                }
            }
            ...
            {
                sb.Append("<tr valign='top'  >");
                sb.Append("<td valign='top' colSpan='1' style='font-weight:bold;font-size:16px;padding:3px;text-transform: uppercase;font-family:Calibri;'>Advice/ Comment:</td>");
                sb.Append("<td valign='top' colSpan='" + colspan + "'  style='font-size:16px;padding:3px;'>" + dr["advice"].ToString() + "</td>");
                sb.Append("</tr>");
              ...
              //  } 
                ...
                if (File.Exists(_pdf))
                {
                    try
                    {
                        ...
                        //string url11 = "https://lims.lupindiagnostics.com/LupinImages/" + "Uploaded Report/" + drAtt["FileUrl"].ToString();
                        ...
                        string OutSource_Footer_Text = "<div style='font-size:10px;font-weight:bold;'>" + Util.GetString("This test has been performed at our referral Lab").Replace("{OutSourceLabName}", Util.GetString(drAtt["LabOutsrcName"])) + "</div>";

                        PdfHtml htmlLogo = new PdfHtml(20, 820, repeatedCanvas.Width,
                                 repeatedCanvas.Height, OutSource_Footer_Text, "");
                        htmlLogo.BrowserWidth = htmlLogoWidthPx;
                        htmlLogo.FitDestHeight = true;
                        //document1.Pages[0].Layout(htmlLogo);
                          foreach (PdfPage pp in document1.Pages)
                        {
                            pp.Layout(htmlLogo);
                        }
   ...
   private static Stream ConvertToStream(string fileUrl)
    ...
    private void mergeDocument()
    {
        ...
        foreach (PdfPage p in tempDocument.Pages)
        {
          ...
          new System.Drawing.Font(new System.Drawing.FontFamily("Times New Roman"), 8, System.Drawing.GraphicsUnit.Point);
            ...
            PdfText pageNumberingText = new PdfText(PageWidth - 100, FooterHeight, String.Format("                 Page {0} of {1}", pageno, tempDocument.Pages.Count), pageNumberingFont);
    ...
    public string MakeHeader(string Header, DataRow dr_Detail)
    {
        ...
        sb.Append("<tr valign='top' ><th class='Department'   colSpan='" + dtLabReport.Rows.Count + "'  >" + drcurrent["Dept"].ToString() + " REPORT </th></tr>");
    ...
    private void SetHeader(PdfPage page)
    {
        ...
        {
            HeaderHeight = Util.GetInt(drcurrent["ReportHeaderHeight"].ToString()) - 15;
        }
    ...
    private void SetFooter(PdfPage page)
    {
        ...
        page.Footer.Layout(getPDFImageforbarcode(480, 0, drcurrent["LabNo"].ToString()));
    }
    ...
    private void bindReport()
    {
        ...
        sb.Append("           FROM (        ");
        sb.Append("           SELECT  pm.Mobile,pm.House_No paddress,pli.laboutsrcid,   ");
        ...
        sb.Append("                DATE_FORMAT(pli.SampleCollectionDate,'%d/%b/%Y %H:%i')SampleDate,   ");
        sb.Append("           DATE_FORMAT(pli.SampleReceiveDate,'%d/%b/%Y  %H:%i')ReceiveDate,   ");
        ...
        sb.Append("               ");
        sb.Append("            ,       DATE_FORMAT(pli.ApprovedDate,'%d/%b/%Y %I:%i')ApprovedDate,   ");
        sb.Append("            pli.ApprovedBy ApprovedBy,        DATE_FORMAT(pli.ResultEnteredDate,'%d/%b/%Y %I:%i')ResultEnteredDate,   ");
        ...
        sb.Append("            1 isborder,0 MachineID  , lt.centreid,lt.Panel_ID,Concat('Dr.',lt.`DoctorName`) ReferDoctor, IF(lt.OtherReferLab='',left(lt.panelname,34),lt.OtherReferLab) Company_Name ,'' Company_code,'' Company_add1,lt.`HLMPatientType`,lt.`HLMOPDIPDNo`,pli.SampleTypeName  ");
        ...
        sb.Append("            AND pli.Test_ID IN ({0})  AND pli.Result_Flag = 1 AND pli.ishold=0  ");//and pli.SubCategoryID=4 
        ...
        sb = new StringBuilder();
        sb.Append(" SELECT plor.test_id, CONCAT(DATE_FORMAT(plor.`dtEntry`,'%Y%m%d'),'/', plor.`FileUrl`) FileUrl, ");
        sb.Append(" plo.LabOutsrcName ");
        sb.Append(" FROM patient_labinvestigation_attachment_report plor ");
        sb.Append(" INNER JOIN `patient_labinvestigation_opd` plo ON plo.`Test_ID`=plor.`Test_ID` ");
        sb.Append(" INNER JOIN centre_master cm ON cm.`CentreID`=plo.`TestCentreID` ");
        sb.Append(" WHERE plor.Test_ID IN ({0}) ");
        using (MySqlDataAdapter da2 = new MySqlDataAdapter(String.Format(sb.ToString(), inClause), con))
        {
            for (int i = 0; i < paramNames.Length; i++)
            {

<%@ Page Language="C#" MasterPageFile="~/Design/DefaultHome.master" ClientIDMode="Static" AutoEventWireup="true" CodeFile="MachineDataReport.aspx.cs" Inherits="Design_Lab_MachineDataReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <div class="POuter_Box_Inventory" style="width: 1300px;">
            ...
            <table style="width:100%;">
                <tr>
                    ...
                    <td  style="width:80px;text-align:right;"><span class="filterdate" >Centre :</span> </td>
                ...
                <tr>
                    <td style="width:100px;text-align:right;"><span class="filterdate" >Report Type :</span> </td>
                    
                    <td colspan="5" style="text-align:left;">
                        <asp:RadioButtonList ID="rdoType" runat="server" RepeatColumns="2" RepeatDirection="Horizontal">
                            <asp:ListItem Value="1" Text="Data From Machine" Selected="True"></asp:ListItem>
                            <asp:ListItem Value="2" Text="Machine Data V/s User Value"></asp:ListItem>
    ...
    <script type="text/javascript">
        ...
        function bindCentre() {
            ...
            $.ajax({
                url: "MachineDataReport.aspx/bindCentre",
                data: '{}',
                type: "POST",
    ...
    <script type="text/javascript">
        ...
        function getreport() {
            ...
            if (IsValid) {
                ...
                var ReportType = $('[id$=rdoType] input:checked').val();
               
                $.ajax({
                    url: "MachineDataReport.aspx/GetReport",
                    async: true,
                    data: JSON.stringify({ FromDate: FromDate, ToDate: ToDate, CentreId: CentreId, ReportType: ReportType }),
                    contentType: "application/json; charset=utf-8",

<%@ Page Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="DiscountOnCashBulk.aspx.cs" Inherits="Design_EDP_DiscountOnCashBulk" Title="Untitled Page" %>
...
{ 
 ...
 var Amt = "";
    ...
    else
    {
       ...
       <div id="Pbody_box_inventory" Class="Pbody_box_inventory" style="width: 973px;" >
          ...
          <table style="width: 954px">
              <tr>
                  <td style="width: 100px">
                      <asp:CheckBox ID="chkDiscount" runat="server" Text="Discounted Patient" /></td>
    ...
    <div class="Outer_Box_Inventory" style="width:99.6%">
                ...
                <td style="width:250px; text-align: right;">
                    Additional Discount:</td><td style="width:250px;">
                         <asp:TextBox ID="txtDisc" runat="server"  Width="100px" ></asp:TextBox></td></tr>
                    <tr style="width: 1000px">
                        <td style="width: 250px">

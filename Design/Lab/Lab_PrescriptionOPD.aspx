...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server" >
    ...
    <div class="POuter_Box_Inventory" style="text-align: center">
        ...
        <asp:TextBox ID="txtappointment" style="display:none"  Enabled="false" Width="100px" runat="server"></asp:TextBox>        
            ...
            <div class="col-md-6">
             <span style="font-weight: bold;text-align:left;">Last Visit No :</span>&nbsp;&nbsp;<span id="lastlabno" style="font-weight: bold;"></span>
        </div></div>
    ...
    <div id="PatientDetails">		 
	     ...
	     <div class="row">
		  <div class="col-md-3">
		   ...
		   <div class="col-md-5 ">
                <select id="ddlPanel" TabIndex="1" data-title="Select Rate Type"  onchange="$showPUPData('0')"></select>			 
		   </div>
		   <div class="col-md-3">
	     ...
	     <div class="row">
		  <div class="col-md-3">
		   ...
		   <div class="col-md-5">
			    <input id="txtMobileNo" type="text"  allowFirstZero onkeyup="previewCountDigit(event,function(e){$patientSearchOnEnter(e)});" onblur="$patientSearchOnEnter(event);"   data-title="Enter Contact No. (Press Enter To Search)" onlynumber="10"    autocomplete="off"  />                          
		   </div>
		   <div class="col-md-3 ">
         ...
         <div class="row">
		  ...
		  <div  class="col-md-3  col-xs-14">
			  <input type="text" id="txtPName"  class="requiredField" TabIndex="3" autocomplete="off"  style="text-transform:uppercase"   maxlength="100"  data-title="Enter Patient Name"  />
		   </div>
		   <div class="col-md-3 ">
  ...
  <div class="col-md-5">		
                     ...
                     <input type="text" id="txtAge1" TabIndex="4" style="width:33%;float:left" onlynumber="5" onkeyup="$clearDateOfBirth(event);$getdob();"  class="requiredField"   max-value="12"  autocomplete="off"  maxlength="2" data-title="Enter Age"   placeholder="Months"/>                      
                     <input type="text" id="txtAge2" TabIndex="4" style="width:33%;float:left"  onlynumber="5" onkeyup="$clearDateOfBirth(event);$getdob();" class="requiredField"  max-value="30"  autocomplete="off"  maxlength="2" data-title="Enter Age"   placeholder="Days"/>							         
      </div>
     ...
     <div class="col-md-3">
        <label class="pull-left">Country</label>
         ...
         <b class="pull-right">:</b>
                  ...
                  <div class="col-md-5">
                   <input type="text" id="txtBarcodeno" TabIndex="6" style="text-transform:uppercase" maxlength="12" style="border-bottom-color: green !important;" data-title="Enter BarcodeNo"/>
                      </div>
...
<cc1:MaskedEditValidator ID="maskTime" runat="server" ControlToValidate="txtCollectionTime"  ControlExtender="masTime" IsValidEmpty="false" InvalidValueMessage=""  ></cc1:MaskedEditValidator>                 
 ...
 <input type="text" id="txtOtherLabRefNo" maxlength="50" data-title="Enter Other Lab Reference No."/>
     ...
     <div class="col-md-3 divGovtPanel" style="display:none">
       ...
       <div class="row divCardCorporate" style="display:none" >
         ...
         <b class="pull-right">:</b>
              ...
              <div id="td_pndt" style="display: none">
                 <div class="row">
                      ...
                      <div class="col-md-3">
                         ...
                         <div class="col-md-5">
                            <input type="text" id="txtChild" maxlength="10"  class="requiredField"  data-title="No. of Children" onkeypress="return isNumberKey(event)" />
                         </div>
                      <div class="col-md-3">
                     ...
                     <div class="col-md-5">
                         <input type="text" id="txtSon" maxlength="10" class="requiredField" data-title="No. of Son" onkeypress="return isNumberKey(event)" />
                     </div>
                   ...
                   <div class="col-md-5">
                         <input type="text" id="txtDaut" maxlength="10" class="requiredField" data-title="Enter No. of Daughter" onkeypress="return isNumberKey(event)" />
                   </div>
                   ...
                   <div class="row">
                     ...
                     <div class="col-md-5">
                        <%-- <input type="text" id="txtPreg" maxlength="20" data-title="enter Pregnancy" />--%>
                         ...
                         <asp:TextBox ID="txtPreg"  placeholder="DD-MM-YYYY" ReadOnly="true" runat="server" class="requiredField"  ></asp:TextBox>				
                     </div>
                     <div class="col-md-3">
                     ...
                     <div class="col-md-5">
                         <input type="text" id="txtAgeSon" maxlength="3" class="requiredField" data-title="enter Age of Son" onkeypress="return isNumberKey1(event)" />
                     </div>
                     ...
                     <div class="col-md-5">
                         <input type="text" id="txtAgeDaut" maxlength="10" class="requiredField" data-title="Enter age of Daughter" onkeypress="return isNumberKey1(event)" />
                     </div>
             ...
             <div class="row">
                     ...
                     <div class="col-md-5">
                         <asp:DropDownList ID="ddlPNTDDocotor" runat="server" class="requiredField" ></asp:DropDownList>
                     </div>
		 ...
		 <div class="col-md-3">
			 <div class="row">
                   <div class="col-md-24">
                        <asp:TextBox ID="txtHomeCollection" placeholder="HomeCollection" MaxLength="20" runat="server" data-title="HomeCollection" ></asp:TextBox>  
                       ...
                       <input type="text"  id="txtMemberShipCardNo" placeholder="Membership Card" maxlength="20"  data-title="Press Enter To Search" onkeyup="$patientSearchOnEnter(event);"
         ...
         { %>
			 ...
			 <div class="row" style="display:none;">
				 ...
				 <div class="col-md-24">
					 ...
					 <button onclick="showData()" id="btnpatient" type="button" style="width:100%" ><span id="Span1"  class="badge badge-grey"></span><b>PNDT</b> </button>					
				 </div>
			 </div>				  
		 </div>	
	 </div>         
        ...
        <div class="POuter_Box_Inventory">
			<div class="row" style="margin-top: 0px;">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <button style="width: 100%; padding: 0px;display:none;" class="label label-important" type="button"><b>Count :</b><span id="lblTotalLabItemsCount" style="font-size: 14px; font-weight: bold;" class="badge badge-grey">0</span></button>
							 <button style="width: 100%; padding: 0px;display:none;"  class="label label-important" type="button" onclick="$openinvestigation()">Investigation</button>
						</div>					                           												
					</div>
                    <div class="row" style="display:none">						
                    ...
                    <div class="row">						
						<div style="padding-left: 15px;" class="col-md-24">
							<input type="text" id="txtInvestigationSearch" TabIndex="7" title="Enter Search Text"  autocomplete="off"  />
						</div>					
					</div>
                    </div>
                <div class="col-md-16">
        ...
        <div style="margin-top: 0px;" class="row">
            ...
            <div class="col-md-12">
                <div class="row">
                    <div id="divDiscountHead">
                    <div class="col-md-24 Purchaseheader">
                        <span id="spnHeaderType">Discount</span>  
                    </div>
                    </div>
                    </div>
                 <div class="row">
            ...
            <cc1:TabPanel runat="server" HeaderText="Discount" ID="tabPanelDiscount" BackColor="#d7edff">  
                <ContentTemplate>  
              ...
              <div class="row" id="divDiscountReason">
				...
				<div class="col-md-10">
					<input  type="text"  id="txtDiscountReason" autocomplete="off"  maxlength="100"  />
                                    ...
                                    <cc1:TabPanel ID="tabCoupon" runat="server" HeaderText="Coupon"  BackColor="#d7edff">
                                        <ContentTemplate>
                                            <div class="row">
                       <div class="col-md-5">
                         <label class="pull-left">  Coupon Code </label>
								<b class="pull-right">:</b>
                                                ...
                                                <div class="col-md-5">
                                                  ...
                                                  <div class="col-md-3">
                                                      <input type="button" id="btnCouponOTP" value="Get OTP" style="font-weight:bold;cursor:pointer;" onclick="$getCouponOTP()" />
                                                ...
                                                <div class="col-md-5">
                                                    <asp:TextBox ID="txtCouponOTP" runat="server" placeholder="Enter OTP" ></asp:TextBox>
				...
				<div class="col-md-3" >
                 ...
                 <div class="col-md-5">
				   <label class="pull-left">Coupon Amount</label>
								<b class="pull-right">:</b>
				</div>
				<div class="col-md-3">
                    <input  type="text" class="ItDoseTextinputNum" style="font-weight:Bold"  value="0"  id="txtCouponAmt" autocomplete="off" disabled="disabled"  />
						</div>	
   ...
   --%>                <div class="col-md-5 clCashOutstanding" style="display:none">
        ...
        <div class="POuter_Box_Inventory" style="text-align: center">			
			<input type="button" style="margin-left:-190px;margin-top:7px" TabIndex="8" id="btnSave" class="ItDoseButton" value="Save" onclick="$saveLabPrescription(this, jQuery(this).val());" />
		...
		<div class="modal-content" style="min-width: 74%;max-width:72%">
			...
			<div class="modal-body" >
			    <div class="row clMoreFilter"  style="display:none" >
					 ...
					 <div  class="col-md-5">
						 <input type="text" maxlength="20" id="txtSearchModelMrNO" />
					 </div>
                     <div  class="col-md-3">
...
<table id="tblsubgroup" style="width:99%;border-collapse:collapse;text-align:left;">
    ...
    <script type="text/javascript">
		...
		function setdiscountoption()
		{
			jQuery('#txtReferDoctor,#txtSecondReference').val('SELF');
                ...
                if (jQuery('#ddlPatientType').val() == "1") {
                   ...
                   //  jQuery('#divHLMDetail').show(); // Comment  By  Vaseem   06jan23 In  HLM  Case
        ...
        function $showPUPData(con) {
          //  $getpatienttype();
		  if (jQuery('#ddlPanel').val().split('#')[0] == '78') {
		jQuery('#ddlPRO').attr("disabled", false);
		}
		else{
				jQuery('#ddlPRO').attr("disabled", true);
		}
            $setPUPData();
            if (con == 0)
                $resetItem("0");
		...
		jQuery('#ddlPRO').val(jQuery('#ddlPanel').val().split('#')[25]);
		jQuery('#ddlPRO').trigger('chosen:updated');
        ...
        var $getCentreData = function (con, callback) {
            ...
            jQuery('#ddlPatientType').trigger('chosen:updated');
            jQuery('#ddlPatientType').attr('disabled', 'disabled');
            $showoption();
...
#>
    ...
    <script type="text/javascript">
        bindApprovalType = function () {
            ...
            serverCall('../Lab/Services/LabBooking.asmx/getDiscountApproval', { centreID: jQuery('#ddlCentre').val().split('#')[0] }, function (response) {
                ...
                $ddlApprovedBy.bindDropDown({ defaultValue: 'Select', data: JSON.parse(response), valueField: 'value', textField: 'label', showDataValue: 1, isSearchAble: true });
            });
        }
        ...
        var $bindDiscountApprovalAndOutStandingEmp = function () {
            ...
            serverCall('../Common/Services/CommonServices.asmx/bindDiscountApprovalAndOutStandingEmp', { CentreID: jQuery('#ddlCentre').val().split('#')[0], IsDiscountApproval: 1, IsOutStandingEmp: 1 }, function (response) {
                $ddlApprovedBy.bindDropDown({ data: JSON.parse(response).DiscountApprovalData, valueField: 'value', textField: 'label', isSearchAble: true, defaultValue: "Select", isSearchAble: true, defaultValue: "Select", showDataValue: 1 });
    ...
    <script type="text/javascript">
        $resetItem = function ($con) {
            ...
            jQuery('#txtCouponNo,#txtInvestigationSearch').prop('readonly', false);
            jQuery(".deletemydata,#btnCouponOTP").show();
            jQuery('#btnCouponOTPResend,#imgviewtest,.clDivCoupon,#tblCouponDetail').hide();
    ...
    <script type="text/javascript">
        var $bindMandatory = function (callback) {
            var manadatory = [
                { control: '#txtMobileNo', isRequired: true, erroMessage: 'Enter Mobile Name',  isSearchAble: false },
                { control: '#txtPName', isRequired: true, erroMessage: 'Enter Patient Name',  isSearchAble: false },
            ];
            ...
            serverCall('../Lab/Services/LabBooking.asmx/GetPRO', {  }, function (response) {
                if (JSON.parse(response) != "") {
                    if (JSON.parse(response).length == 1) {
                        $ddlPRO.bindDropDown({  data: JSON.parse(response), valueField: 'PROID', textField: 'PROName', isSearchAble: true });
                    }
                    else {
                ...
                //if (con == 1) {
                //    $ddlPRO.bindDropDown({ data: JSON.parse(response), valueField: 'PROID', textField: 'PROName', isSearchAble: true, selectedValue: jQuery('#ddlPRO').val() });
                //}
    ...
    <script type="text/javascript">
        ...
        $addInvestigationRow = function (ItemID, investigationRateDetails, callback) {
            ...
            if ($inv == null) {
                toast("Error", "Please Add Observation In this Investigation", "");
                return;
            }          
            ...
            if (isoutsrc == '1') {
                $investigationTr.push("<tr style='background-color:#fae8f9;' id='"); $investigationTr.push(investigationRateDetails.ItemID); $investigationTr.push("'>");
            }
            else {
            ...
            if (jQuery("#ddlPanel").val().split('#')[4] == "1") {
                $investigationTr.push('<td id="tdRate"  style="text-align:right;width:50px;display:none;">');
                $investigationTr.push(investigationRateDetails.Rate); $investigationTr.push('</td>');
               // $investigationTr.push('<td>'); $investigationTr.push('</td>');
            }
            if (jQuery("#ddlPanel").val().split('#')[4] == "0") {
        ...
        var $clearPaymentControl = function (callback) {
            ...
            jQuery('#ddlApprovedBy,#txtDiscountReason').removeClass('requiredField');
            jQuery('#ddlApprovedBy').chosen("destroy").chosen({ width: '100%' });
            jQuery('#txtpaybypanelfinal').val('0');
        ...
        var $addBillAmount = function (data, callback) {
         ...
         //   jQuery('#txtPatientPaidAmount').val(parseFloat(data.billAmount) + parseFloat($sampleCollectionCharge) + parseFloat($reportDeliveryCharge));
           // jQuery('#txtPaidAmount').val(parseFloat(data.billAmount) + parseFloat($sampleCollectionCharge) + parseFloat($reportDeliveryCharge));
            ...
            jQuery('#txtBlanceAmount').val($netamount - $paidAmount - Number(jQuery('#txtAppAmount').val()) - Number(jQuery('#txtCouponAmt').val()));
        ...
        $onPaymentModeChange = function (elem, ddlCurrency, callback) {
            if (elem.checked == false) {
                ...
                if (jQuery(".clReferenceNumber").length == 0)
                    jQuery('.clHeaderReferenceNumber').hide();
                else
                    jQuery('.clHeaderReferenceNumber').show();
        ...
        var $bindPaymentModeDetails = function (IsShowDetail, data, callback) {
            ...
            if (IsShowDetail.data('isbankshow') || IsShowDetail.data('ischequenoshow') == 1)
                jQuery('.clHeaderReferenceNumber').show();
            if (data.$paymentDetails.PaymentMode == "Cheque") {
                $temp.push('<td id="tdTransaction" class="GridViewLabItemStyle ');
                $temp.push((IsShowDetail.data('ischequenoshow') == 0 && IsShowDetail.data('isbankshow') == 0) ? '"style="display:none">' : ' clReferenceNumber">');
                $temp.push('</td>');
            }
            else {
                $temp.push('<td id="tdTransaction" class="GridViewLabItemStyle ');
                $temp.push((IsShowDetail.data('ischequenoshow') == 0 && IsShowDetail.data('isbankshow') == 0) ? '"style="display:none">' : ' clReferenceNumber">');
                $temp.push((IsShowDetail.data('ischequenoshow') == 0 && IsShowDetail.data('isbankshow') == 0) ? '' : '<input type="text" autocomplete="off" class="requiredField" maxlength="20" id="txttransactionid" />');
                $temp.push('</td>');
            }
    ...
    <script  type="text/javascript">
        ...
        $setItemwiseDiscount = function (ctrl) {
            ...
            jQuery(ctrl).closest("tr").find("#txtItemWiseDiscount").val(parseFloat($disc));
        ...
        var $calculateTotalPaymentAmount = function (event, row, callback) {
            ...
            if ($roundOffTotalPaidAmount > $netAmount) {
                if (event != null) {
                    ...
                    jQuery('#txtBlanceAmount').val(precise_round(($netAmount - ($totalPaidAmount - $tragetBaseCurrencyAmount) - Number(jQuery('#txtAppAmount').val()) - Number(jQuery('#txtCouponAmt').val())), '<%=Resources.Resource.BaseCurrencyRound%>'));
                ...
                jQuery('#txtBlanceAmount').val(precise_round(parseFloat(($('#ddlPanel').val().split('#')[20] == "1" ? parseFloat(jQuery('#txtpaybypatientfinal').val()) : parseFloat(jQuery('#txtNetAmount').val()))) - parseFloat(jQuery('#txtPaidAmount').val()) - Number($('#txtAppAmount').val()) - Number(jQuery('#txtCouponAmt').val()), '<%=Resources.Resource.BaseCurrencyRound%>'));
            }
            var $blanceAmount = jQuery("#txtBlanceAmount").val();
   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        var $saveLabData = function (btnSave, buttonVal) {
            ...
            serverCall('Lab_PrescriptionOPD.aspx/SaveNewRegistration', { PatientData: $patientdata, LTData: $ledgertransaction, PLO: $PLOdata, Rcdata: $Rcdata, RequiredField: $RequiredField, sampledata: $sampleData, sampledategiven: $sampleDateGiven, isVipM: 0, patientScanDocument: $patientDocuments }, function (response) {
                ...
                if ($responseData.status) {
                    ...
                    //jQuery('#txtMobileNo').attr("tabindex", 0);
                    jQuery('#txtMobileNo').focus();
        ...
        $clearForm = function () {
            ...
            jQuery('#ddlApprovedBy').prop('selectedIndex', 0).toggleClass('customRequired', false).chosen("destroy").chosen({ width: '100%' });
        ...
        function $f_ledgertransaction() {
           ...
           $objLT.BarcodeManual 	=jQuery.trim(jQuery('#txtBarcodeno').val());
            ...
            $objLT.DiscountPendingPer = jQuery('#ddlApprovedBy').val().split('#')[1];
            ...
            var CouponCode = [];
            var CouponAmtEncrypt = [];
            var CouponAmt = parseFloat(jQuery('#txtCouponAmt').val());
            if (isNaN(CouponAmt))
                CouponAmt = 0;
            if (CouponAmt > 0) {
                jQuery('#tblCouponDetail tr').not('#trCoupon').each(function () {
                    CouponCode.push(jQuery(this).find('#tdCoupanCode').text());
                    CouponAmtEncrypt.push(jQuery(this).find('#tdCouponAmt').text());
                });
                $objLT.CouponAmt = CouponAmt;
                $objLT.CouponCodeDetail = CouponCode.join(",");
                $objLT.CouponID = jQuery('#tblCouponDetail tr').eq(1).attr('id');
                $objLT.CouponType = jQuery('#tblCouponDetail tr').eq(1).find('#tdCouponType').html();
                $objLT.CouponName = jQuery('#tblCouponDetail tr').eq(1).find('#tdCoupanName').html();
                $objLT.CouponAmtDetail = CouponAmtEncrypt;
                $objLT.DiscountApprovedByID = -1;
                $objLT.DiscountApprovedByName = "Auto";
                $objLT.OneCouponOneMobileMultipleBilling = jQuery('#tblCouponDetail tr').eq(1).find('#tdOneCouponOneMobileMultipleBilling').html();
                $objLT.CouponClientShareType = jQuery('#tblCouponDetail tr').eq(1).find('#tdClientShareType').html();
            }
            else {
                $objLT.CouponAmt = 0;
                $objLT.CouponCodeDetail = "";
                $objLT.CouponID = 0;
                $objLT.CouponType = "0";
                $objLT.CouponName = "";
                $objLT.CouponAmtDetail = null;
                ...
                $objLT.OneCouponOneMobileMultipleBilling = 0;
                $objLT.CouponClientShareType = 0;
            }
            ...
            if (parseFloat(jQuery('#txtNetAmount').val()) > 0) {
                jQuery("#tblPaymentDetail").find('tbody tr').each(function () {
                    ...
                    if ($PatientPaidAmount > 0) {
                        ...
                        //abhi
                        $objRC.transactionid = jQuery(this).closest('tr').find('#txttransactionid').val();
    ...
    <script type="text/javascript">
        ...
        $validation = function () {
         ...
         if ($('#td_pndt').css('display') != 'none') {
             if (jQuery('#txtChild').val().length == 0) {
                toast("Error", "Please Enter no. of children ", "");
                  jQuery('#txtChild').focus();
                return false;
                ...
                if (jQuery('#txtSon').val().length == 0) {
                    toast("Error", "Please Enter no. of son ", "");
                    jQuery('#txtSon').focus();
                    return false;

                }
                if (jQuery('#txtDaut').val().length == 0) {
                    toast("Error", "Please Enter no. of daughter ", "");
                    jQuery('#txtDaut').focus();
                    return false;

                }
                if (jQuery('#txtPreg').val().length == 0) {
                    toast("Error", "Please Enter Pregnancy date ", "");
                    jQuery('#txtPreg').focus();
                    return false;

                }
                if (jQuery('#txtAgeSon').val().length == 0) {
                    toast("Error", "Please Enter age of son ", "");
                    jQuery('#txtAgeSon').focus();
                    return false;

                }
                if (jQuery('#txtAgeDaut').val().length == 0) {
                    toast("Error", "Please Enter age of daughter ", "");
                    jQuery('#txtAgeDaut').focus();
                    return false;

                }
                if (jQuery('#ddlPNTDDocotor').val().length == 0) {
                    toast("Error", "Please Enter pndt doctor ", "");
                    jQuery('#ddlPNTDDocotor').focus();
                    return false;
       ...
       //   }
           ...
           // }
            ...
            //    }
            //}
            var $cardNoValidate = 0; var $cardDateValidate = 0; var $bankValidate = 0; var $transactionidValidate = 0; var $txtCardDate_ = 0;
            jQuery("#tblPaymentDetail").find('tbody tr').each(function () {
                if (jQuery(this).closest('tr').find("#tdPaymentMode").text() != 1) {
                    ...
                    if (jQuery(this).closest('tr').find("#tdPaymentMode").text() != "Cash" && jQuery(this).closest('tr').find("#txttransactionid").val() == "") {
                             $transactionidValidate = 1;
                    ...
                    if (jQuery(this).closest('tr').find(".setCardDate").val() == 0) {
                        $txtCardDate_ = 1;
                        jQuery(this).closest('tr').find(".setCardDate").focus();
                        return false;
                    }
                }
            });
            ...
            if ($txtCardDate_ == 1) {
                toast("Error", "Please Select Cheque/Card Date", "");
                return false;
            }
    ...
    <script type="text/javascript">
        $("#txtSon").on('blur', function () {
            if ($('#txtDaut').val() != "" && $('#txtDaut').val() != "0") {
                if ($('#txtSon').val() > ($('#txtChild').val() - $('#txtDaut').val())) {
                    toast("Error", "Sum of Son and Daughter Cann't be Greater than Children!!!");
                }
                else if ($('#txtSon').val() < ($('#txtChild').val() - $('#txtDaut').val())) {
                    toast("Error", "Sum of Son and Daughter Cann't be Less than Children!!!");
                }
                $('#txtSon').val($('#txtChild').val() - $('#txtDaut').val());
            }
        })
        $("#txtDaut").on('blur', function () {
            if ($('#txtSon').val() != "" && $('#txtSon').val() != "0") {
                if ($('#txtDaut').val() > ($('#txtChild').val() - $('#txtSon').val())) {
                    toast("Error", "Sum of Son and Daughter Cann't be Greater than Children!!!");
                }
                else if ($('#txtDaut').val() < ($('#txtChild').val() - $('#txtSon').val())) {
                    toast("Error", "Sum of Son and Daughter Cann't be Less than Children!!!");
                }
                $('#txtDaut').val($('#txtChild').val() - $('#txtSon').val());
            }
        })
        ...
        function GetLastLabNo() {

            $.ajax({
                url: "Services/LabBooking.asmx/GetLastLabNo",
                data: '{ center:"' + $("#ddlCentre option:selected").val().split('#')[0] + '"}', // parameter map       
                type: "POST", // data has to be Posted    	        
                contentType: "application/json; charset=utf-8",
                timeout: 120000,
                dataType: "json",
                success: function (result) {
                    $('#lastlabno').html(result.d);
...
<style  type="text/css">
    ...
    <script type="text/javascript">
        $getCouponOTP = function () {
            ...
            var itemid = "";
            jQuery('#tb_ItemList tr').each(function () {
                if (jQuery(this).closest("tr").attr("id") != "LabHeader") {
            ...
            serverCall("Lab_PrescriptionOPD.aspx/ValidateCoupanGetOTP", { CouponNo: jQuery('#txtCouponNo').val(), mobileno: jQuery('#txtMobileNo').val(), PatientName: jQuery('#txtPName').val(), Panelid: jQuery('#ddlPanel').val().split('#')[0], uhid: jQuery('#txtUHIDNo').val(), itemid: itemid, tablecount: tablecount, bookingamt: jQuery('#txtNetAmount').val(), oldcouponID: oldcouponID, ispackage: subcate }, function (response) {
                var $responseData = JSON.parse(response);
                if ($responseData.status) {
        ...
        $resendCouponOTP = function () {
            serverCall("Lab_PrescriptionOPD.aspx/resendOTPCoupan", { CouponNo: jQuery('#txtCouponNo').val(), mobileno: jQuery('#txtMobileNo').val(), PatientName: jQuery('#txtPName').val(), uniqueid: jQuery('#txtUniqueID').val() }, function (response) {
                var $responseData = JSON.parse(response);
                if ($responseData.status) {
        ...
        $validateCoupon = function () {
            ...
            if (jQuery('#txtCouponOTP').val() == "") {
                jQuery('#txtCouponOTP').focus();
                toast('Error', "Please Enter OTP To Validate");
                return;
            }
            var count = jQuery('#tb_ItemList tr').length;
            if (count == 0 || count == 1) {
            ...
            jQuery('.couponspan').html('');
            serverCall("Lab_PrescriptionOPD.aspx/ValidateCoupan", { CouponNo: jQuery('#txtCouponNo').val(), Panelid: jQuery('#ddlPanel').val().split('#')[0], OTP: jQuery('#txtCouponOTP').val(), uniqueid: jQuery('#txtUniqueID').val(), MobileNo: jQuery('#txtMobileNo').val(), UHID: jQuery('#txtUHIDNo').val(), bookingamt: jQuery('#txtNetAmount').val() }, function (response) {
                var $responseData = JSON.parse(response);
                if ($responseData.status) {
                    ...
                    if (CouponDetails.length == 0) {
                        ...
                        jQuery('#tb_ItemList tr').each(function () {
                            var id = jQuery(this).closest("tr").attr("id");
                            if (id != "LabHeader" && jQuery(this).closest("tr").find("#tdDiscountApplicable").html() == "0") {
                                subcate = "1";
                            }
                        });
                        ...
                        var total1 = 0;
                        jQuery('#tb_ItemList tr').not('#LabHeader').each(function () {

                            if (jQuery(this).closest("tr").find("#tdDiscountApplicable").html() != "0") {
                        ...
                        if (jQuery('#spnCouponDiscFor').text() == "Total Bill") {
                            ...
                            $showConversionAmt("add", jQuery("#ddlCurrency"), function () { });
                            serverCall('Lab_PrescriptionOPD.aspx/getCouponAmt', { couponAmt: parseFloat(couponamt).toFixed(0) }, function (responseCouponAmt) {
                                var $Tr = [];
                                ...
                                $Tr.push('<td class="GridViewLabItemStyle" id="tdOneCouponOneMobileMultipleBilling" style="display:none;">'); $Tr.push(CouponDetails[0].OneCouponOneMobileMultipleBilling); $Tr.push('</td>');
                                $Tr.push('<td class="GridViewLabItemStyle" id="tdClientShareType" style="display:none;">'); $Tr.push(CouponDetails[0].ClientShareType); $Tr.push('</td>');
                            ...
                            serverCall('Lab_PrescriptionOPD.aspx/getcouponitemdisc', { dataIm: dataIm }, function (response) {
                                var $responseData = JSON.parse(response);
                                if ($responseData.status) {
                                    if ($responseData.response == "0") {
                                        ...
                                        serverCall('Lab_PrescriptionOPD.aspx/getCouponAmt', { couponAmt: totalCouponAmt }, function (responseCouponAmt) {
                                            var $Tr = [];
                                            $Tr.push("<tr style='background-color:bisque;' id='"); $Tr.push(CouponDetails[0].CoupanId); $Tr.push("' class='"); $Tr.push(CouponDetails[0].Coupancode); $Tr.push("' >");
                                            $Tr.push('<td class="GridViewLabItemStyle" id="tdCoupanCode">'); $Tr.push(CouponDetails[0].Coupancode); $Tr.push('</td>');
                                            $Tr.push('<td class="GridViewLabItemStyle" id="tdCoupanName">'); $Tr.push(CouponDetails[0].coupanName); $Tr.push('</td>');
                                            ...
                                            $Tr.push('<td class="GridViewLabItemStyle">'); $Tr.push(CouponDetails[0].Applicable); $Tr.push('</td>');
                                            $Tr.push('<td class="GridViewLabItemStyle" style="text-align:right">'); $Tr.push(CouponDetails[0].DiscountPercentage); $Tr.push('</td>');
                                            $Tr.push('<td class="GridViewLabItemStyle" style="text-align:right">'); $Tr.push(totalCouponAmt); $Tr.push('</td>');
                                            $Tr.push('<td class="GridViewLabItemStyle" style="text-align:right">'); $Tr.push(totalCouponAmt); $Tr.push('</td>');
        ...
        function viewitemlist(ctrl) {
            serverCall('Lab_PrescriptionOPD.aspx/bindtestmodal', { CouponID: jQuery(ctrl).closest('tr').attr('id') }, function (response) {
                var $responseData = JSON.parse(response);
                if ($responseData.status) {

<%@ Control Language="C#" AutoEventWireup="true" CodeFile="Membership_Card_Design1.ascx.cs" Inherits="Design_OPD_MemberShipCard_Membership_Card_Design1" %>
         ...
         <table  style="width:8.75cm; height:5.7cm"  >
            <tr><td colspan="2" align="center" style="" >
              ...
              <tr><td align="center">
                  ...
                  </td><td align="right" valign="bottom" rowspan="2" width="200" >
                      <br />
...
<tr>
 ...
 <asp:Label ID="Label1" CssClass="lblAdd" runat="server" Style="font-size:10px"  ForeColor="Red" Text="   No card discount available on Package Rates  "  ></asp:Label>

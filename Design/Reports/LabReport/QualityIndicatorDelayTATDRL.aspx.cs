...
public partial class Design_Lab_QualityIndicatorDelayTATDRL : System.Web.UI.Page
{
...
ddlyear.SelectedValue = DateTime.Now.Year.ToString();
    ...
    private bool reportaccess()
    {
        ...
        ReportAccessList response = JsonConvert.DeserializeObject<ReportAccessList>(objreport.ReportAccess(27));

     ...
     <asp:ScriptReference Path="~/Scripts/Common.js" />
            ...
            <div class="POuter_Box_Inventory" >
                <div class="Purchaseheader">
                 ...
                 <div class="row">
                    <div class="col-md-4"><label class="pull-right">Date Type :</label> </div>
                    <div class="col-md-4"><asp:DropDownList ID="ddlDateType" runat="server">
                        <asp:ListItem Selected="True"   Value="plo.Date">As On Date</asp:ListItem>
                        <asp:ListItem  Value="lt.Date">Billing Date</asp:ListItem>
                        <asp:ListItem Value="plo.ResultEnteredDate">Result Date</asp:ListItem>
                        <asp:ListItem  Value="plo.ApprovedDate">Approval Date</asp:ListItem>
                ...
                <div class="row">
                   ...
                   <div class="row">
							   <div class="col-md-4"><label class="pull-right">Booking Center :</label></div>
                    <div class="col-md-4"> <asp:ListBox ID="ddlcenter"  CssClass="multiselect" SelectionMode="Multiple" runat="server" ClientIDMode="Static"></asp:ListBox> 
                        ...
                        <div class="col-md-4"><label class="pull-right">Test Center :</label></div>
                  ...
                  <div class="col-md-4" ><label class="pull-right">Panel :</label></div>
                    <div class="col-md-4" style="display:none">
                          <asp:ListBox ID="lstpanellist"  CssClass="multiselect" SelectionMode="Multiple" runat="server" ClientIDMode="Static"></asp:ListBox> 
                ...
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6"> <asp:RadioButtonList ID="rbtnReportType" runat="server" RepeatDirection="Horizontal">
     ...
     <script type="text/javascript">
         ...
         function ValidateData() {
             ...
             if ($('[id$=ddlcenter]').val().toString() == "") {
                 ErrMsg += 'Please select Booking centre.\n';
             }
             if ($('[id$=lstCentre]').val().toString() == "") {
                 ErrMsg += 'Please select  Test centre.\n';
             }
             ...
             $('[id$=hdnCentre1]').val('');
             $('[id$=lstCentre]').val().toString();
             $('[id$=hdnCentre1]').val($('[id$=lstCentre]').val().toString());

...
<div class="POuter_Box_Inventory" >
    ...
    PopupButtonID="txttodate" /> </div>
             ...
             <asp:RadioButtonList ID="rblcentreType" runat="server" RepeatDirection="Horizontal">
                 <asp:ListItem Value="0" >Registration centre</asp:ListItem>
                 <asp:ListItem Value="1" Selected="True">Processing centre</asp:ListItem>
             </asp:RadioButtonList>
         </div>
            </div>
     <div class="row" >
         ...
         <div class="col-md-8">Centre::<asp:DropDownList ID="ddlcentre" runat="server" Width="150px"></asp:DropDownList></div>
           <div class="col-md-4" style="width:10%"><label class="pull-left">Date Type :</label> </div>
                    <div class="col-md-4" style="text-align:left"><asp:DropDownList ID="ddlDateType" runat="server">

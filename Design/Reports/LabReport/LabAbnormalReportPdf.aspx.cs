...
public partial class Design_Reports_LabReport_LabAbnormalReportPdf : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                try
                {
                    using (DataTable dt = ((DataTable)Session["dtAbnormalReport"]))
                    {
                        ...
                        if (dt != null && dt.Rows.Count > 0)
                        {
                            ...
                            sb.Append(" <td style='width: 20%;font-weight: bold;font-size: 14px;border-top: 2px solid; border-bottom: 2px solid;'>Patient Name</td> ");
                            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px;border-top: 2px solid; border-bottom: 2px solid;'>Age</td> ");
                            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px;border-top: 2px solid; border-bottom: 2px solid;'>Gender</td> ");                            
                            sb.Append(" <td style='width: 20%;font-weight: bold;font-size: 14px;border-top: 2px solid; border-bottom: 2px solid;'>Investigation</td> ");
                            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px;border-top: 2px solid; border-bottom: 2px solid;'>Observation</td> ");
                            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px;border-top: 2px solid; border-bottom: 2px solid;'>Value</td> ");
                            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px;border-top: 2px solid; border-bottom: 2px solid;'>DisplayReading</td> ");
                            ...
                            for (int i = 0; i < dt.Rows.Count; i++)
                            {
                                ...
                                sb.Append(" <td style='width: 20%;font-size: 14px;border-top: 1px solid; border-bottom: 1px solid;'>" + Util.GetString(dt.Rows[i]["PName"]) + "</td> ");
                                sb.Append(" <td style='width: 10%;font-size: 14px;border-top: 1px solid; border-bottom: 1px solid;'>" + Util.GetString(dt.Rows[i]["Age"]) + "</td> ");
                                sb.Append(" <td style='width: 10%;font-size: 14px;border-top: 1px solid; border-bottom: 1px solid;'>" + Util.GetString(dt.Rows[i]["Gender"]) + "</td> ");
                                sb.Append(" <td style='width: 20%;font-size: 14px;border-top: 1px solid; border-bottom: 1px solid;'>" + Util.GetString(dt.Rows[i]["Investigation"]) + "</td> ");
                                ...
                                sb.Append(" <td style='width: 10%;font-size: 14px;border-top: 1px solid; border-bottom: 1px solid;'>" + Util.GetString(dt.Rows[i]["DisplayReading"]) + "</td> ");
                                sb.Append(" </tr> ");
                            }
            ...
            finally
            {
                ...
                Session["dtAbnormalReport"] = "";
                Session.Remove("dtAbnormalReport");
            }
        }
    }
    ...
    private string MakeHeader()
    {
        ...
        sb.Append("<span style='font-weight: bold;font-size:20px;'>Lab Report (" + reportheader + ")</span><br />");

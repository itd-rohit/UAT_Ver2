...
public partial class Design_OPD_ReRunTestReportPdf : System.Web.UI.Page
{
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                StringBuilder sb = new StringBuilder();
                    ...
                    sb.Append(" SELECT  plo.`CentreID`,plo.`TestCentreID`,lt.Pname,lt.Age,lt.Gender,plo.ledgertransactionno LabNo, plo.Itemname,plo.BarcodeNo, ");
                    sb.Append(" lom.name ObsName,plr.Reason RepeatReason,em.name RepeatBy,  ");
                    sb.Append(" DATE_FORMAT(plr.dtentry,'%d-%b-%y %h:%i') RepeatDate   ");
                    sb.Append(" FROM patient_labobservation_opd_rerun plr  ");
                    sb.Append(" INNER JOIN patient_labinvestigation_opd plo ON plo.test_id=plr.test_id  ");
                    sb.Append(" INNER JOIN f_ledgertransaction lt ON lt.LedgerTransactionID=plo.LedgerTransactionID  ");
                    sb.Append(" INNER JOIN labobservation_master lom ON lom.labobservation_id=plr.labobservation_id  ");
                    sb.Append(" INNER JOIN employee_master em ON em.employee_id=plr.UserId  ");

                    sb.Append("   where plr.dtentry >= @fromDate AND plr.dtentry <= @toDate ");
                ...
                try
                {
                    using (MySqlDataAdapter da = new MySqlDataAdapter(String.Format(sb.ToString(), string.Join(",", CentreId), string.Join(",", TestCentreId)), con))
                    {
                        ...
                        if (dt != null && dt.Rows.Count > 0)
                        {
                            ...
                            if (Request.Form["ReportFormat"].ToString() == "1")
                            {
                                ...
                                sb.Append("<table style='width: 1200px;font-family:Arial;border-top:1px solid'>");
                                    ...
                                    for (int i = 0; i < dt.Rows.Count; i++)
                                    {
                                        ...
                                        sb.AppendFormat(" <td style='width:7%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["Gender"]));
                                        ...
                                        sb.AppendFormat(" <td style='width:16%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["Itemname"]));
                                        sb.AppendFormat(" <td style='width:10%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["ObsName"]));
                                        sb.AppendFormat(" <td style='width:10%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["RepeatReason"]));
                                        sb.AppendFormat(" <td style='width:10%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["RepeatDate"]));
                                        sb.AppendFormat(" <td style='width:10%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["RepeatBy"]));
                            ...
                            else
                            {
                                ...
                                Session["ReportName"] = "Re-Run Test Report";
    ...
    private string MakeHeader()
    {
        ...
        sb.Append("<td style='width:100%; text-align: center;'>");
            ...
            sb.Append("<span style='font-weight: bold;font-size:20px;'>Re-Run Test Report</span><br />");
        ...
        sb.Append("<table style='width:1200px;border-top:2px solid;border-bottom:2px solid ; font-family:Times New Roman;font-size:16px; bottom-margin:30px'>");
            ...
            sb.Append(" <tr> ");
            sb.Append(" <td style='width:3%;font-weight: bold;font-size: 16px !important;word-wrap: break-word;'>Sr.No</td> ");
            ...
            sb.Append(" <td style='width:7%;font-weight: bold;font-size: 16px !important;word-wrap: break-word;'>BarcodNo</td> ");
            sb.Append(" <td style='width:16%;font-weight: bold;font-size: 16px !important;word-wrap: break-word;'>Itemname</td> ");
            sb.Append(" <td style='width:10%;font-weight: bold;font-size: 16px !important;word-wrap: break-word;'>Observation</td> ");
            sb.Append(" <td style='width:10%;font-weight: bold;font-size: 16px !important;word-wrap: break-word;'>Reason</td> ");
            sb.Append(" <td style='width:10%;font-weight: bold;font-size: 16px !important;word-wrap: break-word;'>RepeatDate</td> ");
            sb.Append(" <td style='width:10%;font-weight: bold;font-size: 16px !important;word-wrap: break-word;'>RepeatBy</td> ");
            sb.Append(" </tr> ");

...
<Scripts>
    ...
    <asp:ScriptReference Path="~/Scripts/PostReportScript.js" />
        ...
        <div class="POuter_Box_Inventory">
            ...
            <div class="row">
                <div class="col-md-3"><label class="pull-right">Result Entry Date From:</label></div>
                ...
                <div class="col-md-3"><label class="pull-right">Result Entry To From:</label></div>
            ...
            <div class="row">
                ...
                <div class="col-md-6"> <asp:ListBox ID="lstMac" CssClass="multiselect" SelectionMode="Multiple" runat="server" ></asp:ListBox>
                 ...
                 <div class="col-md-3"><label class="pull-right"></label></div>
                 <div class="col-md-6"></div>
                <div class="col-md-6"></div>
                </div>

                        <div class="row">
                <div class="col-md-3"><label class="pull-right">Booking Centre :</label></div>
                <div class="col-md-6"> <asp:ListBox ID="lstCentre" CssClass="multiselect" SelectionMode="Multiple" runat="server" ></asp:ListBox>
                    </div>
                 <div class="col-md-3"><label class="pull-right">Test Centre :</label></div>
                 <div class="col-md-6"> <asp:ListBox ID="lstTestCentre" CssClass="multiselect" SelectionMode="Multiple" runat="server"></asp:ListBox></div>
                <div class="col-md-6"></div>
                </div>
            ...
            <div class="row" style="display:none" > 
                <div class="col-md-3"><label class="pull-right">Report Formate :</label></div>
                   <div class="col-md-21"> <asp:RadioButtonList ID="rboReporttype" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="0" >Department vs Observation</asp:ListItem>
                                <asp:ListItem Value="1" Selected="True">Department vs Observation </asp:ListItem>
     ...
     <script type="text/javascript">
        jQuery(function () {
            ...
            jQuery('[id*=<%=lstTestCentre.ClientID%>]').multipleSelect({
                includeSelectAllOption: true,
                filter: true, keepOpen: false
            });
         ...
         function getreport() {
             ...
             var TestCentreID = jQuery('#<%=lstTestCentre.ClientID%>').val().toString();
             if (TestCentreID == "") {
               //  toast("Error", "Please select Test CentreId", "");
                // return;
             }
             ...
             serverCall('LabObservationAnalysisReport.aspx/GetReport', { FromDate: FromDate, ToDate: ToDate, CentreId: CentreId, TestCentreID: TestCentreID, ReportFromat: ReportFromat, Parameter: Parameter, Machine: Machine, Reporttype: Reporttype }, function (response) {

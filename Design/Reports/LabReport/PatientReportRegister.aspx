<%@ Page Language="C#" CodeFile="PatientReportRegister.aspx.cs" EnableEventValidation="false" Inherits="Design_Reports_LabReport_PatientReportRegister" %>
            ...
            <div class="POuter_Box_Inventory" >
                <div class="row">
                    <div class="col-md-24" style="text-align: center">
                        <b>Patient Report Register</b><br />
                ...
                <div class="row">
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-4"><label class="pull-right">Department :</label></div>
                     ...
                     <div class="col-md-4"> <asp:ListBox ID="ddlInvestigations" CssClass="multiple" SelectionMode="Multiple" ClientIDMode="Static"  runat="server"></asp:ListBox>                          
                     </div>
                     </div>
                 <div class="row">
                    ...
                    <div class="col-md-4"><asp:RadioButtonList ID="rblreportformat" runat="server" RepeatDirection="Horizontal">
                                    ...
                                    <asp:ListItem Value="2" Selected="True">Excel</asp:ListItem> </asp:RadioButtonList></div>
                </div>               
            </div>

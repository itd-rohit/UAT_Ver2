<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QualityIndicatorDelayTAT_Draw.aspx.cs" Inherits="Design_Lab_QualityIndicatorDelayTAT_Draw" %>
...
<body>
   ...
   <div style="margin-left:10%;margin-top:5%;" runat="server" id="div_contain">
       <div runat="server" style="text-align:center; width:90%;margin-bottom:30px;  font-size:20px" id="divData"></div>

<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="QualityIndicatorDelayTATDRL.aspx.cs" Inherits="Design_Lab_QualityIndicatorDelayTATDRL" %>
...
<Scripts>
    ...
    <asp:ScriptReference Path="~/Scripts/toastr.min.js" />
            ...
            <div class="row" style="text-align:center">
                <div class="col-md-24">
                    <b>Quality Indicator Delay TAT Report</b>  
                    <br />
            ...
            <div class="row">
                ...
                <div class="col-md-21">
                     <asp:RadioButtonList ID="rd" runat="server" RepeatDirection="Horizontal">
                                <asp:ListItem Value="1" Selected="True">Quality Indicator Delay TAT</asp:ListItem>
                                <asp:ListItem Value="2">Quality Indicator -Sample Rejections</asp:ListItem>
                                <asp:ListItem Value="3">Quality Indicator - Sample Repeats</asp:ListItem>
                                 <asp:ListItem Value="4">Quality Indicator - II Sample Reject Criteria</asp:ListItem>
                            </asp:RadioButtonList>
                </div>
                 </div>
                <div class="row">
...
<div class="col-md-24">  <input type="button" value="Get Report" class="searchbutton" onclick="summaryreport()" /></div>
    ...
    <script type="text/javascript">
        function summaryreport() {
            ...
            window.open("QualityIndicatorDelayTATDRL_Print.aspx?Val=" + Val);
        }
    </script>
</form>
</body>

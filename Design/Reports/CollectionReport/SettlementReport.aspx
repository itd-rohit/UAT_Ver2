<%@ Page ClientIDMode="Static" Language="C#" AutoEventWireup="true" CodeFile="SettlementReport.aspx.cs" Inherits="Design_OPD_SettlementReport" %>
        ...
        <div class="POuter_Box_Inventory" runat="server" id="divuser">
            <div class="Purchaseheader">
                 <div class="row">
                    ...
                    <div class="col-md-4">Search User :&nbsp;</div> <div class="col-md-6"><input id="Text1" onkeyup="SearchCheckbox(this,chklUser)" /></div>                    
                </div>   
            </div>
            <div class="row"  style="overflow: scroll;text-align:left; height: 80px;">
             ...
             <div class="row">
               ...
               <div class="row">
                 ...
                 <div class="col-md-8"><asp:RadioButtonList ID="rdoReportFormat" runat="server" RepeatDirection="Horizontal" >
                  ...
                  <div class="col-md-8"><asp:RadioButtonList ID="rblPatienttype" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
                            <asp:ListItem Selected="True" Value="">Both</asp:ListItem>
                            <asp:ListItem Value="0">Non-Credit </asp:ListItem>
                           <asp:ListItem Value="1">Credit Patient</asp:ListItem>

                        </asp:RadioButtonList> </div>                 
                 <div class="col-md-8"><asp:RadioButtonList ID="rblsettlementtype" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
                            <asp:ListItem Selected="True" Value="">Both</asp:ListItem>
                            <asp:ListItem Value="1">Same Day</asp:ListItem>
                           <asp:ListItem Value="2">Back Day settlement</asp:ListItem>

                        </asp:RadioButtonList>
                     <asp:RadioButtonList ID="rbtReportType" runat="server" RepeatDirection="Horizontal" style="display:none" >

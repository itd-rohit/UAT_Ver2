...
public partial class Design_OPD_CollectionReportItemWise : System.Web.UI.Page
{
    ...
    private void GetCollectionData(string fromDate, string toDate, string Dept)
    {
        ...
        try
        {
            ...
            AllLoad_Data.POSTForm(collections, "Design/Reports/CollectionReport/CollectionReportItemWisePdf.aspx", this.Page);

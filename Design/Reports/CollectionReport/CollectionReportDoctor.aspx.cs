...
public partial class Design_OPD_CollectionReportDoctor : System.Web.UI.Page
{
    ...
    private void GetCollectionData(string fromDate, string toDate, string Doctor)
    {
        ...
        {           
                ...
                AllLoad_Data.POSTForm(collections, "Design/Reports/CollectionReport/CollectionReportDoctorPdf.aspx", this.Page);

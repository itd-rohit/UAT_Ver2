<%@ Page ClientIDMode="Static" Language="C#" AutoEventWireup="true" CodeFile="OutStandingReport.aspx.cs" Inherits="Design_OPD_OutStandingReport" %>
        ...
        <div class="POuter_Box_Inventory" runat="server" id="divuser">
            <div class="Purchaseheader">
             ...
             <div class="row">
                 ...
                 <div class="col-md-8"> <asp:RadioButtonList ID="rbtReportType" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
                            <asp:ListItem Selected="True" Value="0">AS ON NOW Outstanding</asp:ListItem>
                            <asp:ListItem Value="1">DATE wise  Outstanding</asp:ListItem>                           
                        </asp:RadioButtonList>
                 </div>
               </div>             
        </div>

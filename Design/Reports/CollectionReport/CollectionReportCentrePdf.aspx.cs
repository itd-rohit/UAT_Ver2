...
public partial class Design_OPD_CollectionReportCentrePdf : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                {
                    sb.Append("  SELECT Centre,CentreID,SUM(GrossAmount)GrossAmount,SUM(NetAmount)NetAmount,SUM(DiscountAmt)DiscountAmt,SUM(CashAmt)CashAmt,");
                    ...
                    sb.Append("  '' PaymentMode,0 PaymentModeID,cm.Centre,plo.`CentreID` ,   ");
                    ...
                    sb.Append(" PaymentMode,PaymentModeID,cm.Centre,rc.`CentreID` ,  ");
                    ...
                    sb.Append("  GROUP BY rc.`CentreID`  ");
                ...
                else
                {
                    ...
                    sb.Append(" FROM ( ");
                    sb.Append(" SELECT SUM(Rate*Quantity)GrossAmount,SUM(Amount)NetAmount,SUM(DiscountAmt)DiscountAmt,0 Amount,  ");
                    sb.Append("  '' PaymentMode,0 PaymentModeID,cm.Centre,plo.`CentreID` ,lt.`LedgerTransactionID`,lt.`LedgerTransactionNo`,lt.`PName`,   ");
                    sb.Append(" 0 CashAmt,0 CardAmt,0 ChequeAmt,0 OnlineAmt,0 DebitCardAmt,0 OnlinePayment,0 OPDAdvance,  ");
                    sb.Append(" SUM(IF(lt.`IsCredit`=1,(Rate*Quantity),0)) CreditSale ,0 SameDaySettlement,0 BackDaySettlement,0 CreditSaleReceiveSameDay,0 AppAmt,0 ClientAdvanceAmt ");
                    sb.Append(" FROM `patient_labinvestigation_opd` plo ");
                    sb.Append(" INNER JOIN f_ledgertransaction lt ON lt.`LedgerTransactionID`=plo.`LedgerTransactionID`   ");
                    ...
                    sb.Append(" AND plo.date >=@fromDate AND plo.date <= @toDate  AND IF(plo.isPackage=1,plo.`SubCategoryID`=15,plo.`SubCategoryID`!=15) ");
                    sb.Append("  GROUP BY lt.`LedgerTransactionID`,plo.`CentreID` ");
                    //cash collection
                    sb.Append(" UNION ALL ");
                    sb.Append(" SELECT 0 GrossAmount,0 NetAmount,0 DiscountAmt,SUM(Amount)Amount, ");
                    sb.Append(" PaymentMode,PaymentModeID,cm.Centre,rc.`CentreID` ,lt.`LedgerTransactionID`,lt.`LedgerTransactionNo`,lt.`PName`,  ");
                    sb.Append(" SUM(IF(`PaymentModeID`=1,Amount,0))CashAmt,SUM(IF(`PaymentModeID`=3,Amount,0))CardAmt, ");
                    sb.Append("  SUM(IF(`PaymentModeID`=2,Amount,0))ChequeAmt,SUM(IF(`PaymentModeID`=10,Amount,0))OnlineAmt,SUM(IF(`PaymentModeID`=5,Amount,0))DebitCardAmt, ");
                    sb.Append(" SUM(IF(`PaymentModeID`=6,Amount,0))OnlinePayment,SUM(IF(`PaymentModeID`=9,Amount,0))OPDAdvance,0 CreditSale, ");
                    sb.Append(" SUM(IFNULL((IF( lt.Date >= @fromDate   AND lt.Date <=  @toDate  ,rc.Amount,0)),0)) SameDaySettlement, ");
                    ...
                    sb.Append(" AND rc.`CreatedDate` >=@fromDate AND rc.`CreatedDate` <= @toDate ");
                    sb.Append("  GROUP BY lt.`LedgerTransactionID`,rc.`CentreID`  ");
                    //Appointment collection
                    sb.Append(" UNION ALL ");
                    sb.Append(" SELECT 0 GrossAmount,0 NetAmount,0 DiscountAmt,SUM(Amount) Amount, ");
                    sb.Append(" PaymentMode,PaymentModeID,cm.Centre,rc.`CentreID` ,rc.AppointmentID `LedgerTransactionID`,rc.`LedgerTransactionNo`,(select CONCAT(pm.`Title`,' ',pm.`PatientName`) from appointment_radiology_details pm where pm.`AppointmentID`=rc.`AppointmentID` limit 1) `PName`,  ");
                    sb.Append(" 0 CashAmt,0 CardAmt, ");
                    sb.Append(" 0 ChequeAmt,0 OnlineAmt,0 OPDAdvance,0 DebitCardAmt, ");
                    sb.Append(" 0 OnlinePayment,0 CreditSale, ");
                    sb.Append(" 0 SameDaySettlement, ");
                    ...
                    sb.Append(" 0 CreditSaleReceiveSameDay,SUM(Amount)AppAmt,0 ClientAdvanceAmt ");
                    sb.Append(" FROM f_receipt rc ");
                    sb.Append("  INNER JOIN centre_master cm ON cm.`CentreID`=rc.`CentreID` and ifnull(rc.AppointmentID,'')<>'' AND rc.`PayBy`<>'C' ");
                    if (Request.Form["ClientID"].ToString() != string.Empty)
                        sb.Append(" AND rc.`Panel_ID` IN ({0}) ");
                    ...
                    sb.Append(" AND rc.`CreatedDate` >=@fromDate AND rc.`CreatedDate` <= @toDate ");
                    sb.Append("  GROUP BY rc.`AppointmentID`,rc.`CentreID`  ");
                    //Client Advance collection
                    sb.Append(" UNION ALL ");
                    sb.Append(" SELECT 0 GrossAmount,0 NetAmount,0 DiscountAmt,SUM(Amount) Amount, ");
                    sb.Append(" PaymentMode,PaymentModeID,cm.Centre,rc.`CentreID` ,rc.AppointmentID `LedgerTransactionID`,rc.`LedgerTransactionNo`,(select CONCAT(pm.`Title`,' ',pm.`PatientName`) from appointment_radiology_details pm where pm.`AppointmentID`=rc.`AppointmentID` limit 1) `PName`,  ");
                    ...
                    sb.Append(" AND rc.`CreatedDate` >=@fromDate AND rc.`CreatedDate` <= @toDate ");
                    sb.Append("  GROUP BY rc.`AppointmentID`,rc.`CentreID`  ");   
                    sb.Append(" )a GROUP BY CentreID,LedgerTransactionID ");

                }
//System.IO.File.WriteAllText(@"F:\Lims 6.0\live_Code\Mdrc\ErrorLog\col.txt",sb.ToString());
                    ...
                    using (MySqlDataAdapter da = new MySqlDataAdapter(String.Format(sb.ToString(), string.Join(",", UserDataList), string.Join(",", CentreIDDataList)), con))
                    {
                        ...
                        if (dt != null && dt.Rows.Count > 0)
                        {
                            ...
                            if (Request.Form["ReportFormat"].ToString() == "1")
                            {
                                ...
                                sb.Append("<table style='width: 1200px;border-collapse: collapse;font-family:Arial;border-top:1px solid'>");
                                if (Request.Form["ReportType"].ToString() == "0")
                                {
                                    for (int i = 0; i < dt.Rows.Count; i++)
                                    {
                                        ...
                                        sb.Append("<tr> ");
                                        sb.AppendFormat(" <td style='width: 12%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["Centre"]));
                                    ...
                                    sb.Append("<tr> ");
                                    sb.AppendFormat(" <td style='width: 12%;font-size: 14px;padding-top: 10px;font-weight: bold '>Total:</td>");
                                    sb.AppendFormat(" <td style='width: 7%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("GrossAmount"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("DiscountAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("NetAmount"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("CashAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("CardAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 7%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("ChequeAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 7%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("DebitCardAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 7%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("OnlineAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("OPDAdvance"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("ClientAdvanceAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("AppAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("ReceivedAmount"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("CreditSale"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                    sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dt.AsEnumerable().Sum(x => x.Field<decimal>("Oustanding"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                ...
                                {
                                    List<getDetail> CentreID = new List<getDetail>();
                                    ...
                                    {
                                        DataTable dtdoc = dt.AsEnumerable().Where(x => x.Field<int>("CentreID") == Util.GetInt(distinctdoctor[j].CentreID)).CopyToDataTable();
                                        sb.Append(" <tr> ");
                                        sb.Append(" <td colspan='2' style='font-size: 16px;padding-top: 10px;padding-bottom: 10px;'>Centre : </td> ");
                                        sb.Append(" <td colspan='13' style='font-size: 16px;font-weight: bold;padding-top: 10px;padding-bottom: 10px;text-align:left;'>" + Util.GetString(dtdoc.Rows[0]["Centre"].ToString()) + "</td> ");
                                        sb.Append(" </tr> ");
                                        ...
                                        for (int i = 0; i < dtdoc.Rows.Count; i++)
                                        {
                                            ...
                                            sb.AppendFormat(" <td style='width: 7%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.Rows[i]["OnlineAmt"]), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                            ...
                                            sb.AppendFormat(" <td style='width: 6%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.Rows[i]["ClientAdvanceAmt"]), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                        ...
                                        sb.AppendFormat(" <td style='width: 7%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.AsEnumerable().Sum(x => x.Field<decimal>("ChequeAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                        sb.AppendFormat(" <td style='width: 7%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.AsEnumerable().Sum(x => x.Field<decimal>("DebitCardAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                        sb.AppendFormat(" <td style='width: 7%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.AsEnumerable().Sum(x => x.Field<decimal>("OnlineAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                        sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.AsEnumerable().Sum(x => x.Field<decimal>("OPDAdvance"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                        sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.AsEnumerable().Sum(x => x.Field<decimal>("ClientAdvanceAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                        
                                        sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.AsEnumerable().Sum(x => x.Field<decimal>("AppAmt"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                        sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.AsEnumerable().Sum(x => x.Field<decimal>("ReceivedAmount"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                        sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.AsEnumerable().Sum(x => x.Field<decimal>("CreditSale"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                                        sb.AppendFormat(" <td style='width: 6%;font-size: 14px;border-bottom: 1px solid;padding-top: 10px;font-weight: bold '>{0}</td> ", Math.Round(Util.GetDecimal(dtdoc.AsEnumerable().Sum(x => x.Field<decimal>("Oustanding"))), Util.GetInt(Resources.Resource.BaseCurrencyRound)), MidpointRounding.AwayFromZero);
                            ...
                            else
                            {
                                ...
                                Session["ReportName"] = "Centre Wise Collection Report";
    ...
    private string MakeHeader()
    {
        ...
        if (Request.Form["ReportType"].ToString() == "0")
        {
            sb.Append("<span style='font-weight: bold;font-size:20px;'>Centre Wise Collection Report(Summary)</span><br />");
        }
        else
        {
            sb.Append("<span style='font-weight: bold;font-size:20px;'>Centre Wise Collection Report(Detail)</span><br />");
        }
        sb.Append("</td>");
        sb.Append("</tr>");
        sb.Append("<tr>");
        ...
        sb.Append(" </div> ");
        sb.Append(" <div style='width:1200px;'>");
        sb.Append("<table style='width:1200px;border-top:2px solid #000;border-bottom:2px solid #000; font-family:Times New Roman;font-size:16px;'>");
        if (Request.Form["ReportType"].ToString() == "0")
        {
            sb.Append(" <tr> ");
            sb.Append(" <td style='width: 12%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Centre Name</td> ");
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>GrossAmt</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>DiscAmt</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>NetAmt</td> ");

            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>CashAmt</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>CardAmt</td> ");
            ...
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>OnlinePay</td> ");
        ...
        {
            sb.Append(" <tr> ");
            sb.Append(" <td style='width: 12%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Patient Name</td> ");
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>GrossAmt</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>DiscAmt</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>NetAmt</td> ");
            ...
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>ChequeAmt</td> ");
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>D.CardAmt</td> ");
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Online Pay</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>OPD Advance</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>CreditSale</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Rec.Amt</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>AppAmt</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Client Ad Amt</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Cash Outs.</td> ");
            sb.Append(" </tr> ");
        }
        sb.Append("</table>");

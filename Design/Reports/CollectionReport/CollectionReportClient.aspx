<%@ Page ClientIDMode="Static" Language="C#"  AutoEventWireup="true" CodeFile="CollectionReportClient.aspx.cs" Inherits="Design_OPD_CollectionReportClient" %>
...
<Scripts>
    ...
    <asp:ScriptReference Path="~/Scripts/CheckboxSearch.js" />
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <b>Client Wise Collection Report</b>
            <br />
        ...
        <div class="POuter_Box_Inventory" runat="server" id="divuser">
            <div class="Purchaseheader">
                   <div class="row">
                    ...
                    <div class="col-md-4">Search Client :&nbsp;</div><div class="col-md-4"> <input id="txtSearchUsers" onkeyup="SearchCheckbox(this,chklClient)" /></div>                    
                </div>                              
            </div>          
                <div class="row"  style="overflow: scroll;text-align:left; height: 100px;">

<%@ Page ClientIDMode="Static" Language="C#" AutoEventWireup="true" CodeFile="CollectionReportDoctor.aspx.cs" Inherits="Design_OPD_CollectionReportDoctor" %>
...
<Scripts>
    ...
    <asp:ScriptReference Path="~/Scripts/CheckboxSearch.js" />
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <b>Doctor Wise Collection Report</b>
            <br />
        ...
        <div class="POuter_Box_Inventory" runat="server" id="divuser">
            <div class="Purchaseheader">
                    ...
                    <div class="col-md-4">Search Doctor :&nbsp;</div> <div class="col-md-4"> <input id="txtSearchUsers" onkeyup="SearchCheckbox(this,chklDoctor)" /></div>                    
                </div>                 
            </div>         

...
public partial class Design_OPD_CollectionReportClient : System.Web.UI.Page
{
    ...
    private bool reportaccess()
    {
        ...
        ReportAccessList response = JsonConvert.DeserializeObject<ReportAccessList>(objreport.ReportAccess(4));
    ...
    private void GetCollectionData(string fromDate, string toDate, string Client)
    {
        ...
        try
        {
             NameValueCollection collections = new NameValueCollection();
                ...
                AllLoad_Data.POSTForm(collections, "Design/Reports/CollectionReport/CollectionReportClientWise.aspx", this.Page);            
        }
        catch (Exception ex)
        {

<%@ Page ClientIDMode="Static" Language="C#" AutoEventWireup="true" CodeFile="CollectionReportDept.aspx.cs" Inherits="Design_OPD_CollectionReportDept" %>
...
<Scripts>
    ...
    <asp:ScriptReference Path="~/Scripts/CheckboxSearch.js" />
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <b>Department Wise Collection Report</b>
            <br />
        ...
        <div class="POuter_Box_Inventory"  runat="server" id="divuser">
            ...
            <div class="row"  style="overflow: scroll;text-align:left; height: 150px;">

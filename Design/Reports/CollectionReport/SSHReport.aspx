<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSHReport.aspx.cs" Inherits="Design_Reports_CollectionReport_SSHReport" %>
        ...
        <div class="POuter_Box_Inventory"  runat="server" id="divcentre">
            <div class="Purchaseheader">
             ...
             <div class="row"  style="overflow: scroll;text-align:left; height: 100px;">
                    <div class="col-md-24"> <asp:CheckBoxList ID="chklCentres" runat="server" RepeatColumns="6" RepeatDirection="Horizontal" CssClass="chkCentre" OnSelectedIndexChanged="chklCentres_SelectedIndexChanged" AutoPostBack=""></asp:CheckBoxList></div>
                 </div> 
        </div>
        <div class="POuter_Box_Inventory" runat="server" id="divuser">
            <div class="Purchaseheader">
                <div class="row">
                    <div class="col-md-6">Panel   <asp:CheckBox ID="chkDept" runat="server" Text="Select All Panel" onclick="SelectAll('Department')" /></div>
                    <div class="col-md-4">Search Panel :&nbsp;</div><div class="col-md-4">  <input id="txtSearchUsers" onkeyup="SearchCheckbox(this,chklDept)" /></div>                    
                </div>                                              
            </div>

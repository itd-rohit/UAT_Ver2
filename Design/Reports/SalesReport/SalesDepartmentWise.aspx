<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="SalesDepartmentWise.aspx.cs" Inherits="Design_Sales_SalesDepartmentWise" %>
		...
		function ExcelReport() 
		 {
            ...
            serverCall('SalesDepartmentWise.aspx/DepartmentWiseSalesExcel', { ToDate: $("#<%=txtTo.ClientID %>").val() ,FromDate: $("#<%=txtFrom.ClientID %>").val() ,pro: pro ,Department: $("#<%=ddlDept.ClientID %>").val() }, function (response) {
                    debugger;
...
else
{
 showerrormsg("No Record(s) found");
        ...
        function Search() {
            var pro = $("#<%=ddlpro.ClientID %>").val();
            serverCall('SalesDepartmentWise.aspx/DepartmentWiseSales', { ToDate: $("#<%=txtTo.ClientID %>").val() ,FromDate: $("#<%=txtFrom.ClientID %>").val() ,pro: pro ,Department: $("#<%=ddlDept.ClientID %>").val() }, function (response) {
                var ProData = $.parseJSON(response);
                    if (ProData.length > 0) {
                        $("#tb_grid").show();
                        $("#RefHead").empty();
 ...
 function showerrormsg(msg) {
    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory">
            <div class="Purchaseheader" style="text-align:center">Sales Executive Vs Department</div>
            ...
            <div class="row">
                ...
                <div class="col-md-3"> <asp:DropDownList ID="ddlpro" runat="server" CssClass="chosen-select"  ClientIDMode="Static"></asp:DropDownList></div>
                 <div class="col-md-2"> <label class="pull-right">Department :</label></div>
                <div class="col-md-3"> <asp:DropDownList ID="ddlDept" runat="server" CssClass="chosen-select"  ClientIDMode="Static"></asp:DropDownList></div>
                <div class="col-md-3"> <input type="button" id="btnSearch" runat="server" class="searchbutton" clientidmode="Static" value="Search" onclick="Search();" style="margin-left: 30px;" />&nbsp;&nbsp;&nbsp;                           
                            <img src="../../../App_Images/excelexport.gif" alt="Export" onclick="ExcelReport()" style="width: 34px; vertical-align: middle; height: 30px;" /></div>

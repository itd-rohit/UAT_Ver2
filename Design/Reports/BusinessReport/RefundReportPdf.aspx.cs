...
public partial class Design_Reports_BusinessReport_RefundReportPdf : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            try
            {
              string  CentreID1=  Request.Form["CentreID"].ToString();
                ...
                if (Request.Form["Reporttype"].ToString() == "0")
                {
                    ...
                    sb.Append(" lt.PanelName,cm.`Centre`, ");
                    ...
                    sb.Append(" INNER JOIN `f_ledgertransaction` lt ON lt.`LedgerTransactionID`=r.`LedgerTransactionID`INNER JOIN centre_master cm ON cm.`CentreID` = lt.CentreID ");

                    if (Request.Form["CentreID"] != "ALL")
                        sb.Append(" AND lt.CentreID in(" + CentreID1 + ")");
                            ...
                            if (Request.Form["ReportFormat"].ToString() == "1")
                            {
                                ...
                                if (Request.Form["Reporttype"].ToString() == "0")
                                {
                                    ...
                                    for (int i = 0; i < dt.Rows.Count; i++)
                                    {
                                        ...
                                        sb.AppendFormat(" <td style='width: 8%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["AmountPaid"]));
                                        sb.AppendFormat(" <td style='width: 8%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["AmtCash"]));
                                        sb.AppendFormat(" <td style='width: 8%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["AmtCheque"]));
                                        sb.AppendFormat(" <td style='width: 8%;border-bottom: 1px solid;font-size: 14px !important;word-wrap: break-word;'>{0}</td> ", Util.GetString(dt.Rows[i]["AmtCreditCard"]));
    ...
    private string MakeHeader()
    {
        ...
        {
            sb.Append(" <tr> ");
            sb.Append(" <td style='width: 3%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>SrNo.</td> ");
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>LabNo</td> ");
            sb.Append(" <td style='width: 8%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Patient Name</td> ");
            sb.Append(" <td style='width: 12%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Centre</td> ");
            sb.Append(" <td style='width: 9%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Bill No</td> ");
            sb.Append(" <td style='width: 9%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Reg Date</td> ");
            sb.Append(" <td style='width: 13%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Refund Date</td> ");
            sb.Append(" <td style='width: 6%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Refund Amt</td> ");
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Cash</td> ");
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Cheque Amt</td> ");
            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Credit Card Amt</td> ");
            sb.Append(" <td style='width: 12%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Refund By</td> ");
            sb.Append(" </tr> ");
        }
        else
        {
            ...
            sb.Append(" <td style='width: 3%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>SrNo.</td> ");
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>LabNo</td> ");
            sb.Append(" <td style='width: 7%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Patient Name</td> ");
            sb.Append(" <td style='width: 12%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Centre</td> ");
            sb.Append(" <td style='width: 9%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Bill No</td> ");
            sb.Append(" <td style='width: 9%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Dept Name</td> ");
            sb.Append(" <td style='width: 13%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>ItemName</td> ");
            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>PanelName</td> ");
            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Reg Date</td> ");
            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Refund Date</td> ");
            sb.Append(" <td style='width: 10%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Refund Amt</td> ");
            sb.Append(" <td style='width: 12%;font-weight: bold;font-size: 14px !important;word-wrap: break-word;'>Refund By</td> ");
            sb.Append(" </tr> ");
        }
        sb.Append("</table>");

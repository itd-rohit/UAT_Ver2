...
public partial class Design_OPD_BusinessReportDept : System.Web.UI.Page
{
    ...
    private bool reportaccess()
    {
        ...
        ReportAccessList response = JsonConvert.DeserializeObject<ReportAccessList>(objreport.ReportAccess(16));
    ...
    private void GetCollectionData(string fromDate, string toDate, string Dept)
    {
        ...
        {           
                ...
                AllLoad_Data.POSTForm(collections, "Design/Reports/BusinessReport/BusinessReportDeptPDF.aspx", this.Page);
        }
        catch (Exception ex)
        {

<%@ Page ClientIDMode="Static" Language="C#" AutoEventWireup="true" CodeFile="BusinessReportClient.aspx.cs" Inherits="Design_OPD_BusinessReportClient" %>
            ...
            <div class="row">
             ...
             <div class="row">
                    <div class="col-md-8"> <asp:RadioButtonList ID="rbtReportType" runat="server" RepeatDirection="Horizontal" >
                            ...
                            <asp:ListItem  Value="1">Detail(Patient Item Name With Date)</asp:ListItem>

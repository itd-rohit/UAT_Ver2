...
public partial class Design_OPD_BusinessReportUser : System.Web.UI.Page
{
    ...
    private bool reportaccess()
    {
        ...
        ReportAccessList response = JsonConvert.DeserializeObject<ReportAccessList>(objreport.ReportAccess(18));
    ...
    private void GetCollectionData(string fromDate, string toDate, string userID)
    {
        ...
        try
        {
                ...
                AllLoad_Data.POSTForm(collections, "Design/Reports/BusinessReport/BusinessReportUserPdf.aspx", this.Page);
        }
        catch (Exception ex)
        {
            ClassLog cl = new ClassLog();

<%@ Page ClientIDMode="Static" Language="C#" AutoEventWireup="true" CodeFile="BusinessReportDoctor.aspx.cs" Inherits="Design_OPD_BusinessReportDoctor" %>
...
<Scripts>
    ...
    <asp:ScriptReference Path="~/Scripts/CheckboxSearch.js" />
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <b>Doctor Wise Business Report</b>
            <br />
        ...
        <div class="POuter_Box_Inventory" runat="server" id="divcentre">
            <div class="Purchaseheader">
                <div class="row">
                    ...
                    <div class="col-md-4">Search Centre :&nbsp;</div> <div class="col-md-6"><input id="txtSearchCentres" onkeyup="SearchCheckbox(this,chklCentres)" /></div>                    
                </div>  
            </div>

            <div id="" style="overflow: scroll;text-align:left; height: 100px;">
                <asp:CheckBoxList ID="chklCentres" runat="server" RepeatColumns="6" RepeatDirection="Horizontal" CssClass="chkCentre"></asp:CheckBoxList>
            </div>
        </div>
        <div class="POuter_Box_Inventory" runat="server" id="divuser">
            <div class="Purchaseheader">
                    ...
                    <div class="row">
                    <div class="col-md-6">Doctor   <asp:CheckBox ID="chkDoctor" runat="server" Text="Select All Doctor" onclick="SelectAll('Doctor')" /></div>
                    <div class="col-md-4">Search Doctor :&nbsp;</div>  <div class="col-md-6"><input id="txtSearchUsers" onkeyup="SearchCheckbox(this,chklDoctor)" /></div>                    
                </div>                 
            </div>         

            <div style="overflow: scroll;text-align:left; height: 200px;">
               <asp:CheckBoxList ID="chklDoctor" runat="server" RepeatColumns="6" RepeatDirection="Horizontal" CssClass="chkCentre"></asp:CheckBoxList>
            </div>
           <div class="row">
        ...
        function SelectAll(Type) {
            if (Type == "Centre") {
                ...
                for (var i = 0; i < chkBoxCount.length; i++) {
                    ...
                    var chkBoxList = document.getElementById('<%=chklDoctor.ClientID %>');
                var chkBoxCount = chkBoxList.getElementsByTagName("input");
                for (var i = 0; i < chkBoxCount.length; i++) {
                    chkBoxCount[i].checked = document.getElementById('<%=chkDoctor.ClientID %>').checked;
                    }
                }

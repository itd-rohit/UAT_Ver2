...
public partial class Design_OPD_BusinessReportItemWise : System.Web.UI.Page
{
    ...
    private bool reportaccess()
    {
        ...
        ReportAccessList response = JsonConvert.DeserializeObject<ReportAccessList>(objreport.ReportAccess(17));
    ...
    private void GetCollectionData(string fromDate, string toDate, string Dept)
    {
        ...
        try
        {
            ...
            AllLoad_Data.POSTForm(collections, "Design/Reports/BusinessReport/BusinessReportItemWisePdf.aspx", this.Page);

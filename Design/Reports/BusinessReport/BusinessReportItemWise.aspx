<%@ Page ClientIDMode="Static" Language="C#" AutoEventWireup="true" CodeFile="BusinessReportItemWise.aspx.cs" Inherits="Design_OPD_BusinessReportItemWise" %>
...
<Scripts>
    ...
    <asp:ScriptReference Path="~/Scripts/PostReportScript.js" />
        ...
        <div class="POuter_Box_Inventory"  runat="server" id="divcentre">
            <div class="Purchaseheader">
             ...
             <div class="row"  style="overflow: scroll;text-align:left; height: 80px;">
                    <div class="col-md-24"> <asp:CheckBoxList ID="chklCentres" runat="server" RepeatColumns="8" RepeatDirection="Horizontal" CssClass="chkCentre"></asp:CheckBoxList></div>
                 </div> 
        </div>
        <div class="POuter_Box_Inventory" runat="server" id="divuser">
            <div class="Purchaseheader">
                <div class="row">
                    <div class="col-md-6">Department   <asp:CheckBox ID="chkDept" runat="server" Text="Select All Department" onclick="SelectAll('Department')" /></div>
                    <div class="col-md-4">Search Department :&nbsp;</div>  <div class="col-md-4"><input id="txtSearchUsers" onkeyup="SearchCheckbox(this,chklDept)"  /></div>                    
                </div>                                              
            </div>
              <div class="row"  style="overflow: scroll;text-align:left; height: 130px;">
                    <div class="col-md-24"> <asp:CheckBoxList ID="chklDept" runat="server" RepeatColumns="8" RepeatDirection="Horizontal" CssClass="chkCentre"></asp:CheckBoxList></div>
                 </div>           
           <div class="row">
               ...
               <div class="col-md-3"><asp:TextBox ID="txtFromTime" runat="server" MaxLength="8"  ToolTip="Enter Time" />
             ...
             <div class="row">
                 <div class="col-md-3"> </div>
                     <div class="col-md-6"> <asp:RadioButtonList ID="rbtReportType" runat="server" RepeatDirection="Horizontal" >
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;" runat="server" id="divsave">
              <div class="row"> 
                   <div class="col-md-3"><asp:RadioButtonList ID="rdoReportFormat" runat="server" RepeatDirection="Horizontal" >
    ...
    <script type="text/javascript">
        function SelectAll(Type) {
            if (Type == "Centre") {
                ...
                var chkBoxList = document.getElementById('<%=chklDept.ClientID %>');
                var chkBoxCount = chkBoxList.getElementsByTagName("input");
                for (var i = 0; i < chkBoxCount.length; i++) {

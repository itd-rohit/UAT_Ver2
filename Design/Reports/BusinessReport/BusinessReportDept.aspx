<%@ Page ClientIDMode="Static" Language="C#" AutoEventWireup="true" CodeFile="BusinessReportDept.aspx.cs" Inherits="Design_OPD_BusinessReportDept" %>
...
<Scripts>
    ...
    <asp:ScriptReference Path="~/Scripts/CheckboxSearch.js" />
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;">
            <b>Department Wise Business Report</b>
            <br />
        ...
        <div class="POuter_Box_Inventory"  runat="server" id="divuser">
            <div class="Purchaseheader">
                <div class="row">
                    ...
                    <div class="col-md-4">Search Department :&nbsp;</div>   <div class="col-md-6"><input id="txtSearchUsers" onkeyup="SearchCheckbox(this,chklDept)"  /></div>                    
                </div>  
            </div>

...
public partial class Design_OPD_BusinessReportDoctor : System.Web.UI.Page
{
    ...
    private bool reportaccess()
    {
        ...
        ReportAccessList response = JsonConvert.DeserializeObject<ReportAccessList>(objreport.ReportAccess(15));
    ...
    {
        using (DataTable dt = AllLoad_Data.loadDoctor())
        {
            if (dt.Rows.Count > 0)
            {
                chklDoctor.DataSource = dt;
                chklDoctor.DataTextField = "NAME";
                chklDoctor.DataValueField = "Doctor_ID";
                chklDoctor.DataBind();
            }
        }
    }
    ...
    protected void btnPreview_Click(object sender, EventArgs e)
    {
        ...
        string startDate = string.Empty, toDate = string.Empty, Doctor;
        ...
        Doctor = GetSelection(chklDoctor);


        GetCollectionData(startDate, toDate, Doctor);
    }
    private void GetCollectionData(string fromDate, string toDate, string Doctor)
    {
        ...
        {           
                ...
                collections.Add("DoctorID", Doctor);
                ...
                AllLoad_Data.POSTForm(collections, "Design/Reports/BusinessReport/BusinessReportDoctorPdf.aspx", this.Page);

...
public partial class Design_OPD_BusinessReportClient : System.Web.UI.Page
{
    ...
    private void GetCollectionData(string fromDate, string toDate, string Client)
    {
        ...
        try
        {
             NameValueCollection collections = new NameValueCollection();
                ...
                AllLoad_Data.POSTForm(collections, "Design/Reports/BusinessReport/BusinessReportClientPdf.aspx", this.Page);            
        }
        catch (Exception ex)
        {

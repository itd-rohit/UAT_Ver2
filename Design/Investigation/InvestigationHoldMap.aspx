<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InvestigationHoldMap.aspx.cs" Inherits="Design_Investigation_InvestigationHoldMap" %>
   ...
   <table style="width:600px;">
       ...
       <tr style="display:none;">
           <td style="font-weight:bold;color:red;">
            ...
            <tr>
                <td style="font-weight:bold;color:red;">Ovservation&nbsp;&nbsp; ::&nbsp;<asp:Label ID="lbobs" runat="server"></asp:Label>
                </td>
       </tr>
       ...
       <tr>
           <td>
               ...
               <asp:GridView ID="grd" OnRowDataBound="grd_RowDataBound" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="3" EnableModelValidation="True" BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px">
                   <Columns>
                       <asp:TemplateField HeaderText="Observation Name">
                          <HeaderTemplate>
                             Investigation:: <asp:TextBox ID="txtearch" Width="300px" runat="server"  placeholder="Search Observation"  />
                           ...
                           <ItemTemplate>
                               <asp:Label ID="Label1" runat="server" Text='<%# Bind("NAME") %>'></asp:Label>
                                <asp:Label ID="Label2" runat="server" Visible="false" Text='<%# Bind("LabObservation_ID") %>'></asp:Label>
                           </ItemTemplate>
                       </asp:TemplateField>
            ...
            <td style="text-align:center;">
                <asp:Button Font-Bold="true" ID="btnsave" OnClick="btnsave_Click" runat="server" Text="Save Mapping" style="cursor:pointer;background-color:maroon;color:white;padding:5px;" />
            </td>
       </tr>
   </table>

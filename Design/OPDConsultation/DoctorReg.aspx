<%@ Page Language="C#" ValidateRequest="false" AutoEventWireup="true" MasterPageFile="~/Design/DefaultHome.master" MaintainScrollPositionOnPostback="true" CodeFile="DoctorReg.aspx.cs" Inherits="Design_FrontOffice_DoctorReg" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <b>DOCTOR REGISTRATION</b><br />
         <asp:Label ID="lblerrmsg" runat="server" ForeColor="#FF0033" Font-Bold="true" ></asp:Label>&nbsp;</div>
		  ...
		  <div class="col-md-3 ">
		   ...
		   <div class="col-md-1 ">
                   ...
                   <asp:DropDownList ID="cmbTitle" runat="server" CssClass="inputbox4" TabIndex="1"
                      Width="50px"      ToolTip="select  gender">
		  ...
		  <div class="col-md-3 ">
		   ...
		   <div class="col-md-5 ">
                    ...
                    <asp:TextBox ID="txtPhone1"
                            runat="server" CssClass="inputbox2"  MaxLength="10" TabIndex="3" ></asp:TextBox></div>
               <div class="col-md-3 ">
		   ...
		   <div class="col-md-5 ">
                    ...
                    <asp:TextBox ID="TxtMobileNo" runat="server" CssClass="inputbox2"  MaxLength="10"
                        TabIndex="4"></asp:TextBox></div></div>
             <div class="row">
		  <div class="col-md-3 ">
		   ...
		   <div class="col-md-5 ">
                    ...
                    <asp:TextBox ID="txtAdd" runat="server" CssClass="inputbox2"
                        TabIndex="5" MaxLength="5" TextMode="MultiLine"></asp:TextBox></div>
 <div class="col-md-3 ">
			   <label class="pull-left">  Specialization   </label>
			   <b class="pull-right">:</b>
		   </div>
		   <div class="col-md-5 ">
                   <asp:DropDownList ID="ddlSpecial" runat="server" CssClass="inputcombobox" TabIndex="6"> </asp:DropDownList>
           </div></div>
            <div class="row">
		  <div class="col-md-3 ">
		   ...
		   <div class="col-md-5 ">
                        <asp:DropDownList ID="cmbDept" runat="server" CssClass="inputcombobox" TabIndex="7"></asp:DropDownList>
		   ...
		   <div class="col-md-5 ">
                        <asp:DropDownList ID="ddlCentreAccess" class="ddlcentreAccess" runat="server"></asp:DropDownList></div>
      ...
      <div class="POuter_Box_Inventory" >
		  ...
		  <div class="col-md-3 ">
		   ...
		   <div class="col-md-5 ">
                  <asp:ScriptManager ID="ScriptManger1" runat="Server">
                    ...
                    <asp:TextBox ID="txtHr1" runat="server" CssClass="inputbox3" placeholder="Hour" MaxLength="2" TabIndex="15" Width="50px" ></asp:TextBox>
               <asp:TextBox ID="txtMin1" runat="server" placeholder="Min"  CssClass="inputbox3" Width="50px" MaxLength="2" TabIndex="16"></asp:TextBox>
               <asp:DropDownList ID="cmbAMPM1" Width="60px" runat="server" CssClass="inputcombobox" TabIndex="17" >
                                <asp:ListItem>AM</asp:ListItem> <asp:ListItem>PM</asp:ListItem></asp:DropDownList>
		   ...
		   <div class="col-md-5 ">
                    ...
                    <asp:TextBox ID="txtHr2" runat="server" CssClass="inputbox3" MaxLength="2" TabIndex="18" Width="50px" placeholder="Hour"
                       ></asp:TextBox><asp:TextBox ID="txtMin2" runat="server" CssClass="inputbox3" Width="50px" placeholder="Min"
		  ...
		  <div class="col-md-3 ">
		   ...
		   <div class="col-md-5 ">
                        <asp:TextBox ID="txtRoomNo" MaxLength="10" runat="server" CssClass="inputbox3"
    ...
    <script type="text/javascript">
        ...
        jQuery("#<%=txtHr1.ClientID%>").on("input", function () {
             debugger;
             if (jQuery('#<%=txtHr1.ClientID%>').val() > 12) {
                     toast("Error", 'Hour should be less Than 12 !!', '');
                     jQuery('#<%=txtHr1.ClientID%>').focus();
                     return false;
                 }
             
        });

        jQuery("#<%=txtMin1.ClientID%>").on("input", function () {
            debugger;
            if (jQuery('#<%=txtMin1.ClientID%>').val() > 60) {
                 toast("Error", 'Minute should be less Than 60 !!', '');
                 jQuery('#<%=txtMin1.ClientID%>').focus();
                     return false;
                 }
        ...
        jQuery("#<%=txtHr2.ClientID%>").on("input", function () {
            debugger;
            if (jQuery('#<%=txtHr2.ClientID%>').val() > 12) {
                 toast("Error", 'End Time Hour should be less Than 12 !!', '');
                 jQuery('#<%=txtHr2.ClientID%>').focus();
                     return false;
                 }

        });

             jQuery("#<%=txtMin2.ClientID%>").on("input", function () {
            debugger;
            if (jQuery('#<%=txtMin2.ClientID%>').val() > 60) {
                toast("Error", 'Minute should be less Than 60 !!', '');
                jQuery('#<%=txtMin2.ClientID%>').focus();
                 return false;
             }
        ...
        <div class="POuter_Box_Inventory" >
            ...
            <asp:Button ID="btnSave" runat="server" CssClass="input_butt1" OnClick="btnSave_Click" TabIndex="24" Text="Save" />
                </div>
           </div>
        </div>
  </asp:Content>

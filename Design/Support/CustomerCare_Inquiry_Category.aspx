<%@ Page  ClientIDMode="Static" Language="C#" MasterPageFile="~/Design/DefaultHome.master"  ValidateRequest="false" EnableEventValidation="false" AutoEventWireup="true" CodeFile="CustomerCare_Inquiry_Category.aspx.cs" Inherits="Design_CallCenter_CustomerCare_Inquiry_Category" %>
       ...
       <div class="POuter_Box_Inventory" >
        ...
        <div class="POuter_Box_Inventory" >   
            ...
            <div class="row" style="display:none">
             ...
             <div class="col-md-3">
                            <asp:ListBox ID="lstCentreType" runat="server"   CssClass="multiselect"   SelectionMode="Multiple" ClientIDMode="Static"></asp:ListBox>
                 </div>   
                 ...
                 <div class="col-md-3 MoreFilter" style="display:none">
                  ...
                  <div class="col-md-3">
                     <asp:ListBox ID="lstZone" CssClass="multiselect" SelectionMode="Multiple" runat="server"  ClientIDMode="Static" onchange="bindState()"></asp:ListBox>
        ...
        <div class="Purchaseheader">
             ...
             <div class="row">
               ...
               <div class="row">
                ...
                <div class="col-md-10">
                    <asp:TextBox ID="txtName" runat="server"  ClientIDMode="Static"  CssClass="autocomplete" />
             ...
             <div class="col-md-3">
              ...
              <div class="row hide" >
                ...
                <div class="col-md-5 hideCCLevel2">
                    <asp:CheckBox ID="chkEmailCCLevel2" runat="server" ClientIDMode="Static" />
                ...
                <div class="col-md-5 hideCCLevel3">
                    <asp:CheckBox ID="chkEmailCCLevel3" runat="server" ClientIDMode="Static" /> 
                    </div>
                   </div>
        ...
        <div class="Purchaseheader">
             ...
             <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-md-10">
                     <asp:TextBox ID="defaulttxtName" runat="server"  ClientIDMode="Static" />
             ...
             <div class="row hide">
                ...
                <div class="col-md-3 defaulthideCCLevel2">
                     <asp:CheckBox ID="defaultchkEmailCCLevel2" runat="server" ClientIDMode="Static" />
 </div>
                ...
                <div class="col-md-3 defaulthideCCLevel3">
                    <asp:CheckBox ID="defaultchkEmailCCLevel3" runat="server" ClientIDMode="Static" /> 
                     </div>
                  </div>
...
<tr>
 ...
 <td class="GridViewLabItemStyle" style="text-align:left;">
    ...
    <script type="text/javascript">
        function bindcenter() {
            serverCall('CustomerCare_Inquiry_Category.aspx/bindCenterType', {  }, function (response) {
        ...
        function bindZone() {
            ...
            serverCall('CustomerCare_Inquiry_Category.aspx/bindBusinessZone', {}, function (response) {
        ...
        function bindState() {
            ...
            if (jQuery("#<%=lstZone.ClientID%>").val() != "") {
                serverCall('CustomerCare_Inquiry_Category.aspx/bindState', {BusinessZoneID:  jQuery("#<%=lstZone.ClientID%>").val() }, function (response) {
    ...
    <script type="text/javascript">
        ...
        function bindEmpState() {
            ...
            if (jQuery("#<%=ddlZone.ClientID%>").val() != "") {
                serverCall('CustomerCare_Inquiry_Category.aspx/bindState', { BusinessZoneID: jQuery("#<%=ddlZone.ClientID%>").val().toString() }, function (response) {
        ...
        function bindEmpCity() {
            ...
            serverCall('CustomerCare_Inquiry_Category.aspx/bindCity', { StateID: jQuery("#<%=ddlState.ClientID%>").val().toString() }, function (response) {
        ...
        function bindEmpCenter() {
            ...
            serverCall('CustomerCare_Inquiry_Category.aspx/bindCentre', { CityID: CityID, BusinessZoneID: BusinessZoneID }, function (response) {
    ...
    <script type="text/javascript">
        function BindData() {
            ...
            serverCall('CustomerCare_Inquiry_Category.aspx/BindData', { CentrTypeId: CentreID, StateId: StateID, SubCategoryID: jQuery('#<%=lblSubCategoryID.ClientID%>').text() }, function (response) {
        ...
        $(function () {
            $("#<%=txtName.ClientID%>").autocomplete({
                source: function (request, response) {
                    serverCall('CustomerCare_Inquiry_Category.aspx/SearchEmployee', { query: $("#<%=txtName.ClientID%>").val(), EmpList: EmpList.toString() }, function (result) {
    ...
    <script type="text/javascript">
        function Save() {
            ...
            serverCall('CustomerCare_Inquiry_Category.aspx/Save', { obj: emp, CenterID: jQuery("#<%=ddlCentre.ClientID%>").val().toString() }, function (response) {
    ...
    <script type="text/javascript">
        ...
        function empRemove(rowID) {
            ...
            serverCall('CustomerCare_Inquiry_Category.aspx/removeTagEmployeeDetail', { ID: ID }, function (response) {
                if (response == "1") {
        ...
        function BindEmpDetail(CentreID, Level) {
            serverCall('CustomerCare_Inquiry_Category.aspx/BindTagEmployeeDetail', { CenterID: CentreID, Level: Level, SubCategoryID: $('#<%=lblSubCategoryID.ClientID%>').text() }, function (response) {
    ...
    <script type="text/javascript">
        $(function () {
            $("#<%=defaulttxtName.ClientID%>").autocomplete({
                source: function (request, response) {
                    ...
                    serverCall('CustomerCare_Inquiry_Category.aspx/SearchEmployee', { query: $("#<%=defaulttxtName.ClientID%>").val(), EmpList: defaultEmpList.toString() }, function (result) {
      ...
      <script type="text/javascript">
          function defaultSave() {
              ...
              serverCall('CustomerCare_Inquiry_Category.aspx/DefaultSave', { Data: emp }, function (response) {
    ...
    <script type="text/javascript">
        ...
        function defaultempRemove(rowID) {
            ...
            serverCall('CustomerCare_Inquiry_Category.aspx/defaultremoveTagEmployeeDetail', { ID: ID }, function (response) {
                if (response == "1") {
        ...
        function defaultBindEmpDetail(CentreID, Level) {
            serverCall('CustomerCare_Inquiry_Category.aspx/defaultBindTagEmployeeDetail', { CenterID: CentreID, Level: Level, SubCategoryID: $('#<%=lblSubCategoryID.ClientID%>').text() }, function (response) {
                empData = $.parseJSON(response);
                if (empData.length == 0) {
      ...
      <script type="text/javascript">
          function defaultBindData() {
              serverCall('CustomerCare_Inquiry_Category.aspx/defaultBindData', { SubCategoryID: $('#<%=lblSubCategoryID.ClientID%>').text() }, function (response) {

<%@ Page  Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="CustomerRegistrationReport.aspx.cs" Inherits="Design_OPD_CustomerRegistrationReport" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div id="Pbody_box_inventory" style="width: 1304px;">
        ...
        <div class="POuter_Box_Inventory" style="text-align: center;width: 1300px;">
            ...
            <b>Customer Registration Report</b><br />
        ...
        <div class="POuter_Box_Inventory" style="width: 1300px;">
            ...
            <table style="text-align: center; width: 100%;">
                <tr>
                    <td style="width: 20%; text-align: right"> From Reg. Date :&nbsp;</td>
                    <td style="text-align: left; width: 30%;">

                        <asp:TextBox ID="txtFromDate" runat="server" Width="110px" />
                        <cc1:CalendarExtender ID="calFromDate" runat="server" TargetControlID="txtFromDate" Format="dd-MMM-yyyy"></cc1:CalendarExtender>
                    </td>
                    <td style="width: 20%; text-align: right">To Reg. Date :&nbsp;</td>
                    <td style="text-align: left; width: 30%;">
                ...
                <tr>
                    <td style="width: 20%; text-align: right"> UHID No. :&nbsp;</td>
                    <td style="text-align: left; width: 30%;">

                        <asp:TextBox ID="txtUHIDNo" runat="server" Width="110px" />
            ...
            <table style="text-align: center;">
                <tr>
                    ...
                    <td colspan="3">
                        <div style="overflow: scroll; height: 266px; width: 1110px; text-align: left; border: solid 1px">

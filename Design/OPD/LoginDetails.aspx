<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="LoginDetails.aspx.cs" Inherits="Design_Store_MIS_LoginDetails" %>
  ...
  <webopt:BundleReference ID="BundleReference3" runat="server" Path="~/App_Style/jquery.Jcrop.css" />
    ...
    <script type="text/javascript">
        ...
        function Search() {
           ...
           // $.blockUI();
            $.ajax({
                url: "LoginDetails.aspx/Search",
                data: '{dtFrom:"' + $("#<%=dtFrom.ClientID %>").val() + '",dtTo:"' + $("#<%=dtTo.ClientID %>").val() + '",CentreID:"' + _CentreID + '",UserID:"' + _UserID + '",ReportType:"' + _ReportType + '",compare:"' + compare + '"}', // parameter map
                ...
                success: function (result) {
                    ...
                    if ($responseData.length == 0) {
                        ...
                        if (_ReportType == '1') {
                            ...
                            theader += '<td class="GridViewHeaderStyle2" style="width: 100px;">Employee Name</td>';
                            theader += '<td class="GridViewHeaderStyle2" style="width: 100px;">Centre</td>';
                            theader += '<td class="GridViewHeaderStyle2" style="width: 150px;">RoleName</td>';    
                            theader += '<td class="GridViewHeaderStyle2" style="width: 100px;">Logintime</td>';
                            theader += '<td class="GridViewHeaderStyle2" style="width: 200px;">Logouttime</td>';
                            theader += '<td class="GridViewHeaderStyle2" style="width: 100px;">IP Address</td>';
                            theader += '<td class="GridViewHeaderStyle2" style="width: 100px;">Browser</td>';
                            theader += '</tr>';
                        ...
                        for (var i = 0; i <= $responseData.length - 1; i++) {
                            ...
                            if (_ReportType == '1' ) {
                                    ...
                                    mydata += '<td class="GridViewLabItemStyle" id="tdEmployeeName" style="width: 100px; text-align:left"><b>' + $responseData[i].EmployeeName + '<b></td>';
                                    mydata += '<td class="GridViewLabItemStyle" id="tdCentre" style="width: 100px; text-align:left"><b>' + $responseData[i].Centre + '<b></td>';
                                    mydata += '<td class="GridViewLabItemStyle" id="tdRoleName" style="width: 150px; text-align:left"><b>' + $responseData[i].RoleName + '<b></td>';
                                    mydata += '<td class="GridViewLabItemStyle" id="tdLoginTime" style="width: 100px; text-align:left"><b>' + $responseData[i].LoginTime + '<b></td>';
                                    mydata += '<td class="GridViewLabItemStyle" id="tdLogOutTime" style="width: 200px; text-align:left"><b>' + $responseData[i].LogOutTime + '<b></td>';
                                    mydata += '<td class="GridViewLabItemStyle" id="tdLoginTime" style="width: 100px; text-align:left"><b>' + $responseData[i].ipAddress + '<b></td>';
                                    mydata += '<td class="GridViewLabItemStyle" id="tdLoginTime" style="width: 100px; text-align:left"><b>' + $responseData[i].Browser + '<b></td>';
                                    mydata += "</tr>";
                                    $('#tb_Status').append(mydata);
        ...
        <div class="POuter_Box_Inventory">
		   ...
		   <div class="col-md-5">
			  <asp:DropDownList ID="ddlReportType" runat="server" CssClass="ddlReportType chosen-select" Width="160px">
                                <asp:ListItem Selected="True" Value="1">Login Summary</asp:ListItem>

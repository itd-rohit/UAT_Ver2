...
<body>
        ...
        <div id="popup_box1">
            ...
            <div class="POuter_Box_Inventory" id="appdiv">
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <asp:DropDownList ID="ddlsourceofcollection" runat="server" CssClass="requiredField">
 ...
 <div class="col-md-4">
    ...
    <script type="text/javascript">
        function openmypopup(ctrl1, phelbo, time, phelboname, endtime) {
              ...
              .autocomplete({
                  ...
                  source: function (request, response) {
                      $.getJSON("../Common/CommonJsonData.aspx?cmd=GetTestList", {
                          ...
                          PanelId: $("#<%=ddldroplocation.ClientID%>").val().split('#')[1],
            ...
            $('#tb_ItemList tr').each(function () {
                ...
                if (id != "theader") {
                    ...
                    if ($('#<%=ch.ClientID%>').is(':checked')) {
                        ...
                        ProData.House_No = $('#<%=txtpatientaddress.ClientID%>').val();

<%@ Page Title="" Language="C#" MasterPageFile="~/Design/DefaultHome.master" AutoEventWireup="true" CodeFile="CentreAppointmentSearch.aspx.cs" Inherits="Design_HomeCollection_CentreAppointmentSearch" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory" style="text-align: center">
            <strong>Centre Visit Search</strong>
        </div>
        <div class="POuter_Box_Inventory">
            <div class="row">
                <div class="col-md-2">
                     <asp:DropDownList ID="ddldateop" runat="server">
                            <asp:ListItem Value=" plo.CentreVisitDateTime ">App Date</asp:ListItem>
                            <asp:ListItem Value=" plo.CreatedDate ">Entry Date</asp:ListItem>
            ...
            <div class="row" id="more" runat="server" style="display: none;">
                <div class="col-md-2">
                    <label class="pull-left">
                        State
                    </label>
            ...
            <div class="row more" style="display: none;">
                ...
                <div class="col-md-3">
                    <asp:TextBox ID="txtpname" runat="server" Width="169px"></asp:TextBox>
                </div>
            </div>
                ...
                <div style="max-height: 380px; overflow: auto;">
                    <table id="tbl" style="width: 100%; border-collapse: collapse; text-align: left;">
                        <tr id="trheader">
                            ...
                            <td class="GridViewHeaderStyle" style="width: 150px;">CreateDate</td>
                            <td class="GridViewHeaderStyle" style="width: 120px;">CreateBy</td>
                            <td class="GridViewHeaderStyle" style="width: 150px;">AppDate</td>
    ...
    <div id="popup_box1">
        ...
        <div class="POuter_Box_Inventory">
            ...
            <div class="row">
                ...
                <div class="col-md-3" style="background-color: bisque">
                    <span id="crstatusdate" style="display: none;"></span>
                </div>
                <div class="col-md-2">
                    <label class="pull-left">
                        PrebookingID
                ...
                <div class="col-md-3" style="background-color: bisque">
                    ...
                    <input type="button" value="View Log" style="font-weight: bold; cursor: pointer; float: right; display: none;" onclick="openlogbox(this)" />
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
                ...
                <div class="col-md-5" style="background-color: bisque">
            ...
            <div class="row">
                ...
                <div class="col-md-3" style="background-color: bisque">
                    <span id="splandmark" style="display: none;"></span>
                </div>
                <div class="col-md-5" style="background-color: bisque">
                    <span id="spid" style="display: none;"></span>
                    <span onclick="hidecode(this)" title="Click To Hide Happy Delivery Code" style="display: none; float: right; cursor: pointer; font-weight: bold; background-color: black; color: white; display: none;" id="spcode"></span>
                </div>
            </div>
            <div class="row">
                <div class="col-md-2">
            ...
            <div class="row">
                <input type="button" value="Show Not available Data" id="btnget" style="font-weight: bold; cursor: pointer; display: none;" onclick="openmyavailable()" />
            </div>
            <div class="row">
            ...
            <div class="row">
                <table id="detailtable2" style="width: 100%; border-collapse: collapse; text-align: left; font-weight: bold; display: none;">
                    <tr id="tr2">
            ...
            <div class="row">
                <table id="detailtable3" style="width: 100%; border-collapse: collapse; text-align: left; font-weight: bold; display: none;">
                    <tr id="tr3">
    ...
    <div id="popup_box4">
       ...
       <div class="row">
        ...
        <div class="col-md-21">
            <input type="text" style="width: 300px;" maxlength="200" id="txtcancelreason" />
            </div>
              </div>
        ...
        <div class="POuter_Box_Inventory" style="width: 600px;" id="Div1">
            ...
            <div class="col-md-3">
                ...
                <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                 <asp:DropDownList ID="ddlapptimere" runat="server" ></asp:DropDownList></div> 
</div>
    ...
    <script type="text/javascript">
        ...
        function bindpincode() {
            ...
            serverCall('customercare.aspx/bindpincode', { LocalityID: $('#<%=ddlarea.ClientID%>').val() }, function (result) {
                pincode = result;
                if (pincode == "") {
        ...
        function bindphelbo() {
            ...
            serverCall('HomecollectionSearch.aspx/bindphelbo', { areaid: $('#<%=ddlarea.ClientID%>').val() }, function (result) {
                localityData = jQuery.parseJSON(result);
                if (localityData.length == 0) {
    ...
    <script type="text/javascript">
        function searchdata(status) {          
            ...
            serverCall('CentreAppointmentSearch.aspx/getdata', { fromdate:  $('#<%=txtfromdate.ClientID%>').val() , todate:  $('#<%=txttodate.ClientID%>').val() , stateId:  $('#<%=ddlstate.ClientID%>').val() , cityid:  $('#<%=ddlcity.ClientID%>').val(), areaid: $('#<%=ddlarea.ClientID%>').val() , pincode: $('#<%=txtpincode.ClientID%>').val() , centre:  $('#<%=ddlcentre.ClientID%>').val() , phelbo: $('#<%=ddlphelbo.ClientID%>').val() , mobileno: $('#<%=txtmobile.ClientID%>').val() , pname:  $('#<%=txtpname.ClientID%>').val() , status:  status , dateoption:  $('#<%=ddldateop.ClientID%>').val() , prebookingno:  $('#<%=txtprebookingid.ClientID%>').val() }, function (result) {
        ...
        function showdetail(ctrl) {
            ...
            serverCall('homecollectionsearch.aspx/BindItemDetail', { prebookingid: id }, function (result) {
                ...
                if (ItemData.length == 0) {
                    ...
                    for (var i = 0; i <= ItemData.length - 1; i++) {
                        var $mydata1 = [];
                        $mydata1.push("<tr style='background-color:azure;' id='");$mydata.push(ItemData[i].stockid);$mydata.push("'>");
                        $mydata1.push('<td>');$mydata.push(parseInt(i + 1));$mydata.push('</td>');
                        $mydata1.push('<td>');$mydata.push(ItemData[i].itemid);$mydata.push('</td>');
                        $mydata1.push('<td>');$mydata.push(ItemData[i].itemname);$mydata.push('</td>');
                        $mydata1.push('<td>');$mydata.push(ItemData[i].itemtype);$mydata.push('</td>');
                        $mydata1.push('<td>');$mydata.push(ItemData[i].rate);$mydata.push('</td>');
                        $mydata1.push('<td>');$mydata.push(ItemData[i].discamt);$mydata.push('</td>');
                        $mydata1.push('<td>');$mydata.push(ItemData[i].netamt);$mydata.push('</td>');
                        $mydata1.push("</tr>");
                        $mydata=$mydata1.join("");
                    }
                    ...
                    $mydata=$mydata.join("");
                    var $mydata2 = [];
                    $mydata2.push('<tr id="ItemDetail');$mydata2.push(id);$mydata2.push('"><td colspan="19">');$mydata2.push($mydata);$mydata2.push('</td></tr>');
                    $($mydata2.join("")).insertAfter($(ctrl).closest('tr'));
        ...
        function openlogbox(ctrl) {
            openmypopup("HomeCollectionLog.aspx?prebookingid=" + $(ctrl).closest('tr').find('#spPrebookingID').html());
        }
        ...
        function cancelappnow() {
            if ($('#txtcancelreason').val() == "") {
                showerrormsg("Please Enter Cancel Reason");
                return;
            }
    ...
    <script type="text/javascript">
        ...
        function RescheduleNow() {
            ...
            if ($('#<%=ddlapptimere.ClientID%>').val() == "0") {
                ...
                showerrormsg("Please Select Appointment Time");
                return;
            }

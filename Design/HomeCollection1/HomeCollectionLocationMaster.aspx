    ...
    <div id="Pbody_box_inventory">
        ...
        <div class="POuter_Box_Inventory">
            ...
            <div class="row Update">
                ...
                <div class="col-md-2 homecollection">
                    <input type="text" disabled="disabled" id="txt_OpenTime" runat="server" onchange="getNoSlot();" name="bookingcutoff" onkeypress="return false;" class="bookingcutoff timepiker" value="06:00" />
                ...
                <div class="col-md-2 homecollection">
                    <input type="text" disabled="disabled" id="txt_ClosingTime" runat="server" onchange="getNoSlot();" name="bookingcutoff" onkeypress="return false;" class="bookingcutoff timepiker" value="20:00" />
                </div>
                <div class="col-md-2 homecollection">
                ...
                <div class="col-md-2 homecollection">
                    <asp:DropDownList ID="ddAvgtime" disabled="disabled"  onchange="getNoSlot();" runat="server">
                        <asp:ListItem Selected="True" Value="10">10-Min</asp:ListItem>
                    ...
                    <div class="row">
                        <table width="100%" id="tblAreaDetails">
                            ...
                            <tr id="tr_dynamic" class="tr_remove">
                                ...
                                <td id="td5">
                                    <input type="text" style="width: 99%;" disabled="disabled" id="txtMore_OpenTime" runat="server" onchange="getNoSlot_More(this);" name="bookingcutoff" onkeypress="return false;" class="bookingcutoff timepiker" value="06:00" /></td>
                                <td id="td6">
                                    <input type="text" style="width: 99%;" disabled="disabled" id="txtMore_CloseTime" runat="server" onchange="getNoSlot_More(this);" name="bookingcutoff" onkeypress="return false;" class="bookingcutoff timepiker" value="20:00" /></td>
                                <td id="td7">
        ...
        function addfidetail() {
          ...
          lastRow = $table.find("tr:last-child");
            ...
            $('#tblAreaDetails tr:last').find('#ContentPlaceHolder1_txtMore_OpenTime').val('06:00');
            $('#tblAreaDetails tr:last').find('#ContentPlaceHolder1_txtMore_CloseTime').val('20:00');
            $('#tblAreaDetails tr:last').find('#ContentPlaceHolder1_ddslot_more').val('10');
        ...
        function searchitemexcel() {
           ...
           // $('#<%=ddlCityZone.ClientID%>').val(CityZoneid);
            ...
            if (IsHomeCollectionActive == '1') {
               ...
               $('#<%= txt_OpenTime.ClientID%>').val("06:00");
               $('#<%= txt_ClosingTime.ClientID%>').val("20:00");
               $('#<%= ddAvgtime.ClientID%>').val("10");
               $('#<%= ddlTimeSloat.ClientID%>').val("3");
               $('.homecollection').hide();
           }
       }
...
function ShowDetail(e) {
    ...
    function clearData() {
        ...
        $('#tblAreaDetails tr:last').find('#ContentPlaceHolder1_ddslot_more').val('10');
        $('#tblAreaDetails tr:last').find('#ContentPlaceHolder1_spnMore_NoSlot').text('20');
        $('#tblAreaDetails tr:last').find('#ContentPlaceHolder1_ddNewslot_more').val('3');

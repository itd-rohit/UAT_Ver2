<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CentreLoadTypeWithoutPCCPUP.ascx.cs" Inherits="Design_UserControl_CentreLoadTypeWithoutPCCPUP" %>
...
<script type="text/javascript">
    ...
    function bindType() {
                jQuery.ajax({
                    url: "../Common/Services/CommonServices.asmx/bindTypeLoadWithoutPCCPUP",
                    data: '{ }',
                    type: "POST",
                    timeout: 120000,
                    async: false,

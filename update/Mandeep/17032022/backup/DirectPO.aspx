            ...
            <div class="Purchaseheader">
                Terms & Conditions
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 ">
                            <asp:DropDownList ID="ddlpaymentterm" runat="server" onchange="setpaymentterm()">
                        ...
                        <div class="col-md-2 ">
                            <asp:DropDownList ID="ddldeliveryterm" runat="server" Width="100px" onchange="setdeliveryterm()">
                    ...
                    <div class="row">
                        <div class="col-md-24 ">
                            <input type="button" value="Save" class="savebutton" onclick="savePurchaseOrder();" id="btnSave" style="display: none" />
    ...
    <script type="text/javascript">
        ...
        function bindDCentre() {
            ...
            function bindLocation() {
                ...
                serverCall('Services/StoreCommonServices.asmx/bindLocation', { CentreID: jQuery('#ddlCentre').val() }, function (response) {
            ...
            jQuery('#txtItem')
                      ...
                      .autocomplete({
                          ...
                          source: function (request, response) {
                              var _temp = [];
                              _temp.push(serverCall('DirectPO.aspx/SearchItem', { ItemName: (request.term), SupplierID: jQuery('#<%=ddlsupplier.ClientID%>').val(), DeliveryLocationID: $('#<%=ddlLocation.ClientID%>').val(), itemcate: $('#<%=ddlcategorytype.ClientID%>').val() }, function (responsenew) {
                                  jQuery.when.apply(null, _temp).done(function () {

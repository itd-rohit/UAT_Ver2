...
public partial class Design_Store_DirectPO : System.Web.UI.Page
{
    ...
    [WebMethod]
    public static string SearchItem(string ItemName, string SupplierID, string DeliveryLocationID, string itemcate)
    {
        StringBuilder sb = new StringBuilder();

        sb.Append(" SELECT si.`ItemID`,sig.`ItemNameGroup` ,si.`ItemIDGroup` ");

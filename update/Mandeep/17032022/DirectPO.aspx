            ...
            jQuery('#txtItem')
                      ...
                      .autocomplete({
                          ...
                          source: function (request, response) {
                              serverCall('DirectPO.aspx/SearchItem', { itemname: extractLast(request.term), SupplierID: jQuery('#<%=ddlsupplier.ClientID%>').val(), itemcate: $('#<%=ddlcategorytype.ClientID%>').val() },

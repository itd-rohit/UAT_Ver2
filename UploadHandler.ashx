...
public class UploadHandler : IHttpHandler, System.Web.SessionState.IRequiresSessionState
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        try
        {
            ...
            FileName = string.Concat(PostedFileName, System.IO.Path.GetExtension(file.FileName));
            ...
            try
            {
                ...
                sb.Append(" INSERT INTO  document_detail (DocumentID,DocumentName,LabNo,PatientID,CreatedByID,CreatedDate,filename,isActive,isDefault,FromPUPPortal,CreatedBy)  ");

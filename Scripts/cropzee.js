...
jQuery.fn.extend({
  cropzee: function (options = {
        ...
        window.cropzeeCreateImage = function(id) {
            ...
            ctx.drawImage(img, dimensions.x, dimensions.y, 200, 200, 0, 0, 200, 200);
        ...
        function cropzeeTriggerModal(id, src) {
            ...
            '<div class="light-modal" id="cropzee-modal" role="dialog" aria-labelledby="light-modal-label" aria-hidden="false" data-lightmodal="close">'
                + '<div class="light-modal-content ' + animation + '">'
                    ...
                    + '<div onclick="cropzeeRotateImage(`' + id + '`);" class="light-modal-close-btn" style="cursor: pointer;display:none;">Rotate 90deg</div>'
                        + '<div onclick="closeModal()" class="light-modal-close-btn" style="cursor: pointer;display:none;" aria-label="close">Add Full Image</div>'
                        
                        + '<div onclick="cropzeeCreateImage(`' + id + '`);" class="light-modal-close-btn" style="cursor: pointer;">Add Image</div>'
                        + '<div onclick="closeonly()" class="light-modal-close-btn" style="cursor: pointer;" aria-label="close">Cancel</div>'
            ...
            setTimeout(function(){
                ...
                setTimeout(function(){
                    ...
                    window.location = window.location.href.split("#")[0] + "#cropzee-modal";
...
// function to close modal
    function closeModal() {
        ...
        var objEditor = CKEDITOR.instances[editorid];
